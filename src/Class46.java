...
final class Class46 {
   ...
   static Class153 aClass153_737;
   static Class94 aClass94_738 = Class3_Sub4.method108("Monde de jeu cr-B-B", (byte)-120);
   static int anInt739;
   static int anInt740;
   static int anInt741;
   ...
   static final void method1086(Class153 var0, int var1) {
      try {
         Class45.aClass153_731 = var0;
         if(var1 != -6) {
            aClass153_737 = (Class153)null;
         }
