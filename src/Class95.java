...
final class Class95 {
   ...
   static Class94 aClass94_1333 = Class3_Sub4.method108("um", (byte)-118);
   private static Class94 aClass94_1334 = Class3_Sub4.method108("You can(Wt add yourself to your own ignore list)3", (byte)-118);
   static Class94 aClass94_1335 = aClass94_1334;
   static int anInt1336 = 0;
   static Class94 aClass94_1337 = Class3_Sub4.method108("::breakcon", (byte)-118);
   static int anInt1338;
   static Class3_Sub28_Sub16 aClass3_Sub28_Sub16_1339;
   static volatile int anInt1340 = -1;
   static Class94 aClass94_1341 = Class3_Sub4.method108("logo", (byte)-119);
   static Class94 aClass94_1342 = Class3_Sub4.method108("details", (byte)-123);
   ...
   static final Class94 method1586(int var0, int var1) {
      try {
         if(-1 > ~var1 && -256 <= ~var1) {
            ...
            var2.anInt2156 = 1;
            var2.aByteArray2153 = new byte[1];
            var2.aByteArray2153[0] = (byte)var1;
            return var2;
         } else {
