...
final class Class3_Sub22 extends Class3 {
   ...
   static Class94 aClass94_2499 = Class3_Sub4.method108("Okay", (byte)-117);
   ...
   int anInt2516;
   int anInt2517;
   static Class94 aClass94_2518 = Class3_Sub4.method108("Poser", (byte)-122);
   int anInt2519;
   int anInt2520;
   static byte[][] aByteArrayArray2521;
   int anInt2522;
   int anInt2523;
   static Class94 aClass94_2524 = Class3_Sub4.method108("Starte 3D)2Softwarebibliothek)3", (byte)-126);
   private static Class94 aClass94_2525 = Class3_Sub4.method108("rating: ", (byte)-118);
   static Class94 aClass94_2526 = aClass94_2525;
   Class3_Sub15 aClass3_Sub15_2527;
   static Class153 aClass153_2528;
   ...
   static final void method398(int var0, int var1, int var2, int var3, int var4, byte[][][] var5, int[] var6, int[] var7, int[] var8, int[] var9, int[] var10, int var11, byte var12, int var13, int var14) {
      if(var0 < 0) {
         var0 = 0;
      } else if(var0 >= Class89.anInt1234 * 128) {
         var0 = Class89.anInt1234 * 128 - 1;
      }
      ...
      if(Class2.anInt67 > Class89.anInt1234) {
         Class2.anInt67 = Class89.anInt1234;
      }
      ...
      for(var16 = 0; var16 < Class3_Sub13_Sub39.anInt3466 + Class3_Sub13_Sub39.anInt3466 + 2; ++var16) {
         for(var17 = 0; var17 < Class3_Sub13_Sub39.anInt3466 + Class3_Sub13_Sub39.anInt3466 + 2; ++var17) {
            ...
            if(var20 >= 0 && var21 >= 0 && var20 < Class89.anInt1234 && var21 < Class3_Sub13_Sub15.anInt3179) {
               int var22;
   ...
   static final void method400(long var0, int var2) {
      try {
         if((long)var2 != var0) {
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 104);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method740(var0, var2 ^ -2037491440);
   ...
   static final void method402(int var0) {
      try {
         if(0 != ~GameStub.aString1216.toLowerCase().indexOf("microsoft")) {
   ...
   static final void method403() {
      GL var0 = Class138.aGL1804;
      var0.glDisableClientState('\u8076');
      Class138.method1837(false);
      var0.glDisable(2929);
      ...
      for(int var1 = 0; var1 < GameClient.aClass3_Sub11ArrayArray2199[0].length; ++var1) {
         Class3_Sub11 var2 = GameClient.aClass3_Sub11ArrayArray2199[0][var1];
   ...
   static final Class75_Sub4 method404(byte var0, Class3_Sub30 var1) {
      try {
         return var0 > -55?(Class75_Sub4)null:new Class75_Sub4(var1.method787((byte)93), var1.method787((byte)55), var1.method787((byte)81), var1.method787((byte)95), var1.method794((byte)124), var1.method794((byte)120), var1.method803((byte)-103));
      } catch (RuntimeException var3) {
