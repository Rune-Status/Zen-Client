...
final class Class3_Sub13_Sub27 extends Class3_Sub13 {
   ...
   static long aLong3338 = 0L;
   static Class94 aClass94_3339 = Class3_Sub4.method108("null", (byte)-125);
   static int anInt3340;
   static Class94[] aClass94Array3341 = new Class94[100];
   static int anInt3342;
   private int anInt3343 = 6;
   static Class94 aClass94_3344 = Class3_Sub4.method108("Sie k-Onnen sich selbst nicht selbst auf Ihre Ignorieren)2Liste setzen(Q", (byte)-126);


   static final void method295(Class94 var0, byte var1, int var2) {
      try {
   ...
   final int[][] method166(int var1, int var2) {
      try {
         if(var1 != -1) {
            this.method157(-8, (Class3_Sub30)null, false);
         }
            ...
            for(int var3 = 0; ~var3 > ~Class8.anInt104; ++var3) {
               if(~Class50.aLongArray826[var3] == ~var0) {
                  ...
                  for(int var4 = var3; var4 < Class8.anInt104; ++var4) {
                     ...
                     Class3_Sub28.aClass94Array2566[var4] = Class3_Sub28.aClass94Array2566[1 + var4];
                     Class50.aLongArray826[var4] = Class50.aLongArray826[1 + var4];
                     Class57.anIntArray904[var4] = Class57.anIntArray904[var4 - -1];
                     Class3.aBooleanArray73[var4] = Class3.aBooleanArray73[1 + var4];
                  }

                  Class110.anInt1472 = Class3_Sub13_Sub17.anInt3213;
                  Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 57);
                  Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method740(var0, -2037491440);
                  break;
               }
            }

            if(var2 != 1) {
               aClass94Array3341 = (Class94[])null;
            }
   ...
   static final Class3_Sub11[] method298(byte[][][] var0, byte[][] var1, byte[][] var2, int[][] var3, float[][] var4, int[][] var5, byte[][] var6, byte[][] var7, float[][] var8, int var9, float[][] var10, int[][] var11, int[][] var12, int[][] var13, int var14) {
      try {
         ...
         Class4.method824(var55, var59, -86);
         return var59;
   ...
   static final void method299(int var0, int var1, int var2) {
      try {
         ...
         if(0 == var2) {
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 215);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-25, var3 - -var3 + 3);
            ++Class23.anInt452;
         }

         if(-2 == ~var2) {
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 39);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-111, 3 + var3 - (-var3 - 14));
            ++Class26.anInt503;
         }

         if(~var2 == -3) {
            ++Class143.anInt1873;
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 77);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-70, var3 + var3 - -3);
         }

         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method790(Class111.aBooleanArray1490[82]?1:0, -13071);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method804(-20037, Class131.anInt1716 + var4);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method783(Class82.anInt1152 + var5, -268435456);
         ...
         for(int var6 = 1; var3 > var6; ++var6) {
            --var1;
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method790(-var4 + Class3_Sub13_Sub38.anIntArray3456[var1], -13071);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method743(10213, Class45.anIntArray729[var1] + -var5);
         }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var1 == 0) {
            this.anInt3343 = var2.method803((byte)-104);
         } else if(~var1 == -2) {
            this.aBoolean2375 = ~var2.method803((byte)-98) == -2;
         }

         if(!var3) {
            aClass94_3339 = (Class94)null;
         }
