...
final class Class3_Sub13_Sub36 extends Class3_Sub13 {
   ...
   private static Class94 aClass94_3428 = Class3_Sub4.method108(" more options", (byte)-126);
   static Class153 aClass153_3429;
   static byte[][][] aByteArrayArrayArray3430;
   private int anInt3431;
   static Class94 aClass94_3432 = Class3_Sub4.method108("Schrifts-=tze geladen)3", (byte)-121);
   private int anInt3433;
   private int anInt3434 = -1;
   static float aFloat3435;
   static Class94 aClass94_3436 = Class3_Sub4.method108("jaune:", (byte)-126);
   private static Class94 aClass94_3437 = Class3_Sub4.method108("Attack", (byte)-126);
static Class94 aClass94_3426 = aClass94_3428;
   static Class94 aClass94_3427 = aClass94_3437;
   ...
   static final void method338(int var0, int var1, boolean var2, int var3, int var4, int var5) {
      try {
         ...
         if(1 == Class133.anInt1753) {
            var7 = 2047 & Class3_Sub29.anInt2589 + Class28.anInt531;
            ...
            Class140_Sub2.method1952(Class3_Sub13_Sub13.anInt3155, -1907397104, var1, Class121.method1736(Class26.anInt501, 1, Class102.aClass140_Sub4_Sub1_2141.anInt2819, Class102.aClass140_Sub4_Sub1_2141.anInt2829) + -50, 600 - -(var6 * 3), var7, Class62.anInt942, var6);
         }

         if(var0 == -6403) {
            var7 = Class7.anInt2162;
            var6 = Class140_Sub4_Sub2.anInt3995;
            ...
            for(var11 = 0; 5 > var11; ++var11) {
               if(Class104.aBooleanArray2169[var11]) {
                  ...
                  if(var11 == 0) {
                     Class140_Sub4_Sub2.anInt3995 += var12;
                  }
               }
            }
            ...
            if(Class138.aBoolean1807) {
               ...
               Class138.method1844(var3, var5, var4, var1, var4 / 2 + var3, var5 - -(var1 / 2), var17, var16, Class130.anInt1705, Class130.anInt1705);
            } else {
               Class74.method1324(var3, var5, var4 + var3, var1 + var5);
               Class51.method1134();
            }

            if(!Class38_Sub1.aBoolean2615 && ~Class90.anInt1297 <= ~var3 && ~Class90.anInt1297 > ~(var4 + var3) && var5 <= Class38_Sub1.anInt2612 && ~(var1 + var5) < ~Class38_Sub1.anInt2612) {
               Class3_Sub13_Sub7.aBoolean3094 = true;
               Class2.anInt59 = 0;
               var12 = Class145.anInt1898;
               int var13 = Class1.anInt55;
               var11 = Class139.anInt1824;
               Class3_Sub28_Sub11.anInt3642 = var11 + (var12 - var11) * (-var3 + Class90.anInt1297) / var4;
               int var14 = Class86.anInt1195;
               Class16.anInt384 = (-var13 + var14) * (Class38_Sub1.anInt2612 - var5) / var1 + var13;
            } else {
            ...
            if(Class138.aBoolean1807) {
               ...
               boolean var18 = false;
               Class138.method1827(true);
               if(~Class143.anInt1875 == -11) {
                  var12 = Class3_Sub30_Sub1.method809(Class106.anInt1446, Class77.anInt1111 >> 10, Class3_Sub28_Sub10.anInt3625, Class140_Sub4_Sub2.anInt3995 >> 10, var0 + 6404);
               } else {
                  var12 = Class3_Sub30_Sub1.method809(Class106.anInt1446, Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0] >> 3, Class3_Sub28_Sub10.anInt3625, Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0] >> 3, 1);
               }

               Class68.method1269(Class44.anInt719, !Class44_Sub1.aBoolean2623);
               Class138.method1849(var12);
               RuntimeException_Sub1.method2285(Class139.anInt1823, Class77.anInt1111, Class7.anInt2162, Class140_Sub4_Sub2.anInt3995, false, Class3_Sub13_Sub25.anInt3315);
               Class138.anInt1791 = Class44.anInt719;
               Class3_Sub22.method398(Class140_Sub4_Sub2.anInt3995, Class7.anInt2162, Class77.anInt1111, Class139.anInt1823, Class3_Sub13_Sub25.anInt3315, Class158.aByteArrayArrayArray2008, Class41.anIntArray686, Class129_Sub1.anIntArray2696, Class159.anIntArray2021, Class140_Sub4_Sub1.anIntArray3959, Class142.anIntArray1871, Class26.anInt501 + 1, var19, Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7, Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7);
            ...
            Class140_Sub4_Sub2.anInt3995 = var6;
            ...
            if(!var2 && !Class3_Sub13_Sub4.aBoolean3064 && !Class38_Sub1.aBoolean2615 && var3 <= Class90.anInt1297 && var4 + var3 > Class90.anInt1297 && ~var5 >= ~Class38_Sub1.anInt2612 && var1 + var5 > Class38_Sub1.anInt2612) {
               Class104.method1628(var5, var4, var1, var3, Class38_Sub1.anInt2612, Class90.anInt1297, (byte)97);
            }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(!var3) {
            aClass153_3429 = (Class153)null;
         }

         if(0 == var1) {
            this.anInt3434 = var2.method737(1);
         }
   ...
   static final Class3_Sub28_Sub13 method342(int var0, boolean var1) {
      try {
         ...
         if(var2 != null) {
            ...
            byte[] var3 = Class45.aClass153_731.method2133(Class53.method1170((byte)44, var0), (byte)-122, Class3_Sub30_Sub1.method810((byte)3, var0));
            ...
            if(null != var3) {
               var2.method625(new Class3_Sub30(var3), -122);
            }
   ...
   static final Class109[] method343(int var0) {
      try {
         Class109[] var1 = new Class109[Class95.anInt1338];

         for(int var2 = 0; ~Class95.anInt1338 < ~var2; ++var2) {
            if(!Class138.aBoolean1807) {
               var1[var2] = new Class109_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], Class3_Sub30.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], Class163_Sub1.aByteArrayArray2987[var2], Class3_Sub13_Sub38.anIntArray3446);
            } else {
               var1[var2] = new Class109_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], Class3_Sub30.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], Class163_Sub1.aByteArrayArray2987[var2], Class3_Sub13_Sub38.anIntArray3446);
            }
         }

         if(var0 != 1854847236) {
            aClass94_3428 = (Class94)null;
         }
