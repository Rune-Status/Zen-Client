...
final class Class86 {
   ...
   int anInt1175;
   private static Class94 aClass94_1176 = Class3_Sub4.method108("Loading wordpack )2 ", (byte)-120);
   int anInt1177;
   int anInt1178;
   static Class94 aClass94_1179 = Class3_Sub4.method108("Veuillez patienter)3)3)3", (byte)-118);
  
   int anInt1181;
   static Class91[] aClass91Array1182 = new Class91[4];
   static Class94 aClass94_1183 = aClass94_1176;
   int anInt1184;
   int anInt1185;
   static Class41 aClass41_1186;
   float aFloat1187;
   static Class94 aClass94_1188 = Class3_Sub4.method108("::rebuild", (byte)-124);
   float aFloat1189;
   float aFloat1190;
   static int anInt1191;
   private static Class94 aClass94_1192 = Class3_Sub4.method108("Examine", (byte)-121);
   static Class3_Sub24_Sub4 aClass3_Sub24_Sub4_1193;
   static Class130 aClass130_1194;
   static int anInt1195;
 static Class94 aClass94_1180 = aClass94_1192;
   ...
   static final Class3_Sub28_Sub17_Sub1 method1430(int var0, int var1) {
      try {
         if(var0 != -28922) {
            ...
            Class3_Sub28_Sub17_Sub1 var2 = (Class3_Sub28_Sub17_Sub1)Class80.aClass93_1135.method1526((long)var1, (byte)121);
            if(var2 != null) {
               return var2;
            } else {
               byte[] var3 = Class153.aClass153_1948.method2133(var1, (byte)-122, 0);
               var2 = new Class3_Sub28_Sub17_Sub1(var3);
               var2.method697(Class3_Sub13_Sub22.aClass109Array3270, (int[])null);
               Class80.aClass93_1135.method1515((byte)-96, var2, (long)var1);
               return var2;
            }
         }
      } catch (RuntimeException var4) {
   ...
   Class86(Class3_Sub30 var1) {
      try {
         int var2 = var1.method803((byte)-92);
         if(~(var2 & 1) == -1) {
            this.anInt1177 = Class92.anInt1322;
         } else {
            this.anInt1177 = var1.method748(-502942936);
         }

         if(~(2 & var2) == -1) {
            this.aFloat1187 = 1.1523438F;
         } else {
            this.aFloat1187 = (float)var1.method737(1) / 256.0F;
         }

         if((var2 & 4) == 0) {
            this.aFloat1190 = 0.69921875F;
         } else {
            this.aFloat1190 = (float)var1.method737(1) / 256.0F;
         }

         if(~(var2 & 8) != -1) {
            this.aFloat1189 = (float)var1.method737(1) / 256.0F;
         } else {
            this.aFloat1189 = 1.2F;
         }
         ...
         if(-1 == ~(16 & var2)) {
            ...
            this.anInt1185 = var1.method787((byte)53);
            this.anInt1181 = var1.method787((byte)15);
            this.anInt1178 = var1.method787((byte)50);
         }

         if((32 & var2) == 0) {
            this.anInt1175 = Class92.anInt1316;
         } else {
            this.anInt1175 = var1.method748(-502942936);
         }

         if(-1 == ~(64 & var2)) {
            this.anInt1184 = 0;
         } else {
            this.anInt1184 = var1.method737(1);
         }
