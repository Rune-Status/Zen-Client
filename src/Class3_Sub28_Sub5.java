...
final class Class3_Sub28_Sub5 extends Class3_Sub28 {

   static Class153 aClass153_3580;
   static Calendar aCalendar3581 = Calendar.getInstance(TimeZone.getTimeZone("GMT"));
   private static Class94 aClass94_3582 = Class3_Sub4.method108("K", (byte)-120);
   static Class94 aClass94_3583 = Class3_Sub4.method108("brillant3:", (byte)-119);
   static Class94 aClass94_3584 = aClass94_3582;
   static Class94 aClass94_3585 = Class3_Sub4.method108(",Mcran)2titre ouvert", (byte)-124);
   static Class94 aClass94_3586 = aClass94_3582;
   ...
   Class3_Sub28_Sub5(Class153 var1, Class153 var2, int var3, boolean var4) {
      try {
         ...
         while(~var8 > ~var7.length) {
            byte[] var9 = var1.method2133(var3, (byte)-122, var7[var8]);
