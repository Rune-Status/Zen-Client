...
final class Class3_Sub19 extends Class3 {
   ...
   byte aByte2472;
   Class94 aClass94_2473;
   static Class153 aClass153_2474;
   static int anInt2475 = 0;
   Class94 aClass94_2476;
   static Class94 aClass94_2477 = Class3_Sub4.method108("<col=ffffff>", (byte)-126);
   int anInt2478;
      ...
      try {
         ...
         for(var6 = 1; ~var6 > -104; ++var6) {
            for(var7 = 1; 103 > var7; ++var7) {
               if(0 == (Class9.aByteArrayArrayArray113[var1][var7 + var2][var6 - -var3] & 24) && !Class94.method1529(var3, var7, var18, var6, var5, var2, var1, true)) {
               ...
               if(-4 < ~var1 && ~(Class9.aByteArrayArrayArray113[1 + var1][var7 + var2][var6 + var3] & 8) != -1 && !Class94.method1529(var3, var7, var18, var6, var5, var2, 1 + var1, true)) {
                  if(!Class138.aBoolean1807) {
                     Class164_Sub1.aClass158_3009.method2182(0);
                  } else {
                     Class74.anIntArray1100 = null;
