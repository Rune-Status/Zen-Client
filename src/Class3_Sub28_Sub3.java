...
final class Class3_Sub28_Sub3 extends Class3_Sub28 {

   int anInt3549 = 0;
   int anInt3550 = -1;
   static Class11 aClass11_3551;
   static int anInt3552;
   boolean aBoolean3553 = true;
   Class94 aClass94_3554;
   int anInt3555 = 12800;
   int anInt3556;
   ...
   final boolean method537(int var1, byte var2, int var3) {
      try {
         if(~this.anInt3555 >= ~var3 && var3 <= this.anInt3559 && var1 >= this.anInt3562 && var1 <= this.anInt3549) {
            for(Class3_Sub21 var4 = (Class3_Sub21)this.aClass61_3560.method1222(-28); var4 != null; var4 = (Class3_Sub21)this.aClass61_3560.method1221(var2 + -93)) {
   ...
   final void method538(byte var1) {
      try {
         ...
         this.anInt3559 = 0;
         if(var1 != 103) {
            aClass11_3551 = (Class11)null;
         }

         this.anInt3549 = 0;
         this.anInt3555 = 12800;

         for(Class3_Sub21 var2 = (Class3_Sub21)this.aClass61_3560.method1222(-74); null != var2; var2 = (Class3_Sub21)this.aClass61_3560.method1221(4)) {
   ...
   static final void method541(byte var0, boolean var1, Class94 var2) {
      try {
         ...
         int var6 = !var1?0:'\u8000';
         int var7 = (!var1?Class83.anInt1156:Class16.anInt377) + var6;
         ...
         Class94[] var13 = new Class94[Class62.anInt952];
   ...
   static final int method543(int var0, int var1, byte var2) {
      try {
         if(var2 > -71) {
            ...
            int var3 = Class140_Sub4_Sub2.method1984(var0 + -1, 38, -1 + var1) - -Class140_Sub4_Sub2.method1984(1 + var0, 38, -1 + var1) - (-Class140_Sub4_Sub2.method1984(-1 + var0, 38, var1 - -1) + -Class140_Sub4_Sub2.method1984(var0 + 1, 38, var1 - -1));
            int var4 = Class140_Sub4_Sub2.method1984(var0 + -1, 38, var1) + Class140_Sub4_Sub2.method1984(var0 + 1, 38, var1) + (Class140_Sub4_Sub2.method1984(var0, 38, -1 + var1) - -Class140_Sub4_Sub2.method1984(var0, 38, 1 + var1));
            int var5 = Class140_Sub4_Sub2.method1984(var0, 38, var1);
   ...
   Class3_Sub28_Sub3(Class94 var1, Class94 var2, int var3, int var4, int var5, boolean var6, int var7) {
      try {
         this.anInt3556 = var4;
         this.anInt3550 = var5;
