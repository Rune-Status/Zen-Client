...
final class Class3_Sub4 extends Class3 {
   ...
   static Class94 aClass94_2252 = method108("Atteindre", (byte)-117);
   int anInt2253;
   int anInt2254;
   static Class94 aClass94_2255 = method108("Suche nach Updates )2 ", (byte)-126);
   int anInt2256;
   int anInt2257;
   static Class153 aClass153_2258;
   int anInt2259 = -1;
   static Class94 aClass94_2260 = method108("Lade Wordpack )2 ", (byte)-117);
   int anInt2261 = 0;
   int anInt2262;
   int anInt2263;
   int anInt2264;
   ...
   static final int method107(Class153 var0, byte var1) {
      try {
         int var2 = 0;
         ...
         if(var0.method2144(0, GameClient.anInt2195)) {
            ++var2;
         }

         if(var0.method2144(0, Class3_Sub28.anInt2575)) {
            ++var2;
         }

         if(var0.method2144(0, Class16.anInt380)) {
            ++var2;
         }
   ...
   static final Class94 method108(String var0, byte var1) {
      try {
   ...
   static final void method110(int var0, int var1, int var2, int var3, boolean var4) {
      Class89.anInt1234 = var1;
      Class3_Sub13_Sub15.anInt3179 = var2;
      Class3_Sub13_Sub39.anInt3466 = var3;
      Class3_Sub28_Sub10_Sub2.aClass3_Sub2ArrayArrayArray4070 = new Class3_Sub2[var0][Class89.anInt1234][Class3_Sub13_Sub15.anInt3179];
      Class58.anIntArrayArrayArray914 = new int[var0][Class89.anInt1234 + 1][Class3_Sub13_Sub15.anInt3179 + 1];
      if(Class138.aBoolean1807) {
         GameClient.aClass3_Sub11ArrayArray2199 = new Class3_Sub11[4][];
      }

      if(var4) {
         Class166.aClass3_Sub2ArrayArrayArray2065 = new Class3_Sub2[1][Class89.anInt1234][Class3_Sub13_Sub15.anInt3179];
         Class3_Sub13_Sub9.anIntArrayArray3115 = new int[Class89.anInt1234][Class3_Sub13_Sub15.anInt3179];
         Class3_Sub28_Sub7.anIntArrayArrayArray3605 = new int[1][Class89.anInt1234 + 1][Class3_Sub13_Sub15.anInt3179 + 1];
         if(Class138.aBoolean1807) {
      ...
      Class81.anIntArrayArrayArray1142 = new int[var0][Class89.anInt1234 + 1][Class3_Sub13_Sub15.anInt3179 + 1];
      ...
      Class136.aByteArrayArrayArray1774 = new byte[var0][Class89.anInt1234][Class3_Sub13_Sub15.anInt3179];
   }
