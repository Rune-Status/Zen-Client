...
final class Class49 {
         ...
         for(int var4 = 0; ~var4 > ~var2; ++var4) {
            ...
            for(int var5 = 0; -14 < ~var5; ++var5) {
               for(int var6 = 0; -14 < ~var6; ++var6) {
                  int var8 = Class111.anIntArrayArrayArray1497[var4][var5][var6];
                  boolean var7 = false;
                  if(~var8 != 0) {
                     int var9 = var8 >> 24 & 3;
                     if(!var0 || 0 == var9) {
   ...
   static final Class11 method1122(int var0, Class11 var1) {
      try {
         if(var0 != 0) {
            method1123(103, 118);
         }

         Class11 var2 = GameClient.method42(var1);
         if(null == var2) {
   ...
   static final Class94 method1124(int[] var0, long var1, int var3, boolean var4) {
      try {
         if(var4) {
            return (Class94)null;
         } else {
            if(Class58.anInterface4_915 != null) {
               Class94 var5 = Class58.anInterface4_915.method20(var3, var0, 4936, var1);
               if(var5 != null) {
                  return var5;
               }
            }
   ...
   static final void method1125(String var0, Throwable var1, byte var2) {
      ...
      try {
         ...
         if(Class3_Sub13_Sub10.aGameStub_3125.anApplet1219 == null) {
            return;
         }

         Class64 var4 = Class3_Sub13_Sub10.aGameStub_3125.method1439(false, new URL(Class3_Sub13_Sub10.aGameStub_3125.anApplet1219.getCodeBase(), "clienterror.ws?c=" + Class3_Sub13_Sub23_Sub1.anInt4033 + "&u=" + Class3_Sub13_Sub16.aLong3202 + "&v1=" + GameStub.aString1216 + "&v2=" + GameStub.aString1196 + "&e=" + var3));
      ...
      try {
         if(!Class38_Sub1.aBoolean2615) {
            if(Class3_Sub28_Sub13.anInt3660 != 0) {
               Class90.anInt1297 = Class3_Sub13_Sub39.anInt3460;
               Class38_Sub1.anInt2612 = Class168.anInt2099;
            } else if(Class3_Sub28_Sub11.anInt3644 == 0) {
               Class90.anInt1297 = Class126.anInt1676;
               Class38_Sub1.anInt2612 = Class130.anInt1709;
            } else {
               Class90.anInt1297 = Class163_Sub1.anInt2993;
         ...
         if(var0 == 0) {
            ...
            if(Class38_Sub1.aBoolean2615) {
               if(Class153.aBoolean1951) {
                  Class63.method1230((byte)116);
               } else {
                  Class84.method1419(-117);
               }
            } else if(null == Class3_Sub28_Sub16.aClass11_3708) {
               if(0 != ~Class53.anInt865) {
                  Class24.method950((Class11)null, -86, Class3_Sub28.anInt2567, Class53.anInt865);
               }
            } else {
            ...
            if(-2 == ~Class3_Sub16.anInt2440) {
               Class3_Sub16.anInt2440 = 2;
            }

            if(1 == Class111.anInt1521) {
               Class111.anInt1521 = 2;
            }
               ...
               for(int var2 = 0; ~var2 > ~Class3_Sub28_Sub3.anInt3557; ++var2) {
                  if(!Class130.aBooleanArray1712[var2]) {
                     if(Class163_Sub1_Sub1.aBooleanArray4008[var2]) {
                        if(!Class138.aBoolean1807) {
                           Class74.method1312(Class155.anIntArray1969[var2], Class140_Sub4_Sub1.anIntArray3954[var2], Class3_Sub28_Sub18.anIntArray3768[var2], Class140_Sub4.anIntArray2794[var2], 16711680, 128);
                        } else {
                           Class22.method930(Class155.anIntArray1969[var2], Class140_Sub4_Sub1.anIntArray3954[var2], Class3_Sub28_Sub18.anIntArray3768[var2], Class140_Sub4.anIntArray2794[var2], 16711680, 128);
                        }
                     }
                  } else if(!Class138.aBoolean1807) {
                     Class74.method1312(Class155.anIntArray1969[var2], Class140_Sub4_Sub1.anIntArray3954[var2], Class3_Sub28_Sub18.anIntArray3768[var2], Class140_Sub4.anIntArray2794[var2], 16711935, 128);
                  } else {
                     Class22.method930(Class155.anIntArray1969[var2], Class140_Sub4_Sub1.anIntArray3954[var2], Class3_Sub28_Sub18.anIntArray3768[var2], Class140_Sub4.anIntArray2794[var2], 16711935, 128);
                  }
               }
            }

            Class61.method1214(Class106.anInt1446, Class102.aClass140_Sub4_Sub1_2141.anInt2819, Class102.aClass140_Sub4_Sub1_2141.anInt2829, Class26.anInt501, 1);
   ...
   final void method1128(byte[] var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var3) {
            anInt815 = -81;
         }

         if(31 == var2.aByteArray2590[var2.anInt2595] && var2.aByteArray2590[var2.anInt2595 + 1] == -117) {
            if(this.anInflater813 == null) {
               this.anInflater813 = new Inflater(true);
            }

            try {
               this.anInflater813.setInput(var2.aByteArray2590, var2.anInt2595 + 10, -8 - (10 + var2.anInt2595) + var2.aByteArray2590.length);
