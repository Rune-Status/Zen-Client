...
final class Class140_Sub6 extends Class140 {
   ...
   static Class153 aClass153_2906;
   int anInt2907;
   ...
   private Class142 aClass142_2923;
   int anInt2924;
   int anInt2925;
   ...
   static final void method2020(int var0, Class111 var1, byte var2, int var3, int var4) {
      try {
         Class3_Sub9 var5 = (Class3_Sub9)Class3.aClass61_78.method1222(-17);
         if(var2 != -73) {
            method2019(true);
         }
         ...
         while(null != var5) {
            ...
            var5 = (Class3_Sub9)Class3.aClass61_78.method1221(4);
         }
   ...
   private final Class140_Sub1 method2022(int var1) {
      try {
         if(var1 >= -6) {
            return (Class140_Sub1)null;
         } else {
            Class28 var2 = Class16.method898((byte)42, this.anInt2915);
            Class140_Sub1 var3 = var2.method966(this.anInt2898, (byte)-30, this.anInt2922, this.anInt2896);
            if(null == var3) {
               return null;
            } else {
   ...
   final void method2023(byte var1, int var2) {
      try {
         ...
         if(var1 != -59) {
            this.method1868(121, 74, -127, 12, -105, -18, 65, 117, 43L, 84, (Class127_Sub1)null);
         }
         ...
         if(this.aClass142_2923 != null) {
            ...
            while(this.anInt2896 > this.aClass142_2923.anIntArray1869[this.anInt2922]) {
               ...
               if(this.aClass142_2923.anIntArray1851.length <= this.anInt2898) {
                  ...
                  if(-1 < ~this.anInt2898 || ~this.anInt2898 <= ~this.aClass142_2923.anIntArray1851.length) {
                     this.anInt2898 = -1;
                  }
               }
            }
   ...
   final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
      try {
         Class140_Sub1 var13 = this.method2022(-126);
         if(null != var13) {
            var13.method1868(var1, var2, var3, var4, var5, var6, var7, var8, var9, var11, this.aClass127_Sub1_2909);
   ...
   static final void method2025(byte var0, int var1) {
      try {
         if(var0 <= -25) {
            ...
            Class3_Sub16.aClass93_2442.method1522(-126, var1);
   ...
   static final void method2026(byte var0, int var1, int var2, int var3) {
      try {
         if(var0 > 114) {
            Class3_Sub28_Sub6 var4 = Class3_Sub24_Sub3.method466(4, 9, var1);
            var4.g((byte)33);
            var4.anInt3598 = var3;
            var4.anInt3597 = var2;
         }
   ...
   static final Class3_Sub28_Sub16[] method2027(int var0, byte var1, int var2, Class153 var3) {
      try {
         return !Class75_Sub4.method1351(var3, var0, var2, -30901)?null:(var1 != 11?(Class3_Sub28_Sub16[])null:Class75_Sub3.method1347(-26802));
      } catch (RuntimeException var5) {
         throw Class44.method1067(var5, "ra.B(" + var0 + ',' + var1 + ',' + var2 + ',' + (var3 != null?"{...}":"null") + ')');
      }
   }
   ...
   Class140_Sub6(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      try {
         ...
         this.anInt2925 = var6;
         this.anInt2911 = var5;
         int var12 = Class16.method898((byte)42, this.anInt2915).anInt542;
         if(0 != ~var12) {
