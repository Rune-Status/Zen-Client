...
final class Class3_Sub28_Sub1 extends Class3_Sub28 {
   ...
   private final void method527(Class3_Sub30 var1, int var2, int var3) {
      try {
         if(var2 != 0) {
            this.method526(-91, -3);
         }
         ...
         if(var3 == 1) {
            this.aClass94_3538 = var1.method776(true);
         } else {
            int var4;
            int var5;
            if(var3 != 2) {
               if(var3 == 3) {
                  var4 = var1.method803((byte)-114);
                  this.anIntArray3540 = new int[var4];
                  this.anIntArray3533 = new int[var4];

                  for(var5 = 0; var5 < var4; ++var5) {
                     this.anIntArray3540[var5] = var1.method737(var2 + 1);
                     this.anIntArray3533[var5] = Class3_Sub13_Sub33.method322(true, var1.method760(false));
                  }
               } else if(-5 == ~var3) {
                  ;
               }
            } else {
               var4 = var1.method803((byte)-38);
               this.anIntArray3534 = new int[var4];
               this.anIntArray3535 = new int[var4];

               for(var5 = 0; var5 < var4; ++var5) {
                  this.anIntArray3534[var5] = var1.method737(1);
                  this.anIntArray3535[var5] = Class3_Sub13_Sub33.method322(true, var1.method760(false));
               }
            }
         }
   ...
   final void method530(Class3_Sub30 var1, byte var2) {
      try {
         if(var2 <= 104) {
         ...
         while(true) {
            int var3 = var1.method803((byte)-62);
            if(~var3 == -1) {
               return;
            }
   ...
   static final Class94 method531(byte var0) {
      try {
         Class94 var1;
         if(-2 == ~Class164_Sub1.anInt3012 && -3 < ~Class3_Sub13_Sub34.anInt3415) {
            var1 = Class16.method903(new Class94[]{Class3_Sub13_Sub32.aClass94_3388, InputStream_Sub1.aClass94_43, Class16.aClass94_378, Class131.aClass94_1724}, (byte)-105);
         } else if(Class140.aBoolean1837 && 2 > Class3_Sub13_Sub34.anInt3415) {
            var1 = Class16.method903(new Class94[]{Class3_Sub28_Sub9.aClass94_3621, InputStream_Sub1.aClass94_43, Class40.aClass94_676, Class131.aClass94_1724}, (byte)-95);
         } else if(Class101.aBoolean1419 && Class111.aBooleanArray1490[81] && Class3_Sub13_Sub34.anInt3415 > 2) {
            var1 = Class3_Sub30.method802(Class3_Sub13_Sub34.anInt3415 + -2, true);
         } else {
            var1 = Class3_Sub30.method802(Class3_Sub13_Sub34.anInt3415 - 1, true);
         }

         if(Class3_Sub13_Sub34.anInt3415 > 2) {
            var1 = Class16.method903(new Class94[]{var1, Class1.aClass94_58, Class72.method1298((byte)9, Class3_Sub13_Sub34.anInt3415 - 2), Class3_Sub13_Sub36.aClass94_3426}, (byte)-62);
         }
   ...
   static final void method533(Color var0, boolean var1, boolean var2, Class94 var3, int var4) {
      try {
         try {
            ...
            try {
               ...
               var3.method1532(22, (-var3.method1575(-21018, Class139.aFontMetrics1822) + 304) / 2, var6, (byte)-90);
               ...
               var3.method1532(22 + var8, var7 + (-var3.method1575(-21018, Class139.aFontMetrics1822) + 304) / 2, var5, (byte)-125);
            }

            if(Class167.aClass94_2083 != null) {
               var5.setFont(Class3_Sub13_Sub32.aFont3384);
               var5.setColor(Color.white);
               Class167.aClass94_2083.method1532(Class140_Sub7.anInt2934 / 2 - 26, Class23.anInt454 / 2 - Class167.aClass94_2083.method1575(-21018, Class139.aFontMetrics1822) / 2, var5, (byte)-116);
            }
