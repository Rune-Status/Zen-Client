...
final class Class3_Sub29 extends Class3 {
   ...
   static Class94[] aClass94Array2580 = new Class94[100];
   static Class153 aClass153_2581;
   static int anInt2582 = 0;
   static boolean aBoolean2583 = false;
   static Class94 aClass94_2584 = Class3_Sub4.method108("<)4col>", (byte)-123);
   static Class94 aClass94_2585 = Class3_Sub4.method108("Connexion au serveur de mise -9 jour en cours", (byte)-124);
   Class94 aClass94_2586;
   static int anInt2587;
   static Applet_Sub1 anApplet_Sub1_2588 = null;
   ...
   static final void method728(boolean var0) {
      try {
         if(var0) {
            method731((Class153)null, (byte)118);
         }
   ...
   static final void method731(Class153 var0, byte var1) {
      try {
         int var2 = 3 / ((var1 - -62) / 37);
         Class3_Sub13_Sub13.aClass153_3154 = var0;
         Class95.anInt1344 = Class3_Sub13_Sub13.aClass153_3154.method2142(16, (byte)71);
      } catch (RuntimeException var3) {
   ...
   static final Class94 method732(String var0, int var1) {
      try {
         if(var1 != 27307) {
            anInt2589 = -93;
         }
         ...
         var3.aByteArray2153 = var2;
         var3.anInt2156 = 0;

         for(int var4 = 0; var4 < var2.length; ++var4) {
            if(-1 != ~var2[var4]) {
               var2[var3.anInt2156++] = var2[var4];
            }
         }
   ...
   static final Class3_Sub28_Sub4 method733(int var0, int var1) {
      try {
         ...
         if(null == var2) {
            byte[] var3;
            if(-32769 < ~var1) {
               var3 = Class3_Sub24_Sub3.aClass153_3490.method2133(1, (byte)-122, var1);
            } else {
               var3 = Class154.aClass153_1967.method2133(1, (byte)-122, 32767 & var1);
            }
            ...
            if(var3 != null) {
               var2.method546(new Class3_Sub30(var3), -1);
            }
   ...
   static final void method734(int var0, Class94 var1) {
      try {
         Class163_Sub2.aClass94_2996 = var1;
         if(null != Class38.aGameStub_665.anApplet1219) {
            try {
               Class94 var2 = Class163.aClass94_2044.method1573((byte)125, Class38.aGameStub_665.anApplet1219);
               Class94 var3 = Class144.aClass94_1885.method1573((byte)126, Class38.aGameStub_665.anApplet1219);
               Class94 var4 = Class16.method903(new Class94[]{var2, Class82.aClass94_1151, var1, Class166.aClass94_2074, var3}, (byte)-119);
               if(var0 == var1.method1540(var0 + -84)) {
                  var4 = Class16.method903(new Class94[]{var4, Canvas_Sub2.aClass94_28}, (byte)-60);
               } else {
                  var4 = Class16.method903(new Class94[]{var4, OutputStream_Sub1.aClass94_51, Class15.method894(94608000000L + Class5.method830((byte)-55), (byte)52), Class163_Sub3.aClass94_3000, Class3_Sub28_Sub12.method612(94608000L, (byte)102)}, (byte)-80);
               }

               Class16.method903(new Class94[]{Class129.aClass94_1694, var4, Class130.aClass94_1698}, (byte)-84).method1554(true, Class38.aGameStub_665.anApplet1219);
