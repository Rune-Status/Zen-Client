...
final class Class89 implements Runnable {
   ...
   private GameStub aGameStub_1239;
   ...
   final void method1461(int var1, int var2, int var3, byte[] var4) throws IOException {
      try {
         if(var3 == -18455) {
            if(!this.aBoolean1241) {
               while(var2 > 0) {
   ...
   final int method1462(int var1) throws IOException {
      try {
         if(var1 != 0) {
            this.method1468(43);
         }
   ...
   final void method1464(boolean var1, int var2, byte[] var3, int var4) throws IOException {
      try {
         if(!this.aBoolean1241) {
            if(!this.aBoolean1243) {
               ...
               synchronized(this) {
                  ...
                  if(null == this.aClass64_1237) {
                     this.aClass64_1237 = this.aGameStub_1239.method1451(0, 3, this);
                  }
   ...
   protected final void finalize() {
      try {
         this.method1468(14821);
      } catch (RuntimeException var2) {
         throw Class44.method1067(var2, "ma.finalize()");
      }
   }

   final int method1465(int var1) throws IOException {
      try {
         if(var1 != -18358) {
   ...
   Class89(Socket var1, GameStub var2) throws IOException {
      try {
         this.aGameStub_1239 = var2;
   ...
   static final void method1470(int var0, Class142 var1, int var2, int var3, boolean var4, int var5) {
      try {
            ...
            if(var1.anIntArrayArray1867 != null && ~var5 > ~var1.anIntArrayArray1867.length && null != var1.anIntArrayArray1867[var5]) {
               ...
               if(~var9 != -1) {
                  if(0 != Class14.anInt340) {
                     ...
                     var10 = (var3 + -64) / 128;
                     Class94.anIntArray2157[Class113.anInt1552] = 0;
