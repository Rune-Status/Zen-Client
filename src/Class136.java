...
final class Class136 {
   ...
   static final void method1814(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      try {
                  ...
                  for(int var23 = -var16; var23 < var12 - -var16; ++var23) {
                     ...
                     if(0 < var26) {
                        ...
                        if(~var27 <= -1 && ~var27 >= ~(-1 + var22.length) && null != var22[var27]) {
                           ...
                           if(-1 != ~var29) {
                              Class111 var14 = Class162.method2207(4, -1 + var29);
                              if(!Class3_Sub24_Sub4.aBooleanArray3503[var14.anInt1482]) {
                                 if(~var13 != 0 && ~var14.anInt1482 == ~Class8.anInt101) {
                                    ...
                                    Class140.aClass3_Sub28_Sub16_Sub2Array1839[var14.anInt1482].method643(var18 + -7, -7 + var24);
                                 }
                              }
                           }
                        }
         ...
         if(var7 >= 124) {
            for(Class3_Sub23 var32 = (Class3_Sub23)Class101.aClass61_1424.method1222(-108); null != var32; var32 = (Class3_Sub23)Class101.aClass61_1424.method1221(4)) {
               ...
               Class140.aClass3_Sub28_Sub16_Sub2Array1839[var32.anInt2532].method643(-7 + var32.anInt2531, -7 + var32.anInt2539);
            }
   ...
   static final void method1816(int var0, int var1) {
      try {
         if(var1 == -7) {
            ...
            Class142.anIntArray1871 = new int[var0];
            Class140_Sub4_Sub1.anIntArray3959 = new int[var0];
