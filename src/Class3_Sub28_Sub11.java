...
final class Class3_Sub28_Sub11 extends Class3_Sub28 {

   private Class130 aClass130_3636;
   static Class94 aClass94_3637 = Class3_Sub4.method108(")4p=", (byte)-119);
   private static Class94 aClass94_3638 = Class3_Sub4.method108("Loading fonts )2 ", (byte)-126);
   private static Class94 aClass94_3639 = Class3_Sub4.method108(" is already on your friend list)3", (byte)-117);
   static int anInt3640;
   static boolean aBoolean3641 = false;
   static int anInt3642 = 0;
   static Class94 aClass94_3643 = aClass94_3638;
   static int anInt3644 = 0;
   static Class94 aClass94_3645 = aClass94_3639;


   static final int method599(int var0, Class153 var1) {
      try {
         int var2 = 0;
         if(var0 != -20916) {
            return -88;
   ...
   final int method600(int var1, int var2, byte var3) {
      try {
         if(this.aClass130_3636 != null) {
            if(var3 != -29) {
               this.method604((Class94)null, (byte)56, 110);
            }
   ...
   private final void method601(Class3_Sub30 var1, int var2, byte var3) {
      try {
         if(var3 < -2) {
            if(249 == var2) {
               int var4 = var1.method803((byte)-52);
               int var5;
               if(this.aClass130_3636 == null) {
               ...
               for(var5 = 0; var4 > var5; ++var5) {
                  boolean var6 = 1 == var1.method803((byte)-94);
                  int var7 = var1.method794((byte)95);
                  Object var8;
                  if(!var6) {
   ...
   static final Class3_Sub28_Sub16 method602(int var0, int var1, byte var2, Class153 var3) {
      try {
   ...
   static final void method603(int var0, int var1, int var2, Class11 var3, boolean var4) {
      try {
         int var5 = var3.anInt168;
         int var6 = var3.anInt193;
         if(var1 != 13987) {
            method602(-115, 65, (byte)-119, (Class153)null);
         }
         ...
         if(Class69.aBoolean1040 && (-1 != ~GameClient.method44(var3).anInt2205 || ~var3.anInt187 == -1)) {
         ...
         if(var4 && null != var3.anObjectArray235 && (~var5 != ~var3.anInt168 || var3.anInt193 != var6)) {
            Class3_Sub16 var7 = new Class3_Sub16();
            var7.anObjectArray2448 = var3.anObjectArray235;
   ...
   final Class94 method604(Class94 var1, byte var2, int var3) {
      try {
         if(this.aClass130_3636 == null) {
            return var1;
         } else {
   ...
   public static void method605(int var0) {
      try {
         ...
         aClass94_3643 = null;
         if(var0 != 221301966) {
            method603(-111, -64, -10, (Class11)null, false);
         }
   ...
   static final void method607(boolean var0) {
      try {
         ...
         Class140_Sub4_Sub2.aClass94_3988 = Class38_Sub1.aClass94_2616;
         ...
         Class48.aClass94_809 = Class85.aClass94_1173;
         ...
         Class130.aClass94_1707 = Class28.aClass94_552;
         Class145.aClass94_1892 = Class13.aClass94_334;
         GameClient.aClass94_2196 = Class43.aClass94_700;
         ...
         Class16.aClass94_374 = Class3_Sub28_Sub18.aClass94_3763;
         Applet_Sub1.aClass94_4 = Class48.aClass94_808;
         ...
         Class3_Sub13_Sub33.aClass94_3397 = Class11.aClass94_297;
         Class43.aClass94_691 = Class163.aClass94_2042;
         Class24.aClass94_461 = Class109.aClass94_1466;
         ...
         Class3_Sub28.aClass94_2576 = Class3_Sub17.aClass94_2461;
         ...
         Class154.aClass94_1959 = Class94.aClass94_2149;
         Class3_Sub30.aClass94_2597 = Class3_Sub28_Sub20.aClass94_3785;
         Class28.aClass94_551 = Class121.aClass94_1647;
         Class44_Sub1.aClass94_2624 = Class164.aClass94_2053;
         ...
         Class3_Sub28_Sub2.aClass94_3546 = Class16.aClass94_355;
         Class94.aClass94_2151 = Class75_Sub4.aClass94_2662;
         ...
         Class16.aClass94_361 = Class14.aClass94_338;
         ...
         aClass94_3645 = Class142.aClass94_1863;
         ...
         Class27.aClass94_525 = Class44_Sub1.aClass94_2628;
      } catch (RuntimeException var2) {
         throw Class44.method1067(var2, "lk.A(" + var0 + ')');
      }
   }

   final void method608(int var1, Class3_Sub30 var2) {
      try {
         while(true) {
            int var3 = var2.method803((byte)-76);
            if(0 == var3) {
               if(var1 != 5) {
                  method607(false);
               }
