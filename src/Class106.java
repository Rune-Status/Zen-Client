...
final class Class106 {
   ...
   private static Class94 aClass94_1440 = Class3_Sub4.method108("Connected to update server", (byte)-117);
   static boolean aBoolean1441 = true;
   static int anInt1442 = 0;
   static Class67 aClass67_1443;
   static short aShort1444 = 256;
   static Class94 aClass94_1445 = aClass94_1440;
   ...
   static final void method1642(int var0, Class94 var1) {
      try {
         if(null != Class3_Sub28_Sub15.aClass3_Sub19Array3694) {
            ...
            long var3 = var1.method1578(var0 + -3930);
            int var2 = 0;
            if(var3 != 0L) {
               ...
               if(var2 < Class3_Sub28_Sub15.aClass3_Sub19Array3694.length && null != Class3_Sub28_Sub15.aClass3_Sub19Array3694[var2]) {
                  ++Class39.anInt671;
                  Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 162);
                  Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method740(Class3_Sub28_Sub15.aClass3_Sub19Array3694[var2].aLong71, -2037491440);
               }
            }
         }
         ...
         if(null != var4) {
            ...
            for(int var6 = 0; ~var4.anIntArray2547.length < ~var6; ++var6) {
               if(var4.anIntArray2547[var6] >= 0 && Class3_Sub13_Sub23.anInt3287 > var4.anIntArray2547[var6]) {
                  Class48 var7 = Class38.method1023(var4.anIntArray2547[var6], (byte)79);
