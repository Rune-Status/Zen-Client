...
final class Class3_Sub28_Sub4 extends Class3_Sub28 {
   ...
   private Class94[] aClass94Array3571;
   static Class93 aClass93_3572 = new Class93(64);
   static Class94 aClass94_3573 = Class3_Sub4.method108(" )2> <col=00ffff>", (byte)-124);
   static Class94 aClass94_3574 = Class3_Sub4.method108("titlebg", (byte)-118);
  
   static Class94 aClass94_3576 = Class3_Sub4.method108("name_icons", (byte)-126);
   static Class94 aClass94_3577 = Class3_Sub4.method108(": ", (byte)-120);
   private static Class94 aClass94_3578 = Class3_Sub4.method108("Loaded title screen", (byte)-126);
   static Class83 aClass83_3579;
 static Class94 aClass94_3575 = aClass94_3578;

   final void method545(Class3_Sub30 var1, int[] var2, boolean var3) {
      try {
         if(!var3) {
   ...
   final void method546(Class3_Sub30 var1, int var2) {
      try {
         while(true) {
            int var3 = var1.method803((byte)-43);
            if(0 == var3) {
               if(var2 != -1) {
   ...
   private final void method553(Class3_Sub30 var1, int var2, int var3) {
      try {
         if(var3 != -14637) {
            this.method548(-20);
         }
         ...
         if(var2 != 1) {
            ...
            if(var2 != 2) {
               if(var2 != 3) {
                  ...
                  for(var5 = 0; var4 > var5; ++var5) {
                     ...
                     for(int var7 = 0; Class155.anIntArray1976[var6] > var7; ++var7) {
                        this.anIntArrayArray3570[var5][var7] = var1.method737(1);
                     }
                  }
               }
            } else {
               ...
               for(var5 = 0; var5 < var4; ++var5) {
                  this.anIntArray3567[var5] = var1.method737(1);
               }
            }
         } else {
            this.aClass94Array3571 = var1.method776(true).method1567(60, (byte)118);
         }
   ...
   final Class94 method554(int var1) {
      try {
         if(var1 != -1) {
            return (Class94)null;
         } else {
            Class94 var2 = Class47.method1090((byte)-118, 80);
            if(null == this.aClass94Array3571) {
               ...
               for(int var3 = 1; var3 < this.aClass94Array3571.length; ++var3) {
                  var2.method1533(Applet_Sub1.aClass94_9, true);
   ...
   final Class94 method555(int var1, Class3_Sub30 var2) {
      try {
         if(var1 != 28021) {
            this.anIntArrayArray3570 = (int[][])((int[][])null);
         }

         Class94 var3 = Class47.method1090((byte)-125, 80);
         if(this.anIntArray3566 != null) {
