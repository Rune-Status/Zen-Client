...
final class Class142 {
   ...
   int anInt1850 = -1;
   int[] anIntArray1851;
   static Class153 aClass153_1852;
   static int anInt1853;
   int anInt1854 = -1;
   boolean[] aBooleanArray1855;
   static Class109 aClass109_1856;
   int anInt1857 = 5;
   static int anInt1858;
   boolean aBoolean1859 = false;
   static Class153 aClass153_1860;
   int anInt1861 = 99;
   static int anInt1862 = 0;
   static Class94 aClass94_1863 = Class3_Sub4.method108(" steht bereits auf Ihrer Freunde)2Liste(Q", (byte)-124);
   int anInt1864;
   int anInt1865 = -1;
   int anInt1866 = -1;
   ...
   final void method2053(Class3_Sub30 var1, byte var2) {
      try {
         if(var2 != -102) {
            this.method2055((Class140_Sub1)null, (byte)88, 7, 103, 54);
         }

         while(true) {
            int var3 = var1.method803((byte)-46);
            if(var3 == 0) {
               return;
            }
   ...
   final Class140_Sub1 method2054(int var1, int var2, int var3, Class140_Sub1 var4, int var5, int var6) {
      try {
         ...
         if(var8 == null) {
            ...
            if(var1 != 19749) {
               this.method2053((Class3_Sub30)null, (byte)-126);
            }

            if((this.aBoolean1846 || Class3_Sub26.aBoolean2558) && ~var3 != 0 && this.anIntArray1851.length > var3) {
            ...
            if(Class138.aBoolean1807 && this.aBoolean1848) {
               if(-2 != ~var5) {
                  if(2 != var5) {
                     if(~var5 == -4) {
   ...
   final Class140_Sub1 method2055(Class140_Sub1 var1, byte var2, int var3, int var4, int var5) {
      try {
         ...
         if(null == var8) {
            ...
            Class3_Sub28_Sub5 var9 = null;
            if((this.aBoolean1846 || Class3_Sub26.aBoolean2558) && 0 != ~var3 && ~var3 > ~this.anIntArray1851.length) {
               var3 = this.anIntArray1851[var3];
               var9 = Class3_Sub9.method133(var3 >> 16, 0);
               var3 &= '\uffff';
            }
            ...
            Class140_Sub1 var17 = var1.method1894(var15, var16, !this.aBoolean1848);
   ...
   final Class140_Sub1 method2056(int var1, int var2, int var3, int var4, Class140_Sub1 var5, int var6) {
      try {
         int var7 = this.anIntArray1869[var2];
         var2 = this.anIntArray1851[var2];
         ...
         if(null == var8) {
            ...
            var4 &= var6;
            Class3_Sub28_Sub5 var9 = null;
            if((this.aBoolean1846 || Class3_Sub26.aBoolean2558) && ~var1 != 0 && ~var1 > ~this.anIntArray1851.length) {
            ...
            if(this.aBoolean1848 && Class138.aBoolean1807) {
               if(1 != var4) {
                  if(-3 == ~var4) {
                     ((Class140_Sub1_Sub1)var10).method1911();
                  } else if(-4 == ~var4) {
   ...
   final Class140_Sub1 method2059(int var1, int var2, int var3, byte var4, Class140_Sub1 var5) {
      try {
         ...
         if(var7 == null) {
            ...
            Class3_Sub28_Sub5 var9 = null;
            if((this.aBoolean1846 || Class3_Sub26.aBoolean2558) && ~var1 != 0 && ~this.anIntArray1851.length < ~var1) {
               var1 = this.anIntArray1851[var1];
   ...
   private final void method2060(int var1, byte var2, Class3_Sub30 var3) {
      try {
         int var4;
         int var5;
         if(~var1 == -2) {
            ...
            for(var5 = 0; var4 > var5; ++var5) {
               this.anIntArray1869[var5] = var3.method737(1);
            }

            this.anIntArray1851 = new int[var4];

            for(var5 = 0; ~var5 > ~var4; ++var5) {
               this.anIntArray1851[var5] = var3.method737(1);
            }

            for(var5 = 0; var4 > var5; ++var5) {
               this.anIntArray1851[var5] += var3.method737(1) << 16;
            }
         } else if(var1 == 2) {
            this.anInt1865 = var3.method737(1);
         } else if(-4 != ~var1) {
            if(var1 == 4) {
               ...
               if(6 != var1) {
                  if(-8 == ~var1) {
                     this.anInt1849 = var3.method737(1);
                  } else if(8 == var1) {
                     this.anInt1861 = var3.method803((byte)-127);
                  } else if(9 == var1) {
                     this.anInt1866 = var3.method803((byte)-56);
                  } else if(10 != var1) {
                     if(-12 != ~var1) {
                        if(12 != var1) {
                           if(13 == var1) {
                              ...
                              for(var5 = 0; ~var4 < ~var5; ++var5) {
                                 int var6 = var3.method803((byte)-96);
                                 if(var6 > 0) {
                                    this.anIntArrayArray1867[var5] = new int[var6];
                                    this.anIntArrayArray1867[var5][0] = var3.method794((byte)102);

                                    for(int var7 = 1; ~var6 < ~var7; ++var7) {
                                       this.anIntArrayArray1867[var5][var7] = var3.method737(1);
                                    }
                                 }
                              }
                           } else if(~var1 != -15) {
                           ...
                           var4 = var3.method803((byte)-117);
                           this.anIntArray1870 = new int[var4];

                           for(var5 = 0; ~var4 < ~var5; ++var5) {
                              this.anIntArray1870[var5] = var3.method737(1);
                           }

                           for(var5 = 0; ~var4 < ~var5; ++var5) {
                              this.anIntArray1870[var5] += var3.method737(1) << 16;
                           }
                        }
                     } else {
                        this.anInt1845 = var3.method803((byte)-119);
                     }
                  } else {
                     this.anInt1850 = var3.method803((byte)-43);
                  }
               } else {
                  this.anInt1854 = var3.method737(1);
               }
            } else {
               this.anInt1857 = var3.method803((byte)-72);
            }
         } else {
            this.aBooleanArray1855 = new boolean[256];
            var4 = var3.method803((byte)-126);

            for(var5 = 0; var5 < var4; ++var5) {
               this.aBooleanArray1855[var3.method803((byte)-81)] = true;
            }
         }
   ...
   static final void method2061(boolean var0) {
      try {
         ...
         Class102.aClass140_Sub4_Sub1_2141 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[2047] = new Class140_Sub4_Sub1();
         ...
         for(var1 = 0; ~Class90.anIntArray1277.length < ~var1; ++var1) {
            Class90.anIntArray1277[var1] = -1;
         }
