...
final class Class96 {
   ...
   int anInt1346;
   int anInt1347;
   static Class94 aClass94_1348 = Class3_Sub4.method108("Kampfstufe: ", (byte)-123);
   static Class94 aClass94_1349 = Class3_Sub4.method108("underlay", (byte)-123);
   int anInt1350;
   int anInt1351;
   ...
   static final void method1587(byte var0, Class3_Sub30 var1) {
      try {
         label134:
         while(true) {
            if(~var1.aByteArray2590.length < ~var1.anInt2595) {
               boolean var18 = false;
               int var5 = 0;
               int var6 = 0;
               if(-2 == ~var1.method803((byte)-29)) {
                  var5 = var1.method803((byte)-73);
                  var18 = true;
                  var6 = var1.method803((byte)-61);
               }

               int var7 = var1.method803((byte)-101);
               int var8 = var1.method803((byte)-109);
                  ...
                  while(true) {
                     ...
                     for(int var14 = 0; ~var14 > -65; ++var14) {
                        if(!var18 || ~(8 * var5) >= ~var13 && ~var13 > ~(8 * var5 - -8) && ~var14 <= ~(8 * var6) && var14 < var6 * 8 - -8) {
                           int var15 = var1.method803((byte)-118);
                           if(0 != var15) {
                              int var2;
                              if(1 == (1 & var15)) {
                                 var2 = var1.method803((byte)-23);
