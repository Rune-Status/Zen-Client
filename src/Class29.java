...
final class Class29 {
   ...
   static int anInt555;
   int anInt556 = 0;
   static Class153 aClass153_557;
   static int[][][] anIntArrayArrayArray558;
   static Class94 aClass94_559 = Class3_Sub4.method108("m-Ochte mit Ihnen handeln)3", (byte)-119);
   static Class94 aClass94_560 = Class3_Sub4.method108(" zuerst von Ihrer Freunde)2Liste(Q", (byte)-119);
   ...
   static final void method968(int var0) {
      try {
         int[] var1 = new int[Class3_Sub13_Sub23.anInt3287];
         int var2 = 0;

         int var3;
         for(var3 = 0; Class3_Sub13_Sub23.anInt3287 > var3; ++var3) {
            Class48 var4 = Class38.method1023(var3, (byte)119);
   ...
   static final void method969(Class153 var0, int var1) {
      try {
   ...
   final void method970(int var1, Class3_Sub30 var2) {
      try {
         while(true) {
            int var3 = var2.method803((byte)-74);
            if(0 == var3) {
               if(var1 != -20638) {
                  method969((Class153)null, 55);
               }
   ...
   private final void method972(Class3_Sub30 var1, byte var2, int var3) {
      try {
         if(var2 > -86) {
            this.method970(-83, (Class3_Sub30)null);
         }

         if(~var3 == -6) {
            this.anInt556 = var1.method737(1);
         }
