...
final class Class72 {
   ...
   Class140 aClass140_1067;
   int anInt1068;
   Class140 aClass140_1069;
   static Class94 aClass94_1070 = Class3_Sub4.method108("headicons_pk", (byte)-120);
   static int anInt1071 = 0;
   static Class94 aClass94_1072 = Class3_Sub4.method108(" (X", (byte)-125);
   Class140 aClass140_1073;
   static boolean aBoolean1074 = false;
   int anInt1075;
   static Class94 aClass94_1076 = Class3_Sub4.method108("<)4col>", (byte)-118);
   int anInt1077;
   int anInt1078;
   long aLong1079;
   ...
   static final Class3_Sub28_Sub11 method1292(byte var0, int var1) {
      try {
         ...
         if(var2 != null) {
            ...
            if(var0 <= 23) {
               aClass94_1070 = (Class94)null;
            }

            byte[] var3 = Class12.aClass153_322.method2133(26, (byte)-122, var1);
            var2 = new Class3_Sub28_Sub11();
            if(var3 != null) {
               var2.method608(5, new Class3_Sub30(var3));
            }
   ...
   static final Class94 method1298(byte var0, int var1) {
      try {
         return var0 != 9?(Class94)null:Class118.method1723((byte)-117, false, 10, var1);
      } catch (RuntimeException var3) {
