...
final class Class93 {
   ...
   static Class94 aClass94_1326 = Class3_Sub4.method108(")2", (byte)-123);
   private int anInt1327;
   static byte[][][] aByteArrayArrayArray1328;
   private Class13 aClass13_1329 = new Class13();
   static int anInt1330;
   private int anInt1331;
   private Class130 aClass130_1332;


   final void method1515(byte var1, Object var2, long var3) {
      try {
   ...
   final Object method1526(long var1, byte var3) {
      try {
         Class3_Sub28_Sub7 var4 = (Class3_Sub28_Sub7)this.aClass130_1332.method1780(var1, var3 + -121);
         if(var3 != 121) {
            return (Object)null;
         } else if(null == var4) {
            return null;
         ...
         throw Class44.method1067(var7, "n.K(" + var1 + ',' + var3 + ')');
      }
   }
