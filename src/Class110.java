...
final class Class110 {
   ...
   static Class94 aClass94_1474 = Class3_Sub4.method108("::serverjs5drop", (byte)-120);
   static float aFloat1475;


   static final void method1681(int var0) {
      try {
         if(Class3_Sub13_Sub25.anInt3305 == 5) {
            if(var0 != -1) {
               aClass94_1474 = (Class94)null;
            }

            Class3_Sub13_Sub25.anInt3305 = 6;
         }
   ...
   static final void method1683(int var0, boolean var1, int var2, boolean var3, Class91 var4, int var5, int var6, int var7, byte var8, int var9, int var10) {
      try {
         if(var1 && !Class140_Sub4_Sub2.method1986(103) && 0 == (2 & Class9.aByteArrayArrayArray113[0][var7][var9])) {
            if(0 != (16 & Class9.aByteArrayArrayArray113[var2][var7][var9])) {
               return;
            }

            if(~Class4.method823(var9, var7, var8 ^ -127, var2) != ~Class140_Sub3.anInt2745) {
               return;
            }
         }
         ...
         Class111 var11 = Class162.method2207(4, var5);
         if(!Class138.aBoolean1807 || !var11.aBoolean1530) {
            int var12;
            int var13;
            if(-2 != ~var10 && ~var10 != -4) {
            ...
            if(var8 == 50) {
               ...
               int var22 = 0;
               int[][] var23;
               if(Class138.aBoolean1807 && -1 != ~var0) {
               ...
               if(var11.method1690(28933)) {
                  Class70.method1286(var9, false, var11, var10, (Class140_Sub4_Sub2)null, var7, var2, (Class140_Sub4_Sub1)null);
               }
                  ...
                  if(10 != var6 && 11 != var6) {
                     if(12 <= var6) {
                        if(-1 == var11.anInt1531 && null == var11.anIntArray1524 && !var11.aBoolean1510) {
                           ...
                           if(Class138.aBoolean1807 && var26) {
                           ...
                           if(4 != var6) {
                              ...
                              if(~var6 != -6) {
                                 ...
                                 if(0 == ~var11.anInt1531 && null == var11.anIntArray1524 && !var11.aBoolean1510) {
                                    ...
                                    if(Class138.aBoolean1807 && var26) {
                                       Class141.method2051(var47.aClass109_Sub1_1770, var20 + -(Class16.anIntArray356[var10] * 8), var22, -(Class3_Sub24_Sub3.anIntArray3491[var10] * 8) + var21);
                                    }
                                 ...
                                 Class3_Sub28_Sub8.method577(var2, var7, var9, var19, (Class140)var39, (Class140)null, Class159.anIntArray2017[var10], 0, var43 * Class16.anIntArray356[var10], Class3_Sub24_Sub3.anIntArray3491[var10] * var43, var24);
                              }
                           } else {
