...
final class Class3_Sub10 extends Class3 {
   ...
   static Class94 aClass94_2336 = Class3_Sub4.method108("M", (byte)-120);
   static int anInt2337;
   static int[] anIntArray2338 = new int[]{160, 192, 80, 96, 0, 144, 80, 48, 160};
   static byte[][][] aByteArrayArrayArray2339;
   static Class94 aClass94_2340 = Class3_Sub4.method108("Bitte warten Sie)3)3)3", (byte)-121);
   Class94 aClass94_2341;


   static final void method138(Class94 var0, int var1) {
      try {
   ...
   static final Class16 method141(boolean var0, int var1) {
      try {
         Class16 var2 = (Class16)Class154.aClass93_1955.method1526((long)var1, (byte)121);
         if(var2 == null) {
            byte[] var3 = Class97.aClass153_1372.method2133(32, (byte)-122, var1);
            if(var0) {
            ...
            var2 = new Class16();
            if(var3 != null) {
               var2.method901(-1, new Class3_Sub30(var3));
            }

            var2.method899(96);
            Class154.aClass93_1955.method1515((byte)-96, var2, (long)var1);
            return var2;
         } else {
            return var2;
         }
      } catch (RuntimeException var4) {
         throw Class44.method1067(var4, "hb.E(" + var0 + ',' + var1 + ')');
      }
   }
   ...
   Class3_Sub10(Class94 var1, int var2) {
      try {
