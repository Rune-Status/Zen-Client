...
final class Class3_Sub13_Sub15 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3183 = Class3_Sub4.method108("::wm3", (byte)-118);
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(~var1 == -1) {
            ...
            if(-3 == ~var1) {
               this.anInt3176 = (var2.method760(false) << 12) / 100;
            }
         } else {
            this.anInt3178 = (var2.method760(false) << 12) / 100;
         }
