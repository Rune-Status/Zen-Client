...
final class Class3_Sub31 extends Class3 {
   ...
   static Class94 aClass94_2605 = Class3_Sub4.method108("::clientjs5drop", (byte)-121);
   static int[] anIntArray2606;
   static int anInt2607;
   static Class94 aClass94_2608 = Class3_Sub4.method108(")4l=", (byte)-121);
   ...
   static final Class94[] method822(int var0, Class94[] var1) {
      try {
         ...
         for(int var3 = 0; ~var3 > -6; ++var3) {
            var2[var3] = Class16.method903(new Class94[]{Class72.method1298((byte)9, var3), Class3_Sub28_Sub4.aClass94_3577}, (byte)-67);
            if(var1 != null && null != var1[var3]) {
               var2[var3] = Class16.method903(new Class94[]{var2[var3], var1[var3]}, (byte)-62);
            }
         }
