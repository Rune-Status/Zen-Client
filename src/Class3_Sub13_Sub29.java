...
final class Class3_Sub13_Sub29 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3357 = Class3_Sub4.method108("", (byte)-119);
   static boolean aBoolean3358 = false;
   static int[] anIntArray3359 = new int[5];
   static Class94 aClass94_3360 = Class3_Sub4.method108("mem=", (byte)-127);
   static Class153 aClass153_3361;
   ...
   static final void method304(int var0) {
      try {
         if(var0 != 6799) {
            method305((GameStub)null, (Class3_Sub30)null, -13, (byte)41);
         }
   ...
   static final void method305(GameStub var0, Class3_Sub30 var1, int var2, byte var3) {
      try {
         int var5 = 123 % ((var3 - -66) / 57);
         Class3_Sub8 var4 = new Class3_Sub8();
         var4.anInt2296 = var1.method803((byte)-54);
         var4.anInt2305 = var1.method748(-502942936);
         ...
         for(int var6 = 0; ~var6 > ~var4.anInt2296; ++var6) {
            try {
               int var7 = var1.method803((byte)-50);
               String var8;
               String var9;
               int var10;
               if(~var7 != -1 && var7 != 1 && -3 != ~var7) {
                  if(-4 == ~var7 || -5 == ~var7) {
                     var8 = new String(var1.method776(true).method1568(0));
                     var9 = new String(var1.method776(true).method1568(0));
                     var10 = var1.method803((byte)-113);
                     String[] var11 = new String[var10];

                     for(int var12 = 0; var10 > var12; ++var12) {
                        var11[var12] = new String(var1.method776(true).method1568(0));
                     }
                     ...
                     if(3 == var7) {
                        for(int var13 = 0; ~var10 < ~var13; ++var13) {
                           var14 = var1.method748(-502942936);
                  ...
                  var9 = new String(var1.method776(true).method1568(0));
                  if(var7 == 1) {
                     var10 = var1.method748(-502942936);
                  }
   ...
   static final void method306(int var0, boolean var1, int var2) {
      try {
         Class79 var3 = Class3_Sub16.method378(var0, (byte)127);
   ...
   static final void method307(Class94[] var0, short[] var1, int var2) {
      try {
   ...
   static final Class55 method311(int var0, int var1) {
      try {
         Class55 var2 = (Class55)Class41.aClass93_684.method1526((long)var0, (byte)121);
         if(var2 != null) {
            return var2;
         } else {
            byte[] var3 = Class3_Sub13_Sub19.aClass153_3227.method2133(33, (byte)-122, var0);
            if(var1 != 5) {
               aClass94_3357 = (Class94)null;
            }
            ...
            var2 = new Class55();
            if(var3 != null) {
               var2.method1182(new Class3_Sub30(var3), var0, (byte)85);
            }

            Class41.aClass93_684.method1515((byte)-112, var2, (long)var0);
            return var2;
         }
      } catch (RuntimeException var4) {
