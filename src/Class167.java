...
final class Class167 {
   ...
   static Class94 aClass94_2082 = Class3_Sub4.method108(" <col=ffff00>", (byte)-127);
   static Class94 aClass94_2083 = null;
   static Class94 aClass94_2084 = Class3_Sub4.method108("ul", (byte)-125);
   static int anInt2085;
   static Class94 aClass94_2086 = Class3_Sub4.method108("Continuer", (byte)-120);
   ...
   static final void method2261(int var0) {
      try {
         while(true) {
            if(Class28.aClass3_Sub30_Sub1_532.method815(Class130.anInt1704, 32666) >= 27) {
               int var1 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 15);
               if(32767 != var1) {
                  boolean var2 = false;
                  if(null == Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var1]) {
                     var2 = true;
                     Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var1] = new Class140_Sub4_Sub2();
                  }

                  Class140_Sub4_Sub2 var3 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var1];
                  ...
                  int var5 = Class27.anIntArray510[Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 3)];
                  if(var2) {
                  ...
                  int var7 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 5);
                  var3.method1987(-1, Class3_Sub28.method522(Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 14), 27112));
                  if(15 < var7) {
                     var7 -= 32;
                  }
                  ...
                  var3.method1967(-2, var3.method1977((byte)114), Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0] + var8, var7 + Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0], ~var4 == -2);
   ...
   static final void method2264(boolean var0) {
      if(var0) {
         ...
         Class3_Sub23.aClass3_Sub11ArrayArray2542 = GameClient.aClass3_Sub11ArrayArray2199;
      }
   ...
   static final void method2265(int var0) {
      try {
         Class3_Sub16.aClass93_2442.method1524(3);
         if(var0 != 0) {
            aClass94_2084 = (Class94)null;
         }
   ...
   static final void method2266(int var0, int var1, byte var2) {
      try {
         if(Class9.anInt120 != 0 && var1 != -1) {
            Class70.method1285(Class3_Sub28.aClass153_2573, false, var1, 0, false, Class9.anInt120);
   ...
   static final void method2267(int var0, int var1, boolean var2, Class3_Sub30 var3, int var4, int var5, byte var6, int var7, int var8) {
      try {
         int var9;
         if(-1 >= ~var5 && ~var5 > -105 && var4 >= 0 && -105 < ~var4) {
            ...
            while(true) {
               ...
               if(var9 == 1) {
                  int var10 = var3.method803((byte)-110);
                  if(!var2) {
                     if(~var10 == -2) {
                        var10 = 0;
                     }
               ...
               if(49 >= var9) {
                  Class139.aByteArrayArrayArray1828[var8][var5][var4] = var3.method760(false);
                  Class93.aByteArrayArrayArray1328[var8][var5][var4] = (byte)((-2 + var9) / 4);
                  Class4.aByteArrayArrayArray81[var8][var5][var4] = (byte)Class3_Sub28_Sub15.method633(-2 + var9 + var7, 3);
               } else if(var9 > 81) {
            ...
            while(true) {
               var9 = var3.method803((byte)-103);
               if(~var9 == -1) {
                  break;
               }

               if(~var9 == -2) {
                  var3.method803((byte)-48);
                  break;
               }

               if(-50 <= ~var9) {
                  var3.method803((byte)-68);
               }
            }
         }
