...
final class Class20 {
   ...
   static Class94 aClass94_434 = Class3_Sub4.method108("Shift)2click ENABLED(Q", (byte)-120);
   ...
   static Class94 aClass94_436 = Class3_Sub4.method108("Cache:", (byte)-125);
   static int anInt437;
   static boolean aBoolean438 = false;
   static Class11 aClass11_439;


   static final boolean method907(int var0, int var1, int var2, int var3, int var4, Class140 var5, int var6, long var7, boolean var9) {
      if(var5 == null) {
         return true;
      } else {
         int var10 = var1 - var4;
   ...
   static final void method909(int var0, Class11 var1) {
      try {
   ...
   static final void method910(int var0, int var1, int var2, int var3, int var4, int var5, Class91 var6) {
      try {
         ...
         if(var0 < -94) {
            ...
            Class111 var12 = Class162.method2207(4, var17);
            ...
            if(~var7 != -1L) {
               ...
               if(0 == var4) {
                  ...
                  if(2 == var4) {
                     ...
                     if(var12.anInt1538 != 0 && var12.anInt1480 + var2 < 104 && -105 < ~(var12.anInt1480 + var1) && 104 > var2 + var12.anInt1485 && ~(var1 + var12.anInt1485) > -105) {
               ...
               if(Class138.aBoolean1807 && var12.aBoolean1503) {
                  if(2 != var19) {
                     if(5 != var19) {
                        if(-7 == ~var19) {
                        ...
                        Class8.method840(var12, (byte)-119, Class3_Sub24_Sub3.anIntArray3491[var18] * 8, var18, Class16.anIntArray356[var18] * 8, 4, var2, var1, var5);
                     }
                  } else {
                     if(var13 instanceof Class140_Sub3) {
                        ((Class140_Sub3)var13).method1960(-1);
