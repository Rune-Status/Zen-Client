...
final class Class153 {
   ...
   static Class153 aClass153_1948;
   ...
   final boolean method2113(byte var1) {
      try {
         if(!this.method2122(3)) {
            ...
            for(int var3 = 0; ~var3 > ~this.aClass62_1949.anIntArray953.length; ++var3) {
               int var4 = this.aClass62_1949.anIntArray953[var3];
   ...
   private final int method2114(int var1, int var2) {
      try {
         if(!this.method2130(false, var1)) {
            ...
            return this.anObjectArray1954[var1] != null?100:this.aClass151_1947.method2097(var1, '\uffff');
         }
   ...
   final void method2115(int var1, boolean var2, boolean var3) {
      try {
         ...
         if(this.method2122(3)) {
            if(var2) {
               this.aClass62_1949.anIntArray955 = null;
               this.aClass62_1949.aClass69_949 = null;
            }

            if(var3) {
               this.aClass62_1949.aClass69Array962 = null;
               this.aClass62_1949.anIntArrayArray943 = (int[][])null;
            }
   ...
   final int method2116(int var1, Class94 var2) {
      try {
   ...
   final int method2118(byte var1) {
      try {
         if(var1 >= -116) {
   ...
   final int method2120(Class94 var1, byte var2) {
      try {
         if(this.method2122(3)) {
            var1 = var1.method1534(var2 ^ 124);
            int var3 = this.aClass62_1949.aClass69_949.method1280(var1.method1574(false), var2 ^ -29);
            return this.method2130(false, var3)?(var2 != -30?87:var3):-1;
         } else {
            return -1;
         }
      } catch (RuntimeException var4) {
         throw Class44.method1067(var4, "ve.EA(" + (var1 != null?"{...}":"null") + ',' + var2 + ')');
      }
   }
   ...
   final int method2121(int var1) {
      try {
         if(!this.method2122(3)) {
            ...
            return this.aClass62_1949.anIntArray954.length;
         }
      } catch (RuntimeException var3) {
   ...
   private final boolean method2122(int var1) {
      try {
         ...
         if(this.aClass62_1949 == null) {
            ...
            this.anObjectArrayArray1952 = new Object[this.aClass62_1949.anInt960][];
            this.anObjectArray1954 = new Object[this.aClass62_1949.anInt960];
         }
   ...
   final byte[] method2123(int var1, Class94 var2, Class94 var3) {
      try {
         if(!this.method2122(var1 ^ 3)) {
            ...
            if(this.method2130(false, var4)) {
               ...
               return this.method2133(var4, (byte)-122, var5);
            } else {
               return null;
            }
         }
   ...
   final void method2124(int var1, Class94 var2) {
      try {
         if(this.method2122(3)) {
            var2 = var2.method1534(-98);
            int var3 = this.aClass62_1949.aClass69_949.method1280(var2.method1574(false), 1);
   ...
   final boolean method2125(Class94 var1, byte var2, Class94 var3) {
      try {
   ...
   final byte[] method2126(int var1, int[] var2, int var3, int var4) {
      try {
         if(!this.method2139(var1, 0, var4)) {
            return null;
         } else {
            if(this.anObjectArrayArray1952[var1] == null || this.anObjectArrayArray1952[var1][var4] == null) {
               boolean var5 = this.method2132(var1, false, var2);
               if(!var5) {
                  this.method2134(false, var1);
                  var5 = this.method2132(var1, false, var2);
                  if(!var5) {
                     return null;
                  }
               }
            ...
            if(var3 < 35) {
               ...
               byte[] var7 = Class140_Sub4_Sub2.method1985(-119, this.anObjectArrayArray1952[var1][var4], false);
               if(this.aBoolean1946) {
                  this.anObjectArrayArray1952[var1][var4] = null;
                  if(this.aClass62_1949.anIntArray954[var1] == 1) {
                     this.anObjectArrayArray1952[var1] = null;
                  }
               }
         ...
         throw Class44.method1067(var6, "ve.BA(" + var1 + ',' + (var2 != null?"{...}":"null") + ',' + var3 + ',' + var4 + ')');
      }
   }

   final boolean method2127(byte var1, Class94 var2) {
      try {
         if(this.method2122(3)) {
            var2 = var2.method1534(-98);
   ...
   private final boolean method2130(boolean var1, int var2) {
      try {
         ...
         if(this.method2122(3)) {
            if(var2 >= 0 && this.aClass62_1949.anIntArray954.length > var2 && ~this.aClass62_1949.anIntArray954[var2] != -1) {
               return true;
         ...
         throw Class44.method1067(var4, "ve.E(" + var1 + ',' + var2 + ')');
      }
   }
   ...
   private final boolean method2132(int var1, boolean var2, int[] var3) {
      try {
         if(!this.method2130(var2, var1)) {
            ...
            int[] var5 = this.aClass62_1949.anIntArrayArray959[var1];
            int var4 = this.aClass62_1949.anIntArray956[var1];
            if(this.anObjectArrayArray1952[var1] == null) {
               this.anObjectArrayArray1952[var1] = new Object[this.aClass62_1949.anIntArray954[var1]];
            }

            boolean var7 = true;
            Object[] var6 = this.anObjectArrayArray1952[var1];
            ...
            if(var7) {
               ...
               if(null != var3 && (~var3[0] != -1 || -1 != ~var3[1] || 0 != var3[2] || var3[3] != 0)) {
                  var21 = Class140_Sub4_Sub2.method1985(-124, this.anObjectArray1954[var1], true);
                  Class3_Sub30 var22 = new Class3_Sub30(var21);
                  var22.method770(var3, 120, 5, var22.aByteArray2590.length);
               } else {
                  var21 = Class140_Sub4_Sub2.method1985(-128, this.anObjectArray1954[var1], false);
               }
               ...
               try {
                  ...
                  throw Class44.method1067(var19, "T3 - " + (var3 != null) + "," + var1 + "," + var21.length + "," + Class38.method1026(var21, var21.length, false) + "," + Class38.method1026(var21, var21.length - 2, false) + "," + this.aClass62_1949.anIntArray945[var1] + "," + this.aClass62_1949.anInt964);
               }
               ...
               if(var4 > 1) {
                  ...
                  var10 -= var4 * var11 * 4;
                  Class3_Sub30 var12 = new Class3_Sub30(var23);
                  var12.anInt2595 = var10;
                  ...
                  for(int var14 = 0; ~var14 > ~var11; ++var14) {
                     ...
                     for(var16 = 0; ~var4 < ~var16; ++var16) {
                        var15 += var12.method748(-502942936);
                        if(null == var5) {
                           ;
                        }
                  ...
                  for(var16 = 0; ~var16 > ~var11; ++var16) {
                     ...
                     for(int var18 = 0; ~var4 < ~var18; ++var18) {
                        var17 += var12.method748(-502942936);
         ...
         throw Class44.method1067(var20, "ve.I(" + var1 + ',' + var2 + ',' + (var3 != null?"{...}":"null") + ')');
      }
   }

   final byte[] method2133(int var1, byte var2, int var3) {
      try {
         if(var2 != -122) {
            this.method2134(false, 93);
         }

         return this.method2126(var1, (int[])null, 52, var3);
      } catch (RuntimeException var5) {
         throw Class44.method1067(var5, "ve.M(" + var1 + ',' + var2 + ',' + var3 + ')');
      }
   }
   ...
   private final void method2134(boolean var1, int var2) {
      try {
         if(!this.aBoolean1945) {
            this.anObjectArray1954[var2] = Class15.method890(false, -101, this.aClass151_1947.method2098(var2, 0));
         } else {
   ...
   final boolean method2135(Class94 var1, int var2) {
      try {
         if(var2 >= -103) {
            return false;
      ...
      try {
         ...
         if(!this.method2122(3)) {
            ...
            for(var4 = 0; var4 < this.anObjectArray1954.length; ++var4) {
               if(0 < this.aClass62_1949.anIntArray956[var4]) {
                  var2 += 100;
   ...
   final byte[] method2138(int var1, int var2) {
      try {
         if(!this.method2122(var2 ^ 3)) {
            return null;
         } else if(~this.aClass62_1949.anIntArray954.length == -2) {
            return this.method2133(0, (byte)-122, var1);
         } else if(!this.method2130(false, var1)) {
            return null;
         } else if(~this.aClass62_1949.anIntArray954[var1] != -2) {
            if(var2 != 0) {
               return (byte[])null;
            } else {
            ...
            return this.method2133(var1, (byte)-122, 0);
         }
      } catch (RuntimeException var4) {
   ...
   private final boolean method2139(int var1, int var2, int var3) {
      try {
         if(this.method2122(3)) {
            if(var2 <= var1 && -1 >= ~var3 && ~this.aClass62_1949.anIntArray954.length < ~var1 && this.aClass62_1949.anIntArray954[var1] > var3) {
               return true;
            } else if(!Class134.aBoolean1765) {
               return false;
            } else {
         ...
         throw Class44.method1067(var5, "ve.K(" + var1 + ',' + var2 + ',' + var3 + ')');
      }
   }
   ...
   final byte[] method2140(int var1, int var2, int var3) {
      try {
         if(!this.method2139(var2, var3 + var3, var1)) {
            ...
            if(this.anObjectArrayArray1952[var2] == null || null == this.anObjectArrayArray1952[var2][var1]) {
               boolean var4 = this.method2132(var2, false, (int[])null);
               if(!var4) {
                  this.method2134(false, var2);
                  var4 = this.method2132(var2, false, (int[])null);
                  if(!var4) {
                     return null;
                  }
               }
            ...
            byte[] var6 = Class140_Sub4_Sub2.method1985(-126, this.anObjectArrayArray1952[var2][var1], false);
            return var6;
         }
      } catch (RuntimeException var5) {
         throw Class44.method1067(var5, "ve.CA(" + var1 + ',' + var2 + ',' + var3 + ')');
      }
   }

   final int[] method2141(byte var1, int var2) {
      try {
         if(var1 != -128) {
            anInt1953 = -69;
         }
         ...
         if(!this.method2130(false, var2)) {
            ...
            int[] var3 = this.aClass62_1949.anIntArrayArray959[var2];
            if(null == var3) {
               var3 = new int[this.aClass62_1949.anIntArray956[var2]];
         ...
         throw Class44.method1067(var5, "ve.G(" + var1 + ',' + var2 + ')');
      }
   }

   Class153(Class151 var1, boolean var2, boolean var3) {
      try {
   ...
   final int method2142(int var1, byte var2) {
      try {
         if(!this.method2130(false, var1)) {
            return 0;
         } else {
            ...
            return this.aClass62_1949.anIntArray954[var1];
         }
      } catch (RuntimeException var4) {
         throw Class44.method1067(var4, "ve.H(" + var1 + ',' + var2 + ')');
      }
   }
   ...
   final boolean method2144(int var1, int var2) {
      try {
         if(!this.method2122(3)) {
            return false;
         } else if(~this.aClass62_1949.anIntArray954.length == -2) {
            return this.method2129((byte)86, var2, 0);
         } else if(this.method2130(false, var2)) {
            if(1 == this.aClass62_1949.anIntArray954[var2]) {
               return this.method2129((byte)109, 0, var2);
            } else if(var1 != 0) {
               return false;
            } else {
               throw new RuntimeException();
         ...
         throw Class44.method1067(var4, "ve.A(" + var1 + ',' + var2 + ')');
      }
   }
