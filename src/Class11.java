...
final class Class11 {
   ...
   Class94[] aClass94Array171;
   Class94 aClass94_172;
   Class94[] aClass94Array173;
   ...
   int[] anIntArray207;
   int anInt208 = 0;
   static Class94 aClass94_209 = Class3_Sub4.method108("event_opbase", (byte)-127);
   int anInt210 = 0;
   int[] anIntArray211;
   int anInt212;
   int anInt213;
   ...
   byte aByte241;
   int anInt242;
   Class94 aClass94_243;
   int anInt244;
   Class94 aClass94_245;
   static float aFloat246;
   int anInt247;
   Object[] anObjectArray248;
   int[] anIntArray249;
   int anInt250 = 1;
   static Class94 aClass94_251 = null;
   int anInt252;
   int anInt253;
   int[] anIntArray254;
   int anInt255;
   ...
   int anInt296;
   static Class94 aClass94_297 = Class3_Sub4.method108("Nehmen", (byte)-118);
   int[][] anIntArrayArray298;
   int[] anIntArray299;
   int[] anIntArray300;
   int anInt301;
   Class11 aClass11_302;
   ...
   final boolean method855(int var1) {
      try {
         if(this.anIntArray207 != null) {
            ...
            Class109_Sub1 var2 = Class94.method1539(0, true, this.anInt224, Class12.aClass153_323);
            if(null == var2) {
               return false;
            } else {
               var2.method1675();
   ...
   static final Class94 method856(boolean var0) {
      try {
         if(!var0) {
            method869(127, -68);
         }

         Class94 var1 = Class3_Sub28_Sub7_Sub1.aClass94_4052;
         Class94 var2 = Class3_Sub28_Sub14.aClass94_3672;
         if(-1 != ~Class44.anInt718) {
            var1 = Class140_Sub4_Sub1.aClass94_3971;
         }

         if(null != Class163_Sub2.aClass94_2996) {
            var2 = Class16.method903(new Class94[]{Class3_Sub28_Sub11.aClass94_3637, Class163_Sub2.aClass94_2996}, (byte)-64);
         }

         return Class16.method903(new Class94[]{Class30.aClass94_577, var1, Class3_Sub28_Sub7.aClass94_3601, Class72.method1298((byte)9, Class3_Sub20.anInt2485), Class151.aClass94_1932, Class72.method1298((byte)9, Class3_Sub26.anInt2554), var2, Class140_Sub3.aClass94_2735}, (byte)-61);
      } catch (RuntimeException var3) {
         throw Class44.method1067(var3, "be.N(" + var0 + ')');
      }
   }

   final void method857(byte var1, Class94 var2, int var3) {
      try {
         if(null == this.aClass94Array171 || ~this.aClass94Array171.length >= ~var3) {
            Class94[] var4 = new Class94[1 + var3];
   ...
   final void method858(int var1, Class3_Sub30 var2) {
      try {
         if(var1 >= -94) {
            this.anInt214 = -74;
         }
         ...
         this.anInt187 = var2.method803((byte)-33);
         this.anInt318 = var2.method803((byte)-35);
         this.anInt189 = var2.method737(1);
         this.anInt316 = var2.method787((byte)100);
         this.anInt166 = var2.method787((byte)109);
         this.anInt177 = var2.method737(1);
         this.anInt244 = var2.method737(1);
         this.aByte304 = 0;
         this.aByte241 = 0;
         this.aByte273 = 0;
         this.aByte162 = 0;
         this.anInt223 = var2.method803((byte)-120);
         this.anInt190 = var2.method737(1);
         ...
         this.anInt212 = var2.method737(1);
         if(-65536 == ~this.anInt212) {
            this.anInt212 = -1;
         }

         int var3 = var2.method803((byte)-98);
         int var4;
         if(-1 > ~var3) {
            ...
            for(var4 = 0; ~var3 < ~var4; ++var4) {
               this.anIntArray275[var4] = var2.method803((byte)-102);
               this.anIntArray307[var4] = var2.method737(1);
            }
         }

         var4 = var2.method803((byte)-46);
         int var5;
         int var6;
         int var7;
         if(-1 > ~var4) {
            ...
            for(var5 = 0; ~var4 < ~var5; ++var5) {
               var6 = var2.method737(1);
               this.anIntArrayArray298[var5] = new int[var6];

               for(var7 = 0; ~var7 > ~var6; ++var7) {
                  this.anIntArrayArray298[var5][var7] = var2.method737(1);
         ...
         if(-1 == ~this.anInt187) {
            this.anInt252 = var2.method737(1);
            this.aBoolean155 = 1 == var2.method803((byte)-67);
         }

         if(~this.anInt187 == -2) {
            var2.method737(1);
            var2.method803((byte)-67);
         }
         ...
         if(~this.anInt187 == -3) {
            ...
            this.aByte304 = 3;
            var6 = var2.method803((byte)-58);
            var7 = var2.method803((byte)-115);
            if(~var6 == -2) {
               var5 |= 268435456;
            }

            int var8 = var2.method803((byte)-97);
            if(~var7 == -2) {
               var5 |= 1073741824;
            }
            ...
            int var9 = var2.method803((byte)-102);
            if(var9 == 1) {
               var5 |= 536870912;
            }

            this.anInt285 = var2.method803((byte)-125);
            this.anInt290 = var2.method803((byte)-50);
            ...
            for(var10 = 0; 20 > var10; ++var10) {
               int var11 = var2.method803((byte)-48);
               if(var11 == 1) {
                  this.anIntArray272[var10] = var2.method787((byte)110);
                  this.anIntArray300[var10] = var2.method787((byte)58);
                  this.anIntArray197[var10] = var2.method748(-502942936);
               } else {
                  this.anIntArray197[var10] = -1;
               }
            }

            this.aClass94Array173 = new Class94[5];

            for(var10 = 0; var10 < 5; ++var10) {
               Class94 var14 = var2.method776(true);
               if(~var14.method1540(-28) < -1) {
         ...
         if(3 == this.anInt187) {
            this.aBoolean226 = 1 == var2.method803((byte)-106);
         }

         if(this.anInt187 == 4 || 1 == this.anInt187) {
            this.anInt194 = var2.method803((byte)-31);
            this.anInt225 = var2.method803((byte)-23);
            this.anInt205 = var2.method803((byte)-35);
            this.anInt270 = var2.method737(1);
            if(~this.anInt270 == -65536) {
               this.anInt270 = -1;
            }

            this.aBoolean215 = 1 == var2.method803((byte)-114);
         }

         if(this.anInt187 == 4) {
            this.aClass94_232 = var2.method776(true);
            this.aClass94_172 = var2.method776(true);
         }

         if(this.anInt187 == 1 || this.anInt187 == 3 || 4 == this.anInt187) {
            this.anInt218 = var2.method748(-502942936);
         }

         if(~this.anInt187 == -4 || ~this.anInt187 == -5) {
            this.anInt253 = var2.method748(-502942936);
            this.anInt228 = var2.method748(-502942936);
            this.anInt222 = var2.method748(-502942936);
         }

         if(-6 == ~this.anInt187) {
            this.anInt224 = var2.method748(-502942936);
            this.anInt296 = var2.method748(-502942936);
         }

         if(6 == this.anInt187) {
            this.anInt202 = 1;
            this.anInt201 = var2.method737(1);
            this.anInt294 = 1;
            if(this.anInt201 == '\uffff') {
               this.anInt201 = -1;
            }

            this.anInt196 = var2.method737(1);
            if(this.anInt196 == '\uffff') {
               this.anInt196 = -1;
            }

            this.anInt305 = var2.method737(1);
            if(~this.anInt305 == -65536) {
               this.anInt305 = -1;
            }

            this.anInt198 = var2.method737(1);
            if('\uffff' == this.anInt198) {
               this.anInt198 = -1;
            }

            this.anInt164 = var2.method737(1);
            this.anInt182 = var2.method737(1);
            this.anInt308 = var2.method737(1);
         }
         ...
         if(7 == this.anInt187) {
            ...
            this.anInt194 = var2.method803((byte)-95);
            this.anInt270 = var2.method737(1);
            if(~this.anInt270 == -65536) {
               this.anInt270 = -1;
            }

            this.aBoolean215 = ~var2.method803((byte)-128) == -2;
            this.anInt218 = var2.method748(-502942936);
            this.anInt285 = var2.method787((byte)31);
            this.anInt290 = var2.method787((byte)83);
            var6 = var2.method803((byte)-74);
            if(-2 == ~var6) {
               var5 |= 1073741824;
            }
            ...
            for(var7 = 0; var7 < 5; ++var7) {
               Class94 var13 = var2.method776(true);
               if(var13.method1540(-121) > 0) {
         ...
         if(-3 == ~this.anInt318 || ~this.anInt187 == -3) {
            this.aClass94_245 = var2.method776(true);
            this.aClass94_243 = var2.method776(true);
            var6 = 63 & var2.method737(1);
            var5 |= var6 << 11;
         }

         if(this.anInt318 == 1 || this.anInt318 == 4 || -6 == ~this.anInt318 || this.anInt318 == 6) {
            this.aClass94_289 = var2.method776(true);
            if(this.aClass94_289.method1540(-33) == 0) {
               if(~this.anInt318 == -2) {
   ...
   final Class3_Sub28_Sub16 method859(boolean var1, int var2) {
      try {
         ...
         if(!var1) {
            ...
            if(~var3 != 0) {
               Class3_Sub28_Sub16 var4 = (Class3_Sub28_Sub16)Class114.aClass93_1569.method1526((long)var3, (byte)121);
               if(var4 == null) {
                  var4 = Class3_Sub28_Sub11.method602(0, var3, (byte)-18, Class12.aClass153_323);
                  if(null != var4) {
                     Class114.aClass93_1569.method1515((byte)-126, var4, (long)var3);
                  } else {
   ...
   private final Object[] method862(int var1, Class3_Sub30 var2) {
      try {
         if(var1 != -65536) {
            return (Object[])null;
         } else {
            int var3 = var2.method803((byte)-103);
            if(-1 != ~var3) {
               Object[] var4 = new Object[var3];

               for(int var5 = 0; var3 > var5; ++var5) {
                  int var6 = var2.method803((byte)-115);
                  if(0 != var6) {
                     if(-2 == ~var6) {
                        var4[var5] = var2.method776(true);
                     }
                  } else {
                     var4[var5] = new Integer(var2.method748(-502942936));
                  }
               }
   ...
   private final int[] method863(Class3_Sub30 var1, boolean var2) {
      try {
         int var3 = var1.method803((byte)-125);
         if(-1 == ~var3) {
            return null;
         } else {
            ...
            for(int var5 = 0; ~var5 > ~var3; ++var5) {
               var4[var5] = var1.method748(-502942936);
            }
   ...
   final void method864(int var1, int var2, int var3) {
      try {
         ...
         if(var3 > -66) {
            this.method858(36, (Class3_Sub30)null);
         }
      ...
      try {
         ...
         if(var4 < 125) {
            ...
            if(-2 == ~var8 && var9 == -1) {
               ...
               Class140_Sub1 var10;
               if(1 == var8) {
                  var10 = (Class140_Sub1)Class3_Sub15.aClass93_2428.method1526((long)((var8 << 16) - -var9), (byte)121);
                  if(var10 == null) {
                     ...
                     Class3_Sub15.aClass93_2428.method1515((byte)-115, var10, (long)(var9 + (var8 << 16)));
                  }
                  ...
                  if(3 != var8) {
                     if(4 == var8) {
                        Class48 var16 = Class38.method1023(var9, (byte)94);
                        ...
                        var10 = Class3_Sub28.method522(var9, 27112).method1476((Class145[])null, 0, (byte)-120, 0, var1, var5, var3, (Class142)null, 0, var2);
                        if(null != var10) {
                           return var10;
                        } else {
                           Applet_Sub1.aBoolean6 = true;
                  ...
                  var10 = Class3_Sub28.method522(var9, 27112).method1482(var2, var5, var1, 27, var3);
                  if(null != var10) {
                     return var10;
                  } else {
                     Applet_Sub1.aBoolean6 = true;
   ...
   final Class3_Sub28_Sub16 method866(byte var1, boolean var2) {
      try {
         ...
         if(0 == ~var3) {
            ...
            Class3_Sub28_Sub16 var6 = (Class3_Sub28_Sub16)Class114.aClass93_1569.method1526(var4, (byte)121);
            if(var6 != null) {
               return var6;
            } else {
               ...
               if(null == var7) {
                  ...
                  Class114.aClass93_1569.method1515((byte)-75, var9, var4);
   ...
   final void method867(int var1, Class3_Sub30 var2) {
      try {
         this.aBoolean233 = true;
         ++var2.anInt2595;
         this.anInt187 = var2.method803((byte)-120);
         if(-1 != ~(128 & this.anInt187)) {
            this.anInt187 &= 127;
            var2.method776(true);
         }

         this.anInt189 = var2.method737(var1 + 2);
         this.anInt316 = var2.method787((byte)66);
         this.anInt166 = var2.method787((byte)121);
         this.anInt177 = var2.method737(1);
         this.anInt244 = var2.method737(1);
         this.aByte304 = var2.method760(false);
         this.aByte241 = var2.method760(false);
         this.aByte273 = var2.method760(false);
         this.aByte162 = var2.method760(false);
         this.anInt190 = var2.method737(var1 ^ -2);
         ...
         this.aBoolean155 = -2 == ~var2.method803((byte)-40);
         if(~this.anInt187 == -1) {
            this.anInt240 = var2.method737(1);
            this.anInt252 = var2.method737(1);
            this.aBoolean219 = -2 == ~var2.method803((byte)-114);
         }

         int var3;
         if(~this.anInt187 == -6) {
            this.anInt224 = var2.method748(var1 + -502942935);
            this.anInt301 = var2.method737(1);
            var3 = var2.method803((byte)-39);
            this.aBoolean157 = -1 != ~(2 & var3);
            this.aBoolean186 = ~(1 & var3) != -1;
            this.anInt223 = var2.method803((byte)-82);
            this.anInt288 = var2.method803((byte)-86);
            this.anInt287 = var2.method748(-502942936);
            this.aBoolean178 = ~var2.method803((byte)-93) == -2;
            this.aBoolean199 = 1 == var2.method803((byte)-60);
         }

         if(~this.anInt187 == -7) {
            this.anInt202 = 1;
            this.anInt201 = var2.method737(var1 + 2);
            ...
            this.anInt182 = var2.method737(1);
            this.anInt308 = var2.method737(1);
            this.anInt280 = var2.method737(1);
            this.anInt164 = var2.method737(1);
            this.anInt305 = var2.method737(1);
            if('\uffff' == this.anInt305) {
               this.anInt305 = -1;
            ...
            this.aBoolean181 = var2.method803((byte)-100) == 1;
            this.aShort293 = (short)var2.method737(1);
            this.aShort169 = (short)var2.method737(1);
            this.aBoolean309 = 1 == var2.method803((byte)-64);
            if(this.aByte304 != 0) {
               this.anInt184 = var2.method737(1);
            }

            if(this.aByte241 != 0) {
               this.anInt312 = var2.method737(1);
            }
         }
         ...
         if(~this.anInt187 == -5) {
            ...
            this.aClass94_232 = var2.method776(true);
            this.anInt205 = var2.method803((byte)-124);
            this.anInt194 = var2.method803((byte)-75);
            this.anInt225 = var2.method803((byte)-38);
            this.aBoolean215 = var2.method803((byte)-51) == 1;
            this.anInt218 = var2.method748(-502942936);
         }

         if(this.anInt187 == 3) {
            this.anInt218 = var2.method748(var1 + -502942935);
            this.aBoolean226 = 1 == var2.method803((byte)-90);
            this.anInt223 = var2.method803((byte)-63);
         }

         if(-10 == ~this.anInt187) {
            this.anInt250 = var2.method803((byte)-56);
            this.anInt218 = var2.method748(-502942936);
            this.aBoolean167 = 1 == var2.method803((byte)-61);
         }

         var3 = var2.method794((byte)87);
         int var4 = var2.method803((byte)-91);
         int var5;
         if(var4 != 0) {
            this.anIntArray299 = new int[10];
            this.aByteArray263 = new byte[10];

            for(this.aByteArray231 = new byte[10]; ~var4 != -1; var4 = var2.method803((byte)-80)) {
               var5 = (var4 >> 4) - 1;
               var4 = var2.method803((byte)-63) | var4 << 8;
               var4 &= 4095;
               if(4095 == var4) {
               ...
               this.aByteArray263[var5] = var2.method760(false);
               this.aByteArray231[var5] = var2.method760(false);
            }
         }

         this.aClass94_277 = var2.method776(true);
         var5 = var2.method803((byte)-80);
         int var6 = var5 & 15;
         int var8;
         if(0 < var6) {
            this.aClass94Array171 = new Class94[var6];

            for(var8 = 0; var6 > var8; ++var8) {
               this.aClass94Array171[var8] = var2.method776(true);
            }
         }

         int var7 = var5 >> 4;
         if(var7 > 0) {
            var8 = var2.method803((byte)-93);
            ...
            this.anIntArray249[var8] = var2.method737(1);
         }

         if(1 < var7) {
            var8 = var2.method803((byte)-33);
            this.anIntArray249[var8] = var2.method737(1);
         }

         this.anInt214 = var2.method803((byte)-105);
         this.anInt179 = var2.method803((byte)-78);
         this.aBoolean200 = var2.method803((byte)-119) == 1;
         var8 = var1;
         this.aClass94_245 = var2.method776(true);
         if(0 != Class3_Sub28_Sub15.method630((byte)-34, var3)) {
            var8 = var2.method737(1);
            this.anInt266 = var2.method737(1);
            if(-65536 == ~var8) {
               var8 = -1;
            }
            ...
            this.anInt238 = var2.method737(1);
            if(this.anInt238 == '\uffff') {
               this.anInt238 = -1;
            }
         }
   ...
   final Class3_Sub28_Sub17 method868(Class109[] var1, int var2) {
      try {
         ...
         if(0 == ~this.anInt270) {
            ...
            Class3_Sub28_Sub17 var3 = (Class3_Sub28_Sub17)Class47.aClass93_743.method1526((long)this.anInt270, (byte)121);
            if(null != var3) {
               return var3;
            } else {
               ...
               if(null == var3) {
                  ...
                  Class47.aClass93_743.method1515((byte)-77, var3, (long)this.anInt270);
               }
