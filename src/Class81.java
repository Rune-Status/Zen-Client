...
final class Class81 {
   ...
   static Class94 aClass94_1140 = Class3_Sub4.method108(" steht bereits auf Ihrer Ignorieren)2Liste(Q", (byte)-119);
   static int anInt1141;
   static int[][][] anIntArrayArrayArray1142;
   static Class94 aClass94_1143 = Class3_Sub4.method108("Chargement du module texte )2 ", (byte)-120);
      ...
      try {
         if(var1 != 0L) {
            if(Class3_Sub28_Sub5.anInt3591 < 100) {
               ...
               Class94 var4 = Class41.method1052(-29664, var1).method1545((byte)-50);

               int var5;
               for(var5 = 0; ~Class3_Sub28_Sub5.anInt3591 < ~var5; ++var5) {
                  if(Class114.aLongArray1574[var5] == var1) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, Class16.method903(new Class94[]{var4, Class3_Sub13_Sub25.aClass94_3311}, (byte)-108), -1);
                     return;
                  }
               }
               ...
               for(var5 = 0; Class8.anInt104 > var5; ++var5) {
                  if(~Class50.aLongArray826[var5] == ~var1) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, Class16.method903(new Class94[]{Class38.aClass94_666, var4, Class3_Sub28_Sub10_Sub2.aClass94_4071}, (byte)-65), -1);
                     return;
                  }
               }
   ...
   static final void method1400(GameStub var0, Object var1, int var2) {
      try {
         if(var2 >= -29) {
            anIntArrayArrayArray1142 = (int[][][])((int[][][])null);
         }
   ...
   static final Class131 method1403(int var0, Class94 var1, Class153 var2) {
      try {
