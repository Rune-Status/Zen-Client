...
final class Class3_Sub5 extends Class3 {
   ...
   int anInt2268;
   static Class94 aClass94_2269 = Class3_Sub4.method108("lila:", (byte)-126);
   int anInt2270;
   int anInt2271;
   int anInt2272;
   int anInt2273;
   static Class94 aClass94_2274 = Class3_Sub4.method108("Vous ne pouvez pas ajouter votre nom -9 votre liste noire)3", (byte)-128);
   static int anInt2275 = 1;
   static Class94 aClass94_2276 = Class3_Sub4.method108("rot:", (byte)-128);
   int anInt2277;
   int anInt2278;
   int anInt2279;
   private static Class94 aClass94_2280 = Class3_Sub4.method108("Starting 3d Library", (byte)-123);
   static int anInt2281 = 0;
   int anInt2282;
   int anInt2283;
   int anInt2284;
   static Class94 aClass94_2267 = aClass94_2280;
               ...
               if(Class119.aClass131_1624.method1787(var9, (byte)-124)) {
                  ...
                  if(null != var16) {
                     ...
                     for(int var18 = 0; ~var17 < ~var18; ++var18) {
                        Class94 var19 = Class158_Sub1.aClass94Array2977[var18];
                        if(-1 + var17 > var18) {
                           var19.method1553(-4 + var19.method1540(-101), false);
                        }
   ...
   static final void method114(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9) {
      try {
         ...
         if(~var9 == ~var8 && var3 == var7 && var5 == var4 && var1 == var6) {
            Class140.method1869((byte)84, var2, var6, var7, var5, var9);
         } else {
            int var11 = var7;
            int var10 = var9;
            int var12 = var9 * 3;
            ...
            for(int var24 = 128; ~var24 >= -4097; var24 += 128) {
               ...
               Class140.method1869((byte)-119, var2, var34, var11, var33, var10);
               var10 = var33;
               var11 = var34;
            }
         }
   ...
   static final void method116(boolean var0, int var1) {
      try {
         ...
         if(Class65.anInt987 == Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7 && ~(Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7) == ~Class45.anInt733) {
            Class65.anInt987 = 0;
         }
         ...
         for(var3 = 0; var3 < var2; ++var3) {
            if(!var0) {
               ...
               var4 = Class102.aClass140_Sub4_Sub1_2141;
            }

            if(null != var4 && var4.method1966((byte)17)) {
               int var5 = var4.method1977((byte)114);
               int var6;
               if(-2 == ~var5) {
                  ...
                  var8 = var4.method1977((byte)114) + var6;
                  if(104 < var8) {
                     var8 = 104;
                  }
                  ...
                  var9 = var7 + var4.method1977((byte)114);
                  if(var7 < 0) {
                     var7 = 0;
                  }
         ...
         if(var1 == 670232012) {
            ...
            for(var3 = 0; ~var2 < ~var3; ++var3) {
               ...
               if(var4 != null && var4.method1966((byte)17)) {
                  ...
                  if((Class11.aBoolean236 && -201 > ~Class159.anInt2022 || 50 < Class159.anInt2022) && !var0 && var4.anInt2764 == var4.method1965(false).anInt368) {
                     var4.aBoolean3968 = true;
                  }

                  var7 = var4.method1977((byte)114);
                  if(-2 == ~var7) {
                  ...
                  if(null != var4.anObject2796 && ~Class44.anInt719 <= ~var4.anInt2797 && ~var4.anInt2778 < ~Class44.anInt719) {
                     var4.aBoolean3968 = false;
                     var4.anInt2831 = Class121.method1736(Class26.anInt501, 1, var4.anInt2819, var4.anInt2829);
                     Class3_Sub13_Sub25.method292(Class26.anInt501, var4.anInt2819, var4.anInt2829, var4.anInt2831, var4, var4.anInt2785, var16, var4.anInt2788, var4.anInt2777, var4.anInt2818, var4.anInt2817);
                  } else {
                     var4.anInt2831 = Class121.method1736(Class26.anInt501, 1, var4.anInt2819, var4.anInt2829);
                     Class20.method907(Class26.anInt501, var4.anInt2819, var4.anInt2829, var4.anInt2831, 64 * (var7 - 1) + 60, var4, var4.anInt2785, var16, var4.aBoolean2810);
                  }
               }
            }
