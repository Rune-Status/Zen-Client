...
final class Class3_Sub13_Sub1 extends Class3_Sub13 {
   ...
   static Class3_Sub30_Sub1 aClass3_Sub30_Sub1_3035 = new Class3_Sub30_Sub1(5000);
   private int anInt3036 = 0;
   private int anInt3037 = 1;
   private int anInt3038 = 0;
   static Class94 aClass94_3039 = Class3_Sub4.method108("0", (byte)-125);
   static Class94 aClass94_3040 = Class3_Sub4.method108("<col=40ff00>", (byte)-127);
   ...
   static final Class method170(int var0, String var1) throws ClassNotFoundException {
      try {
         ...
         return var1.equals("B")?Byte.TYPE:(!var1.equals("I")?(var1.equals("S")?Short.TYPE:(!var1.equals("J")?(var1.equals("Z")?Boolean.TYPE:(var1.equals("F")?Float.TYPE:(var1.equals("D")?Double.TYPE:(var1.equals("C")?Character.TYPE:Class.forName(var1))))):Long.TYPE)):Integer.TYPE);
   ...
   static final void method171(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         ...
         if(Canvas_Sub2.method57(var1, 104)) {
            Class47.method1095(var2, var8, var4, Class140.aClass11ArrayArray1834[var1], var3, -1, var7, var6, (byte)119, var5);
         } else {
            if(~var5 != 0) {
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         ...
         if(-1 != ~var1) {
            if(1 == var1) {
               this.anInt3036 = var2.method803((byte)-119);
            } else if(~var1 == -4) {
               this.anInt3037 = var2.method803((byte)-113);
            }
         } else {
            this.anInt3038 = var2.method803((byte)-70);
         }
