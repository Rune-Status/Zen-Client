...
class Class163_Sub2 extends Class163 {
   ...
   static Class94 aClass94_2996 = null;
   static Class94 aClass94_2997 = Class3_Sub4.method108("blinken1:", (byte)-127);
   static Class30[] aClass30Array2998 = new Class30[28];
   ...
   static final void method2219(Class3_Sub30 var0, boolean var1) {
      try {
         if(var1) {
            aClass30Array2998 = (Class30[])null;
         }

         while(~var0.anInt2595 > ~var0.aByteArray2590.length) {
            int var4 = 0;
            boolean var3 = false;
            int var5 = 0;
            if(var0.method803((byte)-94) == 1) {
               var3 = true;
               var4 = var0.method803((byte)-40);
               var5 = var0.method803((byte)-102);
            }

            int var6 = var0.method803((byte)-104);
            int var7 = var0.method803((byte)-71);
               ...
               for(int var12 = 0; ~var12 > -65; ++var12) {
                  for(int var13 = 0; var13 < 64; ++var13) {
                     if(!var3 || ~var12 <= ~(8 * var4) && var12 < 8 + var4 * 8 && var13 >= var5 * 8 && ~var13 > ~(8 + var5 * 8)) {
                        var2 = var0.method760(false);
                        if(-1 != ~var2) {
                           if(Class16.aByteArrayArrayArray383[var10][var11] == null) {
                              Class16.aByteArrayArrayArray383[var10][var11] = new byte[4096];
                           }

                           Class16.aByteArrayArrayArray383[var10][var11][var12 + (-var13 + 63 << 6)] = var2;
                           byte var14 = var0.method760(false);
