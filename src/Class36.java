...
final class Class36 {
   ...
   static final Class129 method1012(byte var0) {
      try {
         try {
            ...
            return (Class129)Class.forName("Class129_Sub2").newInstance();
   ...
   static final Class94 method1013(byte var0, int var1) {
      try {
         Class94 var2 = Class72.method1298((byte)9, var1);
         if(var0 >= -87) {
            return (Class94)null;
         } else {
            for(int var3 = var2.method1540(-123) + -3; var3 > 0; var3 -= 3) {
               var2 = Class16.method903(new Class94[]{var2.method1557(var3, 0, 0), Class3_Sub13_Sub22.aClass94_3268, var2.method1556(var3, (byte)-74)}, (byte)-62);
            }

            return var2.method1540(-50) > 9?Class16.method903(new Class94[]{Class148.aClass94_1917, var2.method1557(-8 + var2.method1540(-50), 0, 0), Class3_Sub13_Sub10.aClass94_3124, Class72.aClass94_1072, var2, Class66.aClass94_995}, (byte)-113):(6 < var2.method1540(-63)?Class16.method903(new Class94[]{Class3_Sub13_Sub17.aClass94_3211, var2.method1557(-4 + var2.method1540(-65), 0, 0), Class3_Sub28_Sub5.aClass94_3586, Class72.aClass94_1072, var2, Class66.aClass94_995}, (byte)-112):Class16.method903(new Class94[]{Class167.aClass94_2082, var2, Class3_Sub29.aClass94_2584}, (byte)-82));
         }
   ...
   final int method1015(int var1, int var2, byte[] var3, byte[] var4, int var5, int var6) {
      try {
         ...
         for(var8 = var6 << 3; var1 > var5; ++var5) {
            ...
            var7 &= -var13 >> 31;
            var13 += 24;
            var3[var12] = (byte)(var7 = Class3_Sub13_Sub29.method308(var7, var10 >>> var13));
            if(~var12 > ~var14) {
               ++var12;
               var13 -= 8;
            ...
            if(~var6 != -1) {
               ...
               if(0 == (var8 & var7)) {
                  for(var10 = -1 + var6; ~var10 <= -2; --var10) {
                     ...
                     var3[var10] = Class3_Sub13_Sub29.method308(var12, var11);
                  }
