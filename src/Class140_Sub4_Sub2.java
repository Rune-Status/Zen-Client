...
final class Class140_Sub4_Sub2 extends Class140_Sub4 {
	...
	private static Class94 aClass94_3978 = Class3_Sub4.method108("Dec", (byte)-117);
	static float aFloat3979;
	private static Class94 aClass94_3980 = Class3_Sub4.method108("Jul", (byte)-126);
	private static Class94 aClass94_3982 = Class3_Sub4.method108("May", (byte)-125);
	private static Class94 aClass94_3983 = Class3_Sub4.method108("Nov", (byte)-126);
	private static Class94 aClass94_3984 = Class3_Sub4.method108("Mar", (byte)-121);
	static int[] anIntArray3986 = new int[32];
	private static Class94 aClass94_3987 = Class3_Sub4.method108("flash3:", (byte)-123);
	static Class94 aClass94_3988 = aClass94_3987;
	static Class94 aClass94_3981 = aClass94_3987;
	private static Class94 aClass94_3989 = Class3_Sub4.method108("Jan", (byte)-121);
	private static Class94 aClass94_3990 = Class3_Sub4.method108("Feb", (byte)-124);
	static Class94 aClass94_3991 = Class3_Sub4.method108("ondulation:", (byte)-117);
	static Class94 aClass94_3992 = Class3_Sub4.method108("loginscreen", (byte)-128);
	static Class153 aClass153_3993;
	static Class153 aClass153_3994;
	static int anInt3995;
	private static Class94 aClass94_3996 = Class3_Sub4.method108("Aug", (byte)-126);
	static int[] anIntArray3997 = new int[]{19, 55, 38, 155, 255, 110, 137, 205, 76};
	static Class94 aClass94_3998 = Class3_Sub4.method108(":trade:", (byte)-128);
	private static Class94 aClass94_3999 = Class3_Sub4.method108("Apr", (byte)-128);
	private static Class94 aClass94_4000 = Class3_Sub4.method108("Jun", (byte)-122);
	static int anInt4001;
	static int anInt4002 = 0;
	private static Class94 aClass94_4003 = Class3_Sub4.method108("Sep", (byte)-126);
	private static Class94 aClass94_4004 = Class3_Sub4.method108("Oct", (byte)-122);
	...
	final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
		try {
			if(this.aClass90_3976 != null) {
				Class142 var13 = 0 != ~this.anInt2771 && -1 == ~this.anInt2828? GameClient.method45(this.anInt2771, (byte)-20):null;
				Class142 var14 = -1 != this.anInt2764 && (~this.anInt2764 != ~this.method1965(false).anInt368 || var13 == null)? GameClient.method45(this.anInt2764, (byte)-20):null;
	...
	final int method1972(int var1) {
		try {
			if(~Class158.anInt2014 != var1 && this.aClass90_3976.anIntArray1292 != null) {
