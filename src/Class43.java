...
final class Class43 {
   ...
   private static Class94 aClass94_695 = Class3_Sub4.method108("Unable to find ", (byte)-127);
   boolean aBoolean696 = false;
   int anInt697;
   int anInt698;
   static Class94 aClass94_699 = Class3_Sub4.method108("clignotant3:", (byte)-119);
   static Class94 aClass94_700 = Class3_Sub4.method108("blaugr-Un:", (byte)-120);
   static Class94 aClass94_701 = Class3_Sub4.method108("Chargement de la liste des serveurs", (byte)-127);
...
static Class94 aClass94_691 = aClass94_695;
   ...
   static final Class3_Sub28_Sub16 method1062(int var0) {
      try {
         ...
         for(int var4 = 0; ~var1 < ~var4; ++var4) {
            var3[var4] = Class3_Sub13_Sub38.anIntArray3446[Class3_Sub28_Sub15.method633(var2[var4], 255)];
         }

         Object var6;
         if(!Class138.aBoolean1807) {
            var6 = new Class3_Sub28_Sub16_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], var3);
         } else {
            var6 = new Class3_Sub28_Sub16_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], var3);
         }
   ...
   static final void method1065(int var0, Class3_Sub16 var1) {
      try {
         if(var0 != 1073376993) {
            aClass94_699 = (Class94)null;
         }

         Class48.method1104((byte)-93, 200000, var1);
      } catch (RuntimeException var3) {
   ...
   Class43(Class3_Sub30 var1) {
      try {
         if(null == Class3_Sub13_Sub9.anIntArray3107) {
            Class45.method1083((byte)-94);
         }

         this.anInt704 = var1.method803((byte)-99);
         this.aBoolean690 = -1 != ~(this.anInt704 & 16);
         this.aBoolean711 = -1 != ~(this.anInt704 & 8);
         this.anInt704 &= 7;
         this.anInt703 = var1.method737(1);
         this.anInt708 = var1.method737(1);
         this.anInt697 = var1.method737(1);
         this.anInt698 = var1.method803((byte)-78);
         this.method1061(66);
         this.aShortArray706 = new short[this.anInt698 * 2 + 1];

         int var2;
         for(var2 = 0; var2 < this.aShortArray706.length; ++var2) {
            this.aShortArray706[var2] = (short)var1.method737(1);
         }

         this.anInt713 = Class51.anIntArray834[var1.method737(1)];
         var2 = var1.method803((byte)-95);
