...
final class Class85 {
   ...
   static Class142[] aClass142Array1168 = new Class142[14];
   static float aFloat1169;
   static int anInt1170;
   static Class153 aClass153_1171;
   static int anInt1172;
   static Class94 aClass94_1173 = Class3_Sub4.method108("gr-Un:", (byte)-118);
   static int anInt1174 = 99;


   static final int method1423(boolean var0, Class3_Sub30 var1, Class94 var2) {
      try {
         if(var0) {
            method1426(17);
         }

         int var3 = var1.anInt2595;
         byte[] var4 = var2.method1568(0);
         var1.method768(-32769, var4.length);
         var1.anInt2595 += Class3_Sub13_Sub9.aClass36_3112.method1015(var4.length, -81, var1.aByteArray2590, var4, 0, var1.anInt2595);
         return var1.anInt2595 + -var3;
      } catch (RuntimeException var5) {
         throw Class44.method1067(var5, "lg.A(" + var0 + ',' + (var1 != null?"{...}":"null") + ',' + (var2 != null?"{...}":"null") + ')');
      }
   }

   static final Class109[] method1424(Class153 var0, byte var1, int var2, int var3) {
      try {
         if(var1 != -12) {
            anInt1174 = 37;
         }
   ...
   static final void method1425(int var0) {
      ...
      for(int var1 = 0; var1 < Class89.anInt1234; ++var1) {
   ...
   public static void method1426(int var0) {
      try {
         aClass153_1171 = null;
         if(var0 != -25247) {
            aClass142Array1168 = (Class142[])null;
         }
