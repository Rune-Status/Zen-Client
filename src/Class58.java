...
final class Class58 {
   ...
   static Class94 aClass94_910 = Class3_Sub4.method108("::fpson", (byte)-124);
      ...
      try {
         if(var0 == -16385) {
            ...
            if(null != Class44_Sub1.aClass155_2627) {
               Class44_Sub1.aClass155_2627.method2153((byte)-34);
            }
   ...
   static final Class155 method1195(int var0, GameStub var1, Component var2, int var3, int var4) {
      try {
         if(Class21.anInt443 == 0) {
            ...
            try {
               Class155 var9 = (Class155)Class.forName("Class155_Sub2").newInstance();
               var9.anInt1989 = var0;
               var9.anIntArray1975 = new int[(!Class94.aBoolean2150?1:2) * 256];
               ...
               if(Class3_Sub24_Sub4.anInt3507 > 0 && null == Class38_Sub1.aClass15_2613) {
                  ...
                  Class38_Sub1.aClass15_2613.aGameStub_350 = var1;
               ...
               try {
                  ...
                  var5.anIntArray1975 = new int[256 * (Class94.aBoolean2150?2:1)];
                  var5.anInt1989 = var0;
   ...
   static final void method1197(Class153 var0, byte var1) {
      try {
         if(var1 != 69) {
            method1195(-53, (GameStub)null, (Component)null, 79, 12);
         }
