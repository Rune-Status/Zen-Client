...
final class Class3_Sub13_Sub35 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3418 = Class3_Sub4.method108("(U5", (byte)-121);
   ...
   static final int method335(int var0) {
      try {
         ...
         return Class101.aBoolean1419 && Class111.aBooleanArray1490[81] && 2 < Class3_Sub13_Sub34.anInt3415?Class114.anIntArray1578[-2 + Class3_Sub13_Sub34.anInt3415]:Class114.anIntArray1578[Class3_Sub13_Sub34.anInt3415 - 1];
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var3) {
            if(var1 == 0) {
               this.aBoolean2375 = -2 == ~var2.method803((byte)-80);
            }
   ...
   static final Class3_Sub28_Sub1 method336(int var0, byte var1) {
      try {
         Class3_Sub28_Sub1 var2 = (Class3_Sub28_Sub1)Class3_Sub13_Sub11.aClass47_3137.method1092((long)var0, 1400);
         if(null != var2) {
            return var2;
         } else {
            byte[] var3;
            if(var0 < '\u8000') {
               var3 = Class47.aClass153_748.method2133(0, (byte)-122, var0);
            } else {
               var3 = Class13.aClass153_332.method2133(0, (byte)-122, var0 & 32767);
            }

            var2 = new Class3_Sub28_Sub1();
            if(null != var3) {
               var2.method530(new Class3_Sub30(var3), (byte)116);
            }
            ...
            Class3_Sub13_Sub11.aClass47_3137.method1097(var2, (long)var0, (byte)40);
            return var2;
         }
      } catch (RuntimeException var4) {
         throw Class44.method1067(var4, "tb.B(" + var0 + ',' + var1 + ')');
      }
   }
