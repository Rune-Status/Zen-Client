...
final class Class65 {
   ...
   static Class94 aClass94_981 = Class3_Sub4.method108("S-Blectionner", (byte)-123);
   static Class94 aClass94_982 = Class3_Sub4.method108("niveau ", (byte)-128);
   static Class61 aClass61_983 = new Class61();
   static int anInt984 = 0;
   static Class94 aClass94_985 = Class3_Sub4.method108("Fps:", (byte)-124);
   static Class3_Sub30[] aClass3_Sub30Array986 = new Class3_Sub30[2048];
   static int anInt987 = 0;
   static Class94 aClass94_988 = Class3_Sub4.method108("voudrait faire un -Bchange avec vous)3", (byte)-123);
   static Class94 aClass94_989 = Class3_Sub4.method108(" est d-Bj-9 dans votre liste d(Wamis)3", (byte)-120);
   static int anInt990;
   static int anInt991 = -1;
   static Class94 aClass94_992 = Class3_Sub4.method108("http:)4)4", (byte)-121);
   ...
   static final void method1236(Class153 var0, Class153 var1, int var2) {
      try {
         Class47.aClass153_748 = var1;
         if(var2 >= -94) {
            aClass94_992 = (Class94)null;
         }

         Class13.aClass153_332 = var0;
      ...
      try {
         ...
         if(Class138.aBoolean1807) {
            ...
            if(Class3_Sub13_Sub19.aShort3241 <= var7) {
               if(Class4.aShort83 < var7) {
                  var7 = Class4.aShort83;
               }
            } else {
   ...
   static final void method1240(boolean var0) {
      try {
         ...
         Class140_Sub4_Sub2.aClass3_Sub28_Sub16Array3977 = null;
         ...
         Class140.aClass109Array1831 = null;
         if(var0) {
