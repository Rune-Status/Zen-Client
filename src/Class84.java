...
final class Class84 {
   ...
   static final void method1417(int var0) {
      try {
         if(var0 < 98) {
            method1418(55, (Class153)null);
         }

         if(~Class143.anInt1875 == -11 && Class138.aBoolean1807) {
            Class117.method1719(28, 5);
         }

         if(~Class143.anInt1875 == -31) {
   ...
   static final void method1418(int var0, Class153 var1) {
      try {
         Class163_Sub2_Sub1.aClass109_Sub1Array4027 = Class3_Sub28_Sub13.method619((byte)65, Class140_Sub4_Sub2.anInt4001, var1);
         ...
         for(var2 = 0; -4 < ~var2; ++var2) {
            ...
            for(int var12 = 0; -65 < ~var12; ++var12) {
               Class52.anIntArray861[var12 + 64 * var2] = Class3_Sub13_Sub29.method308((int)var9, Class3_Sub13_Sub29.method308((int)var6 << 8, (int)var3 << 16));
               var6 += var8;
               var9 += var11;
               var3 += var5;
            }
         ...
         Class3_Sub13_Sub10.method215((byte)-89, (Class109_Sub1)null);
   ...
   static final void method1419(int var0) {
      try {
         ...
         for(int var8 = 0; ~Class3_Sub13_Sub34.anInt3415 < ~var8; ++var8) {
            ...
            Class168.aClass3_Sub28_Sub17_2096.method681(Class3_Sub30.method802(var8, true), var1 - -3, var9, var10, 0);
         }

         Class69.method1282(Class109.anInt1462, (byte)107, Class3_Sub13_Sub33.anInt3395, Class3_Sub28_Sub1.anInt3537, Class3_Sub28_Sub3.anInt3552);
   ...
   static final int method1421(int var0) {
      try {
         ...
         return ((Class3_Sub13_Sub15.aBoolean3184?1:0) << 19) + (((Class38.aBoolean661?1:0) << 16) + ((!Class128.aBoolean1685?0:1) << 15) + ((!Class106.aBoolean1441?0:1) << 13) + ((Class140_Sub6.aBoolean2910?1:0) << 10) + ((Class3_Sub13_Sub22.aBoolean3275?1:0) << 9) + ((Class11.aBoolean236?1:0) << 7) + ((!Class25.aBoolean488?0:1) << 6) + ((Class148.aBoolean1905?1:0) << 5) + (((!Class3_Sub28_Sub13.aBoolean3665?0:1) << 3) + (Class3_Sub28_Sub10.anInt3625 & 7) - (-((!Class3_Sub28_Sub7.aBoolean3604?0:1) << 4) + -((Class44_Sub1.aBoolean2623?1:0) << 8)) - (-(Class80.anInt1137 << 11 & 6144) + -((-1 == ~Class3_Sub16.anInt2453?0:1) << 20) - (((~Class9.anInt120 != -1?1:0) << 21) + ((~Class14.anInt340 == -1?0:1) << 22)))) - -(Class127_Sub1.method1757() << 23));
      } catch (RuntimeException var2) {
