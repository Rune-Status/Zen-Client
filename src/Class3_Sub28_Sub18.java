...
final class Class3_Sub28_Sub18 extends Class3_Sub28 {

   static int anInt3757;
   static Class94 aClass94_3758 = Class3_Sub4.method108("Veuillez patienter )2 tentative de r-Btablissement)3", (byte)-118);
   private int anInt3759 = -1;
   private int anInt3760;
   private static Class94 aClass94_3761 = Class3_Sub4.method108("Face here", (byte)-117);
   static Class94 aClass94_3762 = aClass94_3761;
   static Class94 aClass94_3763 = Class3_Sub4.method108("Liste der Welten geladen", (byte)-117);
   ...
   final void method712(byte var1) {
      try {
         ...
         if(-1 == ~(1 & var2)) {
            Class138.method1850(this.anInt3759);
         }

         if(0 == (var2 & 2)) {
            Class138.method1856(0);
         }
