...
final class Class3_Sub28_Sub8 extends Class3_Sub28 {
   ...
   static final int method571(int var0) {
      try {
         return var0 >= -57?-107:((double)Class140_Sub4_Sub2.aFloat3979 == 3.0D?37:((double)Class140_Sub4_Sub2.aFloat3979 == 4.0D?50:(6.0D != (double)Class140_Sub4_Sub2.aFloat3979?((double)Class140_Sub4_Sub2.aFloat3979 == 8.0D?100:200):75)));
   ...
   static final Class3_Sub28_Sub15 method572(int var0, byte var1) {
      try {
         ...
         if(var2 != null) {
            ...
            byte[] var3 = Class3_Sub1.aClass153_2203.method2133(var0, (byte)-122, 0);
            if(var3 != null) {
               ...
               Class3_Sub30 var4 = new Class3_Sub30(var3);
               var4.anInt2595 = -2 + var4.aByteArray2590.length;
               int var5 = var4.method737(1);
               int var6 = -12 + var4.aByteArray2590.length + -2 - var5;
               var4.anInt2595 = var6;
               int var7 = var4.method748(-502942936);
               var2.anInt3680 = var4.method737(var1 ^ -92);
               var2.anInt3687 = var4.method737(1);
               var2.anInt3678 = var4.method737(var1 ^ -92);
               var2.anInt3682 = var4.method737(1);
               int var8 = var4.method803((byte)-70);
               int var9;
               int var10;
               if(var8 > 0) {
               ...
               var2.aClass94Array3688 = new Class94[var7];
               var9 = 0;

               for(var2.anIntArray3690 = new int[var7]; ~var6 < ~var4.anInt2595; var2.anIntArray3683[var9++] = var10) {
                  var10 = var4.method737(var1 ^ -92);
                  if(var10 != 3) {
                     if(var10 < 100 && 21 != var10 && -39 != ~var10 && 39 != var10) {
                        var2.anIntArray3690[var9] = var4.method748(-502942936);
                     } else {
                        var2.anIntArray3690[var9] = var4.method803((byte)-67);
                     }
                  } else {
                     var2.aClass94Array3688[var9] = var4.method776(true);
                  }
               }
   ...
   static final void method574(Class140_Sub4_Sub2 var0, boolean var1) {
      try {
         if(!var1) {
            for(Class3_Sub9 var2 = (Class3_Sub9)Class89.aClass61_1242.method1222(-71); var2 != null; var2 = (Class3_Sub9)Class89.aClass61_1242.method1221(4)) {
   ...
   static final void method575(Class153 var0, int var1) {
      try {
         if(var1 != -1) {
            method575((Class153)null, -38);
         }
   ...
   static final int method576(Class94 var0, boolean var1) {
      try {
         if(Class119.aClass131_1624 != null && var0.method1540(-65) != 0) {
            if(var1) {
               return -117;
            } else {
   ...
   static final void method577(int var0, int var1, int var2, int var3, Class140 var4, Class140 var5, int var6, int var7, int var8, int var9, long var10) {
      if(var4 != null) {
