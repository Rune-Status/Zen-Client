...
final class Class3_Sub13_Sub3 extends Class3_Sub13 {
   ...
   private static Class94 aClass94_3048 = Class3_Sub4.method108("Hidden", (byte)-119);
   static Class148 aClass148_3049 = new Class148();
   private boolean aBoolean3050 = true;
   static Class94 aClass94_3051 = aClass94_3048;
   static short aShort3052 = 205;
   static Class94 aClass94_3053 = Class3_Sub4.method108("Lade Schrifts-=tze )2 ", (byte)-125);
   ...
   static final Class94 method178(byte[] var0, int var1, int var2, int var3) {
      try {
         Class94 var4 = new Class94();
         var4.aByteArray2153 = new byte[var2];
         var4.anInt2156 = 0;
         if(var1 != -4114) {
            aClass94_3053 = (Class94)null;
         }

         for(int var5 = var3; ~(var2 + var3) < ~var5; ++var5) {
            if(-1 != ~var0[var5]) {
               var4.aByteArray2153[var4.anInt2156++] = var0[var5];
            }
         }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         ...
         if(0 == var1) {
            this.anInt3047 = var2.method737(1);
         } else if(-2 == ~var1) {
            this.aBoolean3050 = var2.method803((byte)-88) == 1;
         }
   ...
   static final boolean method181(int var0) {
      try {
         ...
         try {
            return Class4.method827((byte)-83);
         } catch (IOException var4) {
            Class3_Sub13_Sub24.method289(false);
            return true;
         } catch (Exception var5) {
            String var2 = "T2 - " + Class94.anInt2147 + "," + Class7.anInt2166 + "," + Class24.anInt469 + " - " + Class130.anInt1704 + "," + (Class131.anInt1716 - -Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0]) + "," + (Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0] + Class82.anInt1152) + " - ";

            for(int var3 = 0; var3 < Class130.anInt1704 && 50 > var3; ++var3) {
               var2 = var2 + Class28.aClass3_Sub30_Sub1_532.aByteArray2590[var3] + ",";
            }
      ...
      try {
         ...
         if(this.aClass97_2376.aBoolean1379) {
            ...
            for(int var10 = 0; var10 < Class113.anInt1559; ++var10) {
               ...
               int var15 = this.anInt3047 * (-var5[Class16.anInt396 & -1 + var10] + var5[var10 + 1 & Class16.anInt396]);
               int var17 = var14 >> 12;
               int var16 = var15 >> 12;
