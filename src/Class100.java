...
final class Class100 {
   ...
   static Class153 aClass153_1410;
   boolean aBoolean1411 = true;
   int anInt1412 = -1;
   static Class136 aClass136_1413 = new Class136();
   int anInt1414 = 128;
   private static Class94 aClass94_1415 = Class3_Sub4.method108("Loaded input handler", (byte)-125);
   static int anInt1416;
   int anInt1417;
   int anInt1418;
static Class94 aClass94_1409 = aClass94_1415;
   ...
   final void method1601(int var1, Class3_Sub30 var2, int var3) {
      try {
         while(true) {
            int var4 = var2.method803((byte)-43);
            if(var4 == 0) {
               if(var3 != 255) {
                  anInt1407 = -8;
               }
   ...
   static final int method1602(int var0, Class94 var1) {
      try {
         if(Class119.aClass131_1624 != null && ~var1.method1540(var0 ^ -107) != -1) {
   ...
   private final void method1604(byte var1, int var2, Class3_Sub30 var3, int var4) {
      try {
         if(-2 != ~var2) {
            if(var2 != 2) {
               if(3 == var2) {
                  this.anInt1414 = var3.method737(1);
               } else if(~var2 == -5) {
                  this.aBoolean1411 = false;
               }
            } else {
               this.anInt1412 = var3.method737(1);
               if(-65536 == ~this.anInt1412) {
                  this.anInt1412 = -1;
               }
            }
         } else {
            this.anInt1404 = var3.method794((byte)93);
   ...
   static final void method1605(int var0, Class94 var1, int var2) {
      try {
         ++Class19.anInt421;
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(var0 + -255, 188);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method790(var2, var0 + -13326);
         if(var0 == 255) {
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method740(var1.method1578(-126), -2037491440);
         }
