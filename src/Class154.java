...
final class Class154 {
   ...
   private static Class94 aClass94_1958 = Class3_Sub4.method108("Please wait )2 attempting to reestablish)3", (byte)-125);
   static Class94 aClass94_1959 = aClass94_1958;
   static int[] anIntArray1960 = new int[14];
   
   private static Class94 aClass94_1963 = Class3_Sub4.method108("glow2:", (byte)-127);
   static Class93 aClass93_1964 = new Class93(5);
   static Class93 aClass93_1965 = new Class93(50);
   static int anInt1966 = -1;
   static Class153 aClass153_1967;
static Class94 aClass94_1961 = aClass94_1963;
   static Class94 aClass94_1962 = aClass94_1963;
   ...
   static final void method2146(int var0, int var1, int var2, int var3, Class140 var4, Class140 var5, int var6, int var7, long var8) {
   ...
   static final Class94 method2148(int var0, byte var1) {
      try {
         if(999999999 <= var0) {
            if(var1 != -78) {
               method2145((byte)-8);
