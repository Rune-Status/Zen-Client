...
public final class GameClient extends Applet_Sub1 {
   ...
   final void method38(int var1) {
      try {
         if(~Class143.anInt1875 != -1001) {
            ...
            if(null == Class3_Sub13_Sub10.aFrame3121) {
               ...
               if(Class3_Sub13_Sub10.aFrame3121 != null) {
                  ...
                  var3 = Class38.aGameStub_665.anApplet1219;
               }
               ...
               if(var4 != Class3_Sub9.anInt2334 || ~var5 != ~Class70.anInt1047) {
                  if(GameStub.aString1202.startsWith("mac")) {
         ...
         throw Class44.method1067(var9, "GameClient.K(" + var1 + ')');
      }
   }
   ...
   public static void method43(boolean var0) {
      try {
         ...
         throw Class44.method1067(var2, "GameClient.O(" + var0 + ')');
      }
   }
   ...
   final void method32(byte var1) {
      try {
         ...
         if(null != Class3_Sub13_Sub10.aFrame3121) {
            Class3_Sub28_Sub10_Sub1.method593(Class3_Sub13_Sub10.aFrame3121, true, Class38.aGameStub_665);
            Class3_Sub13_Sub10.aFrame3121 = null;
         }

         if(null != Class38.aGameStub_665) {
            Class38.aGameStub_665.method1442(this.getClass(), 0);
         }
         ...
         throw Class44.method1067(var4, "GameClient.F(" + var1 + ')');
      }
   }
   ...
   public final void init() {
      try {
         if(this.method29(27496)) {
            Class111.anInt1514 = Integer.parseInt(this.getParameter("worldid"));
            ...
            try {
               Class3_Sub20.anInt2485 = Integer.parseInt(this.getParameter("lang"));
            } catch (Exception var10) {
               Class3_Sub20.anInt2485 = 0;
            }

            Class3.method87(-31, Class3_Sub20.anInt2485);
         ...
         throw Class44.method1067(var11, "GameClient.init()");
      }
   }
   ...
   final void method39(int var1) {
	...
	Class3_Sub16.anInt2451 = Class111.anInt1514;
         Class3_Sub28_Sub7.method564(Class38.aGameStub_665, 0);
         if(Class44.anInt718 != 0) {
            if(Class44.anInt718 == 1) {
               RuntimeException_Sub1.aString2121 = this.getCodeBase().getHost();
               Class53.anInt867 = Class111.anInt1514 + 50000;
         ...
         if(GameStub.anInt1214 == 3 && 2 != Class44.anInt718) {
            Class3_Sub16.anInt2451 = Class111.anInt1514;
         }
         ...
         Class163_Sub1.anInt2994 = GameStub.anInt1214;

         try {
            if(Class38.aGameStub_665.aClass122_1198 != null) {
               Class101.aClass30_1422 = new Class30(Class38.aGameStub_665.aClass122_1198, 5200, 0);

               for(int var2 = 0; ~var2 > -29; ++var2) {
                  Class163_Sub2.aClass30Array2998[var2] = new Class30(Class38.aGameStub_665.aClass122Array1197[var2], 6000, 0);
               }

               Class114.aClass30_1572 = new Class30(Class38.aGameStub_665.aClass122_1204, 6000, 0);
               Class86.aClass41_1186 = new Class41(255, Class101.aClass30_1422, Class114.aClass30_1572, 500000);
               Class69.aClass30_1039 = new Class30(Class38.aGameStub_665.aClass122_1207, 24, 0);
               Class38.aGameStub_665.aClass122Array1197 = null;
               Class38.aGameStub_665.aClass122_1204 = null;
               Class38.aGameStub_665.aClass122_1207 = null;
               Class38.aGameStub_665.aClass122_1198 = null;
            }
         } catch (IOException var3) {
         ...
         throw Class44.method1067(var4, "GameClient.B(" + var1 + ')');
      }
   }
   ...
   final void method33(int var1) {
      try {
         ...
         throw Class44.method1067(var3, "GameClient.C(" + var1 + ')');
      }

      if(Applet_Sub1.anInt12 != 0) {
         aBoolean2201 = true;
      }
   ...
   static final Class142 method45(int var0, byte var1) {
      try {
         ...
         throw Class44.method1067(var4, "GameClient.D(" + var0 + ',' + var1 + ')');
      }
   }
   ...
   private final void method46(boolean var1, int var2) {
      try {
         ...
         throw Class44.method1067(var4, "GameClient.P(" + var1 + ',' + var2 + ')');
      }
   }
   ...
   private final void method47(byte var1) {
      try {
         ...
         throw Class44.method1067(var10, "GameClient.I(" + var1 + ')');
      }
   }
   ...
   private final void method48(boolean var1) {
      try {
         ...
         throw Class44.method1067(var3, "GameClient.J(" + var1 + ')');
      }
   }
   ...
   private final void method49(int var1) {
      try {
         ...
         if(~Class3_Sub13_Sub5.anInt3068 < -1) {
            ...
            try {
               if(~Class4.anInt80 == -1) {
                  Class17.aClass64_413 = Class38.aGameStub_665.method1441((byte)8, Class38_Sub1.aString2611, Class140_Sub6.anInt2894);
                  ++Class4.anInt80;
               }
               ...
               if(2 == Class4.anInt80) {
                  InputStream_Sub1.aClass89_41 = new Class89((Socket)Class17.aClass64_413.anObject974, Class38.aGameStub_665);
         ...
         throw Class44.method1067(var4, "GameClient.E(" + var1 + ')');
      }
   }
   ...
   public static final void main(String[] var0) {
      try {
         try {
            ...
            int var1 = -1;
            Class111.anInt1514 = Integer.parseInt(var0[0]);
            Class44.anInt718 = 2;
            ...
            if(-1 == var1) {
               ...
               Class3_Sub20.anInt2485 = var1;
            }

            Class3.method87(-78, Class3_Sub20.anInt2485);
            Class163_Sub2_Sub1.aBoolean4018 = false;
            Class3_Sub28_Sub11.aBoolean3641 = false;
            ...
            Class3_Sub26.anInt2554 = 0;
            Class163_Sub2.aClass94_2996 = Class3_Sub28_Sub14.aClass94_3672;
            GameClient var6 = new GameClient();
            Class126.aClient1671 = var6;
            var6.method40(32 - -Class3_Sub13_Sub13.anInt3148, 530, false, 1024, "runescape", 768, -8057, 28);
         ...
         throw Class44.method1067(var5, "GameClient.main(" + (var0 != null?"{...}":"null") + ')');
      }
   }
   ...
   private final void method52(int var1) {
      try {
         ...
         if(var1 >= 46) {
            ...
            if(Class96.anInt1354 == 0) {
               ...
               if(var3 > 16384 && 5000L > -Class3_Sub13_Sub24.aLong3296 + var4) {
                  ...
                  Class3_Sub17.aClass94_2464 = Class94.aClass94_2151;
               ...
               if(-11 == ~Class96.anInt1354) {
                  ...
                  if(~Class96.anInt1354 == -46) {
                     ...
                     Class44_Sub1.aClass155_2627 = Class58.method1195(22050, Class38.aGameStub_665, Class3_Sub28_Sub12.aCanvas3648, 0, 14);
                     ...
                     Class3_Sub21.aClass155_2491 = Class58.method1195(2048, Class38.aGameStub_665, Class3_Sub28_Sub12.aCanvas3648, 1, 14);
                           ...
                           if(Class96.anInt1354 != 70) {
                              if(Class96.anInt1354 == 80) {
                                 ...
                                 if(-101 == ~Class96.anInt1354) {
                                    ...
                                    Class38.aGameStub_665.method1451(0, 10, Class106.aClass67_1443);
         ...
         throw Class44.method1067(var6, "GameClient.A(" + var1 + ')');
      }
   }
   ...
   final void method25(byte var1) {
      try {
         ...
         throw Class44.method1067(var3, "GameClient.N(" + var1 + ')');
      }
   }
