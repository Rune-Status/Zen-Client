...
final class Class138 {
   ...
   private static Class94 aClass94_1819 = Class3_Sub4.method108("radeon", (byte)-119);
   static int anInt1820;
   static boolean aBoolean1821;


   private static final Class94 method1820(String var0) {
      byte[] var1;
      try {
   ...
   private static final int method1840() {
      ...
      if(var0 != 0) {
         ...
         Class94 var13 = method1820(aString1786).method1534(-98);
         if(var13.method1551(aClass94_1819, 57) != -1) {
            int var6 = 0;
            Class94[] var7 = var13.method1565(32, 40, 47).method1567(32, (byte)-98);

            for(int var8 = 0; var8 < var7.length; ++var8) {
               Class94 var9 = var7[var8];
