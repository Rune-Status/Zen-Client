...
final class Class52 {
   ...
   static Class94 aClass94_852 = Class3_Sub4.method108("(U4", (byte)-120);
   static Class94 aClass94_853 = Class3_Sub4.method108("::tele ", (byte)-120);
   int anInt854;
   private long aLong855;
   static Class94 aClass94_856 = Class3_Sub4.method108("::wm0", (byte)-120);
   ...
   final Class140_Sub1 method1157(int var1, int var2, int var3, int var4, Class142 var5, int var6, int var7, int var8) {
      try {
         if(var8 != -2012759707) {
            this.anInt854 = -32;
         }
         ...
         Class140_Sub1 var11 = (Class140_Sub1)Class80.aClass93_1131.method1526(var9, (byte)121);
         if(null == var11) {
            Class140_Sub5[] var12 = new Class140_Sub5[3];
            int var13 = 0;
            ...
            Class140_Sub5 var14 = Class3_Sub13_Sub13.method231(var3, 0).method941(true);
            if(null != var14) {
               var12[var13++] = var14;
            }
            ...
            var14 = new Class140_Sub5(var12, var13);
            ...
            Class80.aClass93_1131.method1515((byte)-111, var11, var9);
         }
   ...
   private final void method1158(int var1) {
      try {
         ...
         this.aLong860 = var4[(int)(255L & ((long)(this.anInt858 >> 8) ^ this.aLong860))] ^ this.aLong860 >>> 8;
         this.aLong860 = var4[(int)(255L & (this.aLong860 ^ (long)this.anInt858))] ^ this.aLong860 >>> 8;

         int var5;
         for(var5 = 0; 12 > var5; ++var5) {
            this.aLong860 = this.aLong860 >>> 8 ^ var4[(int)((this.aLong860 ^ (long)(this.anIntArray857[var5] >> 24)) & 255L)];
            this.aLong860 = this.aLong860 >>> 8 ^ var4[(int)(255L & (this.aLong860 ^ (long)(this.anIntArray857[var5] >> 16)))];
            this.aLong860 = var4[(int)(255L & ((long)(this.anIntArray857[var5] >> 8) ^ this.aLong860))] ^ this.aLong860 >>> 8;
            this.aLong860 = this.aLong860 >>> 8 ^ var4[(int)((this.aLong860 ^ (long)this.anIntArray857[var5]) & 255L)];
         }
   ...
   static final void method1160(int var0, int var1) {
      try {
         if(Canvas_Sub2.method57(var1, 104)) {
            if(var0 > -100) {
               method1168(52);
            }

            Class67.method1260(23206, -1, Class140.aClass11ArrayArray1834[var1]);
         }
   ...
   final void method1161(int[] var1, int var2, boolean var3, int var4, int[] var5, int var6) {
      try {
            ...
            for(int var7 = 0; -9 < ~var7; ++var7) {
               for(int var8 = 0; Class25.anInt497 > var8; ++var8) {
                  ...
                  if(null != var9 && !var9.aBoolean476 && ~var9.anInt466 == ~(!var3?Class3_Sub26.anIntArray2559[var7]:Class3_Sub13_Sub19.anIntArray3228[var7])) {
                     var5[Class163.anIntArray2043[var7]] = Class3_Sub13_Sub29.method308(Integer.MIN_VALUE, var8);
                     break;
                  }
               }
            }
         ...
         throw Class44.method1067(var10, "hh.G(" + (var1 != null?"{...}":"null") + ',' + var2 + ',' + var3 + ',' + var4 + ',' + (var5 != null?"{...}":"null") + ',' + var6 + ')');
      }
   }
   ...
   final int method1163(int var1) {
      try {
         ...
         return this.anInt854 != -1?305419896 + Class3_Sub28.method522(this.anInt854, var1 + '\ucb05').anInt1284:(this.anIntArray857[8] << 10) + ((this.anIntArray862[0] << 25) - -(this.anIntArray862[4] << 20)) - (-(this.anIntArray857[0] << 15) - ((this.anIntArray857[11] << 5) + this.anIntArray857[1]));
      } catch (RuntimeException var3) {
      ...
      try {
         ...
         if(-1 != ~this.anIntArray857[var4]) {
            if(Class3_Sub13_Sub13.method231(var2, var3) != null) {
               this.anIntArray857[var4] = Class3_Sub13_Sub29.method308(var2, Integer.MIN_VALUE);
               this.method1158(459557008);
            }
         }
      } catch (RuntimeException var5) {
   ...
   final Class140_Sub1 method1165(Class145[] var1, int var2, Class142 var3, Class142 var4, int var5, int var6, int var7, int var8, boolean var9, int var10, int var11) {
      try {
         int var12 = 102 % ((var7 - -39) / 61);
         if(0 != ~this.anInt854) {
            return Class3_Sub28.method522(this.anInt854, 27112).method1476(var1, var6, (byte)-128, var11, var2, var8, var10, var3, var5, var4);
         } else {
            ...
            if(var4 != null && (~var4.anInt1854 <= -1 || ~var4.anInt1849 <= -1)) {
               ...
               if(0 <= var4.anInt1854) {
                  if(-65536 == ~var4.anInt1854) {
                     ...
                     var15[5] = Class3_Sub13_Sub29.method308(1073741824, var4.anInt1854);
               ...
               if(~var4.anInt1849 <= -1) {
                  if(-65536 != ~var4.anInt1849) {
                     var15[3] = Class3_Sub13_Sub29.method308(1073741824, var4.anInt1849);
                     var13 ^= (long)var15[3];
                  } else {
                     var15[3] = 0;
                     var13 ^= 4294967295L;
            ...
            Class140_Sub1 var37 = (Class140_Sub1)Class148.aClass93_1911.method1526(var13, (byte)121);
            boolean var17;
            int var23;
            int var22;
            int var25;
            ...
            if(var37 == null) {
               ...
               for(int var18 = 0; -13 < ~var18; ++var18) {
                  ...
                  if(~(var19 & 1073741824) != -1) {
                     if(!Class38.method1023(1073741823 & var19, (byte)92).method1108((byte)95, this.aBoolean864)) {
                        var17 = true;
                     }
               ...
               if(var17) {
                  if(this.aLong855 != -1L) {
                     var37 = (Class140_Sub1)Class148.aClass93_1911.method1526(this.aLong855, (byte)121);
                  }
               ...
               if(null == var37) {
                  Class140_Sub5[] var39 = new Class140_Sub5[12];
                  ...
                  for(var19 = 0; ~var19 > -13; ++var19) {
                     ...
                     if(~(var20 & 1073741824) == -1) {
                        ...
                        var21 = Class38.method1023(var20 & 1073741823, (byte)115).method1117(this.aBoolean864, 80);
                        if(null != var21) {
                           var39[var19] = var21;
                        }
                     }
                  ...
                  Class16 var40 = null;
                  if(this.anInt858 != -1) {
                     var40 = Class3_Sub10.method141(false, this.anInt858);
                  }
                        ...
                        if(null != var40.anIntArrayArray359[var20] && null != var39[var20]) {
                           ...
                           if(this.anIntArrayArray863[var20] == null) {
                              ...
                              if(~var24 == -1 && -1 == ~var25 && var26 == 0) {
                                 ...
                                 var32 = Class51.anIntArray851[var26] >> 1;
                                 var33 = Class51.anIntArray840[var26] >> 1;
                  ...
                  Class140_Sub5 var43 = new Class140_Sub5(var39, var39.length);
                  ...
                  if(var9) {
                     Class148.aClass93_1911.method1515((byte)-115, var37, var13);
                     this.aLong855 = var13;
                  }
               }
            }
            ...
            for(var22 = 0; ~var45 < ~var22; ++var22) {
               if(var1[var22] != null) {
                  Class142 var41 = GameClient.method45(var1[var22].anInt1890, (byte)-20);
                  if(var41.anIntArray1851 != null) {
                     ...
                     Class166.aClass3_Sub28_Sub5Array2070[var22] = Class3_Sub9.method133(var26 >>> 16, 0);
                     var26 &= '\uffff';
                     Class140.anIntArray1833[var22] = var26;
                     if(Class166.aClass3_Sub28_Sub5Array2070[var22] != null) {
                        var42 |= Class166.aClass3_Sub28_Sub5Array2070[var22].method561(var26, (byte)119);
                        var38 |= Class166.aClass3_Sub28_Sub5Array2070[var22].method559(1317095745, var26);
                        var44 |= var41.aBoolean1848;
                     }

                     if((var41.aBoolean1846 || Class3_Sub26.aBoolean2558) && 0 != ~var25 && var25 < var41.anIntArray1851.length) {
                        Class154.anIntArray1960[var22] = var41.anIntArray1869[var24];
            ...
            if(!var17 && null == var4 && null == var3) {
               ...
               if(null != var4) {
                  ...
                  if((var4.aBoolean1846 || Class3_Sub26.aBoolean2558) && var2 != -1 && var4.anIntArray1851.length > var2) {
               ...
               if(var3 != null) {
                  ...
                  if((var3.aBoolean1846 || Class3_Sub26.aBoolean2558) && 0 != ~var6 && var3.anIntArray1851.length > var6) {
               ...
               Class140_Sub1 var51 = var37.method1894(!var38, !var42, !var44);
               var33 = 0;

               for(var34 = 1; var33 < var45; var34 <<= 1) {
                  if(Class166.aClass3_Sub28_Sub5Array2070[var33] != null) {
                     var51.method1887(Class166.aClass3_Sub28_Sub5Array2070[var33], Class140.anIntArray1833[var33], Class75.aClass3_Sub28_Sub5Array1103[var33], Class127.anIntArray1679[var33], Class3_Sub13_Sub11.anIntArray3139[var33] + -1, Class154.anIntArray1960[var33], var34, Class123.aClass142Array1654[var33].aBoolean1848, this.anIntArrayArray863[var33]);
                  }
   ...
   static final boolean method1166(int var0, byte var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, boolean var11, int var12) {
      try {
         ...
         if(var1 != 34) {
            ...
            int var16 = 0;
            boolean var17 = false;
            int[][] var18 = Class86.aClass91Array1182[Class26.anInt501].anIntArrayArray1304;
            ...
            while(~var16 != ~var28) {
               ...
               if(0 != var7) {
                  if((var7 < 5 || 10 == var7) && Class86.aClass91Array1182[Class26.anInt501].method1488(var0, var13, false, var14, var6, var7 + -1, var5, var4)) {
                     var17 = true;
                     break;
                  }

                  if(var7 < 10 && Class86.aClass91Array1182[Class26.anInt501].method1492(var0, -1 + var7, var6, var14, var5, var4, var13, 95)) {
                     var17 = true;
                     break;
                  }
               }

               if(var2 != 0 && -1 != ~var10 && Class86.aClass91Array1182[Class26.anInt501].method1498(true, var6, var14, var13, var5, var2, var8, var0, var10)) {
                  var17 = true;
                  break;
               }
   ...
   final Class140_Sub1 method1167(int var1, byte var2, Class142 var3, int var4, int var5) {
      try {
         if(0 == ~this.anInt854) {
            Class140_Sub1 var6 = (Class140_Sub1)Class80.aClass93_1131.method1526(this.aLong860, (byte)121);
            if(var2 < 122) {
               this.anIntArray862 = (int[])null;
            }
            ...
            if(var6 == null) {
               ...
               for(int var8 = 0; var8 < 12; ++var8) {
                  ...
                  } else if(!Class38.method1023(1073741823 & var9, (byte)127).method1102(this.aBoolean864, false)) {
                     var7 = true;
                  }
               }
               ...
               Class140_Sub5[] var14 = new Class140_Sub5[12];
               var9 = 0;
               ...
               for(int var10 = 0; ~var10 > -13; ++var10) {
                  ...
                  if(~(1073741824 & var11) == -1) {
                     ...
                     var12 = Class38.method1023(var11 & 1073741823, (byte)89).method1116(this.aBoolean864, (byte)-109);
                     if(var12 != null) {
                        var14[var9++] = var12;
                     }
                  }
               ...
               Class140_Sub5 var15 = new Class140_Sub5(var14, var9);
               ...
               Class80.aClass93_1131.method1515((byte)-102, var6, this.aLong860);
            }
            ...
            return Class3_Sub28.method522(this.anInt854, 27112).method1482(var3, var1, var5, -109, var4);
         }
