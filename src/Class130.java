...
final class Class130 {
   ...
   static Class94 aClass94_1698 = Class3_Sub4.method108("(R", (byte)-117);
   static Class94 aClass94_1699 = Class3_Sub4.method108(" )2> <col=ff9040>", (byte)-117);
   int anInt1700;
   static int anInt1701;
   static Class94 aClass94_1702 = Class3_Sub4.method108("Hierhin drehen", (byte)-123);
   ...
   private static Class94 aClass94_1710 = Class3_Sub4.method108("Loaded sprites", (byte)-123);
   static Class94 aClass94_1707 = aClass94_1710;
   static int anInt1711 = -2;
   static boolean[] aBooleanArray1712 = new boolean[100];
   private Class3 aClass3_1713;
   static Class94 aClass94_1714 = Class3_Sub4.method108("<col=ff7000>", (byte)-128);
   private int anInt1715 = 0;


   static final void method1772(int var0, int var1, int var2, Class140_Sub4_Sub2 var3) {
      try {
         if(var3.anInt2771 == var1 && -1 != var1) {
            Class142 var4 = GameClient.method45(var1, (byte)-20);
            ...
            if(var5 == 1) {
               ...
               var3.anInt2773 = 0;
               var3.anInt2828 = var0;
               Class89.method1470(var3.anInt2829, var4, 183921384, var3.anInt2819, false, var3.anInt2832);
            }

            if(-3 == ~var5) {
               var3.anInt2773 = 0;
            }
         } else if(~var1 == 0 || -1 == var3.anInt2771 || GameClient.method45(var1, (byte)-20).anInt1857 >= GameClient.method45(var3.anInt2771, (byte)-20).anInt1857) {
            var3.anInt2760 = 0;
            var3.anInt2771 = var1;
            var3.anInt2776 = 1;
            var3.anInt2773 = 0;
            ...
            var3.anInt2832 = 0;
            if(var3.anInt2771 != -1) {
               Class89.method1470(var3.anInt2829, GameClient.method45(var3.anInt2771, (byte)-20), var2 + 183921345, var3.anInt2819, false, var3.anInt2832);
            }
         }
   ...
   static final void method1775() {
      for(int var0 = 0; var0 < Class3_Sub13_Sub5.anInt3070; ++var0) {
         Class25 var1 = Class142.aClass25Array1868[var0];
         Class158.method2186(var1);
         Class142.aClass25Array1868[var0] = null;
      }
                                                                     ...
                                                                     if(33 == var0) {
                                                                        ...
                                                                        if(var0 == 37) {
                                                                           ...
                                                                           if(39 == var0) {
                                                                              ...
                                                                              if(!var1) {
                                                                                 method1772(8, 6, 81, (Class140_Sub4_Sub2)null);
                                                                              }
   ...
   final Class3 method1784(int var1) {
      try {
         if(null != this.aClass3_1706) {
            ...
            if(var1 != 0) {
               method1772(-100, 110, -46, (Class140_Sub4_Sub2)null);
            }
   ...
   final int method1785(int var1) {
      try {
         if(var1 < 66) {
            method1772(-91, -119, -117, (Class140_Sub4_Sub2)null);
         }
