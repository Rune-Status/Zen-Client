...
final class Class50 {
	...
	int anInt821;
	private static Class94 aClass94_832 = Class3_Sub4.method108(" has logged out)3", (byte)-121);
	private static Class94 aClass94_827 = Class3_Sub4.method108("purple:", (byte)-119);
	static Class94 aClass94_822 = aClass94_832;
	int anInt823;
	static Class3_Sub28_Sub16 aClass3_Sub28_Sub16_824;
	static Class94 aClass94_825 = aClass94_827;
	static long[] aLongArray826 = new long[200];
	static int anInt828 = 0;
	static Class94 aClass94_829 = Class3_Sub4.method108("null", (byte)-126);
	int anInt830;
	int anInt831;

	static Class94 aClass94_833 = aClass94_827;
	...
	static final void method1131(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		try {
			if(~var6 <= -1 && 0 <= var4 && -104 < ~var6 && 103 > var4) {
				...
				if(~var5 == -4) {
					Class12 var13 = Class3_Sub30.method784(var0, var6, var4);
					if(null != var13) {
