...
public abstract class Applet_Sub1 extends Applet implements Runnable, FocusListener, WindowListener {
   ...
   private static Class94 aClass94_5 = Class3_Sub4.method108(" from your ignore list first)3", (byte)-128);
   static boolean aBoolean6 = false;
   static Class94 aClass94_7 = Class3_Sub4.method108(" s(West d-Bconnect-B)3", (byte)-123);
   static Class94 aClass94_8 = Class3_Sub4.method108("", (byte)-118);
   static Class94 aClass94_9 = Class3_Sub4.method108(")3)3)3", (byte)-128);
   static Class94 aClass94_10 = Class3_Sub4.method108("::rect_debug", (byte)-128);
   static boolean aBoolean11 = false;
   public static int anInt12;
   public static boolean aBoolean13;
   static Class94 aClass94_4 = aClass94_5;
   ...
   static final Class94 method27(Class94 var0, boolean var1) {
      try {
         if(!var1) {
            method26(-78);
         }
   ...
   public final AppletContext getAppletContext() {
      try {
         return null != Class3_Sub13_Sub7.aFrame3092?null:(Class38.aGameStub_665 != null && this != Class38.aGameStub_665.anApplet1219?Class38.aGameStub_665.anApplet1219.getAppletContext():super.getAppletContext());
      } catch (RuntimeException var2) {
   ...
   final synchronized void method30(byte var1) {
      try {
         ...
         if(Class3_Sub13_Sub10.aFrame3121 != null) {
            ...
            var2 = Class38.aGameStub_665.anApplet1219;
         }
   ...
   public final void destroy() {
      try {
         if(this == Class3_Sub29.anApplet_Sub1_2588 && !Class29.aBoolean554) {
            ...
            Class3_Sub13_Sub10.aGameStub_3125 = null;
   ...
   public final URL getDocumentBase() {
      try {
         return null != Class3_Sub13_Sub7.aFrame3092?null:(Class38.aGameStub_665 != null && this != Class38.aGameStub_665.anApplet1219?Class38.aGameStub_665.anApplet1219.getDocumentBase():super.getDocumentBase());
      } catch (RuntimeException var2) {
   ...
   private final void method35(int var1, boolean var2) {
      try {
         ...
         if(Class38.aGameStub_665.anApplet1219 != null) {
            Class38.aGameStub_665.anApplet1219.destroy();
         }
         ...
         if(null != Class38.aGameStub_665) {
            try {
               Class38.aGameStub_665.method1445(0);
   ...
   public static final void setAppletStub(GameStub var0) {
      try {
         Class38.aGameStub_665 = var0;
         Class3_Sub13_Sub10.aGameStub_3125 = var0;
      } catch (RuntimeException var2) {
         throw Class44.method1067(var2, "rc.setAppletStub(" + (var0 != null?"{...}":"null") + ')');
      }
   }
   ...
   public final URL getCodeBase() {
      return Class3_Sub13_Sub7.aFrame3092 == null?(null != Class38.aGameStub_665 && this != Class38.aGameStub_665.anApplet1219?Class38.aGameStub_665.anApplet1219.getCodeBase():super.getCodeBase()):null;
   }

   public final void run() {
      try {
         try {
            if(null != GameStub.aString1216) {
               String var1 = GameStub.aString1216.toLowerCase();
               if(var1.indexOf("sun") == -1 && -1 == var1.indexOf("apple")) {
                  if(0 != ~var1.indexOf("ibm") && (GameStub.aString1196 == null || GameStub.aString1196.equals("1.4.2"))) {
                     this.method31("wrongjava", -48);
                     return;
                  }
               } else {
                  String var2 = GameStub.aString1196;
            ...
            int var7;
            if(null != GameStub.aString1196 && GameStub.aString1196.startsWith("1.")) {
               var7 = 2;

               int var9;
               for(var9 = 0; ~var7 > ~GameStub.aString1196.length(); ++var7) {
                  char var3 = GameStub.aString1196.charAt(var7);
                  if(~var3 > -49 || 57 < var3) {
                     break;
                  }
            ...
            if(null != Class38.aGameStub_665.anApplet1219) {
               Method var8 = GameStub.aMethod1220;
               if(null != var8) {
                  try {
                     var8.invoke(Class38.aGameStub_665.anApplet1219, new Object[]{Boolean.TRUE});
            ...
            while(-1L == ~Class3_Sub9.aLong2313 || Class3_Sub9.aLong2313 > Class5.method830((byte)-55)) {
               ...
               this.method37(0);
               Class81.method1400(Class38.aGameStub_665, Class3_Sub28_Sub12.aCanvas3648, -80);
            }
   ...
   public final String getParameter(String var1) {
      try {
         return Class3_Sub13_Sub7.aFrame3092 == null?(Class38.aGameStub_665 != null && this != Class38.aGameStub_665.anApplet1219?Class38.aGameStub_665.anApplet1219.getParameter(var1):super.getParameter(var1)):null;
      } catch (RuntimeException var3) {
   ...
   final void method40(int var1, int var2, boolean var3, int var4, String var5, int var6, int var7, int var8) {
      try {
         ...
         try {
            ...
            Class3_Sub13_Sub10.aGameStub_3125 = Class38.aGameStub_665 = new GameStub((Applet)null, var1, var5, var8);
            Class64 var10 = Class38.aGameStub_665.method1451(0, 1, this);
   ...
   final void method41(byte var1, int var2, int var3, int var4, int var5) {
      try {
         try {
            ...
            if(null == Class38.aGameStub_665) {
               Class3_Sub13_Sub10.aGameStub_3125 = Class38.aGameStub_665 = new GameStub(this, var3, (String)null, 0);
            }

            Class64 var7 = Class38.aGameStub_665.method1451(0, 1, this);
