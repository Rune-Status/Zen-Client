...
final class Class3_Sub13_Sub33 extends Class3_Sub13 {
   ...
   static Class94[] aClass94Array3391;
   private Class75[] aClass75Array3392;
   static Class133[] aClass133Array3393 = new Class133[6];
   static Class94 aClass94_3394 = Class3_Sub4.method108("<col=ffb000>", (byte)-123);
   static int anInt3395;
   static byte[] aByteArray3396;
   
   static volatile int anInt3398 = 0;
   static Class94 aClass94_3399 = Class3_Sub4.method108("<br>(X", (byte)-119);
   private static Class94 aClass94_3400 = Class3_Sub4.method108("Take", (byte)-126);
   static Class94 aClass94_3401 = Class3_Sub4.method108("Weiter", (byte)-118);
static Class94 aClass94_3397 = aClass94_3400;
   ...
   private final void method323(int var1, int[][] var2) {
      try {
         ...
         Class58.method1196(0, 0, (byte)111, Class3_Sub20.anInt2487, Class16.anInt396);
         ...
         if(var1 != -60) {
            method326((byte)-35, (Class94)null);
         }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var1 == 0) {
            this.aClass75Array3392 = new Class75[var2.method803((byte)-77)];

            for(int var4 = 0; ~this.aClass75Array3392.length < ~var4; ++var4) {
               int var5 = var2.method803((byte)-44);
               if(var5 == 0) {
            ...
            this.aBoolean2375 = var2.method803((byte)-48) == 1;
         }
   ...
   static final int method326(byte var0, Class94 var1) {
      try {
         if(var0 <= 13) {
            aClass94_3399 = (Class94)null;
         }

         return var1.method1540(-43) + 1;
      } catch (RuntimeException var3) {
