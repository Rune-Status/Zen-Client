...
final class Class77 {
   ...
   static Class94 aClass94_1110 = Class3_Sub4.method108("Attaquer", (byte)-126);
   static int anInt1111;
   static Class52 aClass52_1112 = new Class52();


   static final Class109_Sub1 method1364(byte var0) {
      try {
         Class109_Sub1 var1 = new Class109_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], Class163_Sub1.aByteArrayArray2987[0], Class3_Sub13_Sub38.anIntArray3446);
         if(var0 <= 55) {
            method1366(86, -88);
         }
   ...
   static final void method1368(int var0) {
      try {
         ...
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method740(0L, -2037491440);
      } catch (RuntimeException var2) {
