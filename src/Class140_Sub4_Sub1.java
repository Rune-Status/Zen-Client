...
final class Class140_Sub4_Sub1 extends Class140_Sub4 {
   ...
   int anInt3955 = -1;
   int anInt3956 = 0;
   static Class94 aClass94_3957 = Class3_Sub4.method108("Gestionnaire de saisie charg-B", (byte)-117);
   private int anInt3958 = 0;
   static int[] anIntArray3959 = new int[2];
   int anInt3960 = 0;
   static Class94 aClass94_3961 = Class3_Sub4.method108("Forced tweening ENABLED(Q", (byte)-118);
   Class52 aClass52_3962;
   int anInt3963 = -1;
   static Class94 aClass94_3964 = Class3_Sub4.method108("_labels", (byte)-121);
   int anInt3965 = 0;
   int anInt3966 = -1;
   Class94 aClass94_3967;
   boolean aBoolean3968 = false;
   int anInt3969 = 0;
   int anInt3970 = -1;
   static Class94 aClass94_3971 = Class3_Sub4.method108("www)2wtqa", (byte)-125);
   int anInt3972 = -1;
   int anInt3973 = -1;
   int anInt3974 = 0;


   final int method1977(byte var1) {
      try {
         if(null != this.aClass52_3962 && 0 != ~this.aClass52_3962.anInt854) {
            return Class3_Sub28.method522(this.aClass52_3962.anInt854, var1 + 26998).anInt1245;
         } else {
            if(var1 != 114) {
               this.method1966((byte)-22);
            }

            return super.method1977((byte)114);
         }
   ...
   final void method1978(int var1, Class3_Sub30 var2) {
      try {
         var2.anInt2595 = 0;
         int var5 = -63 / ((36 - var1) / 48);
         int var3 = var2.method803((byte)-105);
         int var8 = -1;
         int var4 = 1 & var3;
         boolean var6 = ~(var3 & 4) != -1;
         int var7 = super.method1977((byte)114);
         int[] var9 = new int[12];
         this.method1976(1 + (var3 >> 3 & 7), 2);
         this.anInt3958 = 3 & var3 >> 6;
         this.anInt2819 += (-var7 + this.method1977((byte)114)) * 64;
         this.anInt2829 += 64 * (this.method1977((byte)114) + -var7);
         this.anInt3972 = var2.method760(false);
         this.anInt3955 = var2.method760(false);
         this.anInt3956 = 0;
         ...
         for(int var10 = 0; -13 < ~var10; ++var10) {
            var11 = var2.method803((byte)-29);
            if(~var11 != -1) {
               var12 = var2.method803((byte)-109);
               var13 = (var11 << 8) - -var12;
               if(~var10 == -1 && -65536 == ~var13) {
                  var8 = var2.method737(1);
                  this.anInt3956 = var2.method803((byte)-24);
                  break;
               }
               ...
               if('\u8000' <= var13) {
                  ...
                  var14 = Class38.method1023(var13, (byte)119).anInt782;
                  if(var14 != 0) {
         ...
         this.anInt2763 = var2.method737(1);
         long var20 = var2.method756(-99);
         this.aClass94_3967 = Class41.method1052(-29664, var20).method1545((byte)-50);
         this.anInt3960 = var2.method803((byte)-41);
         if(var6) {
            this.anInt3974 = var2.method737(1);
            this.anInt3965 = this.anInt3960;
            this.anInt3970 = -1;
         } else {
            this.anInt3974 = 0;
            this.anInt3965 = var2.method803((byte)-119);
            this.anInt3970 = var2.method803((byte)-116);
         ...
         this.anInt3969 = var2.method803((byte)-87);
         if(-1 == ~this.anInt3969) {
            ...
            this.anInt3952 = var2.method737(1);
            this.anInt3966 = var2.method737(1);
            this.anInt3963 = var2.method737(1);
            this.anInt3973 = var2.method737(1);
            if(this.anInt3969 != var13 || ~this.anInt3952 != ~var14 || ~this.anInt3966 != ~var15 || var16 != this.anInt3963 || ~this.anInt3973 != ~var17) {
               Class3_Sub28.method518(this, -110);
            }
         }
         ...
         var14 = this.aClass52_3962.anInt854;
         this.aClass52_3962.method1161(var19, var8, ~var4 == -2, 0, var9, this.anInt2763);
         if(~var14 != ~var8) {
            this.anInt2819 = 128 * this.anIntArray2767[0] + this.method1977((byte)114) * 64;
            this.anInt2829 = 128 * this.anIntArray2755[0] - -(64 * this.method1977((byte)114));
         }
         ...
         throw Class44.method1067(var18, "e.P(" + var1 + ',' + (var2 != null?"{...}":"null") + ')');
      }
   }
   ...
   final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
      try {
         if(this.aClass52_3962 != null) {
            Class142 var13 = this.anInt2771 != -1 && 0 == this.anInt2828? GameClient.method45(this.anInt2771, (byte)-20):null;
            Class142 var14 = 0 != ~this.anInt2764 && !this.aBoolean3968 && (~this.anInt2764 != ~this.method1965(false).anInt368 || var13 == null)? GameClient.method45(this.anInt2764, (byte)-20):null;
            ...
            if(Class138.aBoolean1807 && Class3_Sub24_Sub3.anInt3492 < 96 && ~var16 < -51) {
            ...
            if(var15 != null) {
               ...
               Class140_Sub1 var23;
               if(Class140_Sub6.aBoolean2910 && (-1 == this.aClass52_3962.anInt854 || Class3_Sub28.method522(this.aClass52_3962.anInt854, 27112).aBoolean1249)) {
                  ...
                  for(var17 = RuntimeException_Sub1.aClass96Array2114.length + -1; -1 >= ~var17; --var17) {
                     ...
                     if(var27 != null && ~var27.anInt1355 != 0) {
                        ...
                        if(-2 == ~var27.anInt1360 && 0 <= var27.anInt1359 && ~Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292.length < ~var27.anInt1359) {
                           Class140_Sub4_Sub2 var24 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var27.anInt1359];
                           if(null != var24) {
                        ...
                        if(-11 == ~var27.anInt1360 && var27.anInt1359 >= 0 && ~Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269.length < ~var27.anInt1359) {
                           Class140_Sub4_Sub1 var28 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var27.anInt1359];
                           if(null != var28) {
               ...
               if(!this.aBoolean3968 && 0 != ~this.anInt2842 && this.anInt2805 != -1) {
                  Class28 var26 = Class16.method898((byte)42, this.anInt2842);
   ...
   final Class94 method1980(int var1) {
      try {
         Class94 var2 = this.aClass94_3967;
         if(var1 != 0) {
            this.method1868(-63, 126, 58, -9, -74, -119, -45, -114, -62L, -76, (Class127_Sub1)null);
         }

         if(Class3_Sub30_Sub1.aClass94Array3802 != null) {
            var2 = Class16.method903(new Class94[]{Class3_Sub30_Sub1.aClass94Array3802[this.anInt3958], var2}, (byte)-92);
         }

         if(null != OutputStream_Sub1.aClass94Array45) {
            var2 = Class16.method903(new Class94[]{var2, OutputStream_Sub1.aClass94Array45[this.anInt3958]}, (byte)-128);
         }
   ...
   final void method1981(byte var1, int var2, boolean var3, int var4) {
      try {
         super.method1967(var1 + -128, this.method1977((byte)114), var2, var4, var3);
         if(var1 != 126) {
            aClass94_3964 = (Class94)null;
         }
