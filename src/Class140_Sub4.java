...
abstract class Class140_Sub4 extends Class140 {
   ...
   int anInt2763 = -1;
   int anInt2764 = -1;
   static Class94 aClass94_2765 = Class3_Sub4.method108(" ", (byte)-120);
   ...
   int anInt2820 = -32768;
   int anInt2821 = 0;
   private int anInt2822 = 1;
   int anInt2823;
   int anInt2824 = 0;
   Class94 aClass94_2825 = null;
   int anInt2826 = -1;
   ...
   final Class16 method1965(boolean var1) {
      try {
         int var2 = this.method1972(-1);
         return var1?(Class16)null:(0 == ~var2?Class4.aClass16_84:Class3_Sub10.method141(false, var2));
   ...
   final void method1967(int var1, int var2, int var3, int var4, boolean var5) {
      try {
         if(~this.anInt2771 != 0 && -2 == ~GameClient.method45(this.anInt2771, (byte)-20).anInt1850) {
            this.anInt2771 = -1;
         }
         ...
         if(Class138.aBoolean1807 && Class102.aClass140_Sub4_Sub1_2141 == this) {
   ...
   final void method1968(int var1, byte var2, int var3) {
      try {
         ...
         if(~this.anInt2771 != 0 && 1 == GameClient.method45(this.anInt2771, (byte)-20).anInt1850) {
            this.anInt2771 = -1;
         }
   ...
   final void method1969(byte var1, Class140_Sub1 var2, int var3) {
      try {
         if(var1 <= 33) {
            this.method1971((Class140_Sub1)null, (byte)-26);
         }

         Class3_Sub28_Sub9.anInt3623 = 0;
         Class3_Sub13_Sub16.anInt3198 = 0;
         Class3_Sub13_Sub9.anInt3111 = 0;
         Class16 var4 = this.method1965(false);
         ...
         if(-1 != ~var5 && var6 != 0) {
            ...
            int var13 = Class121.method1736(Class26.anInt501, 1, var11 + this.anInt2819, this.anInt2829 + var12);
            int var14 = var5 / 2;
            int var15 = -var6 / 2;
            int var16 = var14 * var8 + var15 * var7 >> 16;
            int var20 = var6 / 2;
            int var17 = var15 * var8 + -(var14 * var7) >> 16;
            int var18 = Class121.method1736(Class26.anInt501, 1, var16 + this.anInt2819, this.anInt2829 - -var17);
            int var19 = -var5 / 2;
            ...
            int var23 = Class121.method1736(Class26.anInt501, 1, this.anInt2819 + var21, var22 + this.anInt2829);
            int var29 = ~var18 < ~var13?var13:var18;
            int var28 = Class121.method1736(Class26.anInt501, 1, var26 + this.anInt2819, var27 + this.anInt2829);
   ...
   final void method1971(Class140_Sub1 var1, byte var2) {
      try {
         if(var2 > -102) {
            this.method1976(1, -96);
         }

         Class16 var3 = this.method1965(false);
   ...
   abstract int method1972(int var1);
   ...
   int method1977(byte var1) {
      try {
         return var1 != 114?-24:this.anInt2822;
      } catch (RuntimeException var3) {
