...
class Class3_Sub30 extends Class3 {
    ...
    private static Class94 aClass94_2593 = Class3_Sub4.method108("Loaded interfaces", (byte) -117);
    static Class94 aClass94_2594 = Class3_Sub4.method108("Polices charg-Bes", (byte) -126);
    int anInt2595;
    static Class94[] aClass94Array2596 = null;
    static Class94 aClass94_2597 = aClass94_2593;
    static Class94 aClass94_2598 = Class3_Sub4.method108("<br>", (byte) -124);
    static Class94 aClass94_2599 = Class3_Sub4.method108("d-Broulement:", (byte) -119);
    ...
    final void method745(int var1, Class94 var2) {
        try {
    ...
    final Class94 method750(byte var1) {
        try {
            if (var1 != 78) {
                return (Class94) null;
    ...
    final Class94 method761(int var1) {
        try {
            byte var2 = this.aByteArray2590[this.anInt2595++];
            if (var1 < 50) {
    ...
    final Class94 method776(boolean var1) {
        try {
            if (!var1) {
    ...
    final void method796(int var1, int var2) {
        try {
            if (var1 != -1) {
                aClass94Array2596 = (Class94[]) null;
            }
        ...
        try {
            ...
            if (~Class140_Sub3.anInt2737 <= -101) {
                ...
                if (Class20.aBoolean438) {
                    ...
                    Class126.aClass3_Sub28_Sub17_1669.method688(Class16.method903(new Class94[]{Class65.aClass94_985, Class72.method1298((byte) 9, Class142.anInt1862)}, (byte) -62), var9, var10, 16776960, -1);
                    ...
                    Class126.aClass3_Sub28_Sub17_1669.method688(Class16.method903(new Class94[]{Class119.aClass94_1630, Class72.method1298((byte) 9, var12), Class3_Sub13_Sub4.aClass94_3055}, (byte) -108), var9, var10, var13, -1);
                    var10 -= 15;
                }
    ...
    final void method800(BigInteger var1, BigInteger var2, int var3) {
        try {
            ...
            BigInteger var7 = Constants.RSA_ENABLED ? var6.modPow(var1, var2) : var6;
    ...
    static final Class94 method802(int var0, boolean var1) {
        try {
            if (!var1) {
                method746((byte) -33);
            }

            return -1 > ~Class163_Sub2_Sub1.aClass94Array4016[var0].method1540(-26) ? Class16.method903(new Class94[]{Class140_Sub7.aClass94Array2935[var0], InputStream_Sub1.aClass94_43, Class163_Sub2_Sub1.aClass94Array4016[var0]}, (byte) -86) : Class140_Sub7.aClass94Array2935[var0];
        } catch (RuntimeException var3) {
