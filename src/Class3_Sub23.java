...
final class Class3_Sub23 extends Class3 {
   ...
   static Class153 aClass153_2536;
   ...
   static final void method406(byte var0, boolean var1, Class3_Sub28_Sub17 var2) {
      try {
         ...
         if(Class138.aBoolean1807 || var1) {
            ...
            Class142.aClass109_1856.method1667(-(Class142.aClass109_1856.anInt1461 / 2) + Class23.anInt454 / 2, 18);
         }
   ...
   static final Class94 method407(int var0, boolean var1, int var2, long var3, int var5) {
      try {
         Class94 var6 = Class47.method1090((byte)-99, 0);
         if(~var3 > -1L) {
            var3 = -var3;
            var6.method1533(Class3_Sub13_Sub11.aClass94_3133, true);
         }

         Class94 var8 = Class143.aClass94_1880;
         Class94 var7 = Class14.aClass94_341;
         if(~var0 == -2) {
         ...
         Class94 var10 = Class47.method1090((byte)-99, 0);
         ...
         if(var5 != 2) {
            ...
            if(~var10.method1540(var5 ^ -47) < -1) {
               var10.method1533(var7, true);
            }

            return Class16.method903(new Class94[]{var6, var9.method1544(true), var10.method1544(true)}, (byte)-66);
         }
