...
final class Class3_Sub28_Sub13 extends Class3_Sub28 {

   static int anInt3657;
   int anInt3658;
   static int anInt3659;
   static int anInt3660 = 0;
   static Class94 aClass94_3661 = Class3_Sub4.method108("T", (byte)-128);
   int anInt3662;
   Class130 aClass130_3663;
   private Class94 aClass94_3664;
   static boolean aBoolean3665 = true;
   private Class130 aClass130_3666;
   private int anInt3667;


   private final void method615(int var1, Class3_Sub30 var2, byte var3) {
      try {
         if(var3 > -29) {
            anInt3657 = 70;
         }
         ...
         if(~var1 != -2) {
            if(~var1 == -3) {
               this.anInt3658 = var2.method803((byte)-52);
            } else if(3 != var1) {
               if(var1 != 4) {
                  if(5 == var1 || -7 == ~var1) {
                     int var4 = var2.method737(1);
                     this.aClass130_3663 = new Class130(Class95.method1585((byte)94, var4));

                     for(int var5 = 0; var5 < var4; ++var5) {
                        int var6 = var2.method748(-502942936);
                        Object var7;
                        if(~var1 == -6) {
                           var7 = new Class3_Sub29(var2.method776(true));
                        } else {
                           var7 = new Class3_Sub18(var2.method748(-502942936));
                        }
                  ...
                  this.anInt3667 = var2.method748(-502942936);
               }
            } else {
               this.aClass94_3664 = var2.method776(true);
            }
         } else {
            this.anInt3662 = var2.method803((byte)-47);
         }
   ...
   final Class94 method616(int var1, byte var2) {
      try {
   ...
   final boolean method617(Class94 var1, int var2) {
      try {
         if(null == this.aClass130_3663) {
            return false;
         } else {
            if(var2 != 8729) {
               this.method615(-97, (Class3_Sub30)null, (byte)-91);
            }
   ...
   static final Class109_Sub1[] method619(byte var0, int var1, Class153 var2) {
      try {
         return Class140_Sub7.method2029((byte)-119, var2, var1)?(var0 <= 52?(Class109_Sub1[])null:Class69.method1281(0)):null;
      } catch (RuntimeException var4) {
   ...
   final boolean method621(int var1, int var2) {
      try {
         if(null != this.aClass130_3663) {
            ...
            if(var1 != -8143) {
               method619((byte)68, -100, (Class153)null);
            }
   ...
   static final byte[] method623(byte var0, byte[] var1) {
      try {
         if(var0 > -112) {
            method619((byte)43, -121, (Class153)null);
         }

         Class3_Sub30 var2 = new Class3_Sub30(var1);
         int var3 = var2.method803((byte)-67);
         int var4 = var2.method748(-502942936);
         if(0 <= var4 && (-1 == ~Class75.anInt1108 || ~Class75.anInt1108 <= ~var4)) {
            if(-1 == ~var3) {
               ...
               int var5 = var2.method748(-502942936);
   ...
   final void method625(Class3_Sub30 var1, int var2) {
      try {
         while(true) {
            int var3 = var1.method803((byte)-83);
            if(-1 == ~var3) {
               var3 = 68 % ((-84 - var2) / 35);
               return;
            }
