...
final class Class3_Sub13_Sub8 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3106 = Class3_Sub4.method108("clignotant2:", (byte)-124);
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         ...
         if(~var1 == -1) {
            this.aBoolean3100 = -2 == ~var2.method803((byte)-117);
         } else if(-2 == ~var1) {
            this.aBoolean3104 = var2.method803((byte)-93) == 1;
         } else if(-3 == ~var1) {
            this.aBoolean2375 = ~var2.method803((byte)-45) == -2;
         }
         ...
         if(this.aClass97_2376.aBoolean1379) {
            ...
            if(this.aBoolean3100) {
               for(var11 = 0; Class113.anInt1559 > var11; ++var11) {
                  var8[var11] = var5[Class16.anInt396 + -var11];
                  var9[var11] = var6[-var11 + Class16.anInt396];
                  var10[var11] = var7[Class16.anInt396 - var11];
               }
            } else {
               for(var11 = 0; ~Class113.anInt1559 < ~var11; ++var11) {
   ...
   static final void method203(int var0) {
      try {
         ...
         if(Class3_Sub28_Sub13.anInt3660 == 2) {
            if(~Class90.anInt1297 == ~Class3_Sub13_Sub39.anInt3460 && Class38_Sub1.anInt2612 == Class168.anInt2099) {
               Class3_Sub28_Sub13.anInt3660 = 0;
               if(Class101.aBoolean1419 && Class111.aBooleanArray1490[81] && ~Class3_Sub13_Sub34.anInt3415 < -3) {
         ...
         } else if(Class90.anInt1297 == Class163_Sub1.anInt2993 && ~Class38_Sub1.anInt2612 == ~Class38_Sub1.anInt2614) {
            Class3_Sub28_Sub13.anInt3660 = 0;
            if(Class101.aBoolean1419 && Class111.aBooleanArray1490[81] && -3 > ~Class3_Sub13_Sub34.anInt3415) {
               Class3_Sub30_Sub1.method806(2597, Class3_Sub13_Sub34.anInt3415 - 2);
            } else {
               Class3_Sub30_Sub1.method806(2597, Class3_Sub13_Sub34.anInt3415 - 1);
            }
   ...
   static final void method204(int var0) {
      try {
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 243);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-66, Class83.method1411(0));
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method804(var0 + -20034, Class23.anInt454);
         if(var0 != -3) {
            anInt3103 = -41;
         }

         ++Applet_Sub1.anInt2;
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method804(-20037, Class140_Sub7.anInt2934);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-31, Class3_Sub28_Sub14.anInt3671);
      } catch (RuntimeException var2) {
         throw Class44.method1067(var2, "ej.C(" + var0 + ')');
      }
   }

   static final void method205(Class153 var0, int var1, Class153 var2, Interface4 var3) {
      try {
         ...
         if(Class3_Sub24_Sub3.aClass153_3490 != null) {
            Class83.anInt1156 = Class3_Sub24_Sub3.aClass153_3490.method2142(1, (byte)100);
         }

         if(Class154.aClass153_1967 != null) {
            Class16.anInt377 = Class154.aClass153_1967.method2142(1, (byte)83);
         }

         if(var1 <= 32) {
            aClass94_3106 = (Class94)null;
         }
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            if(!this.aBoolean3100) {
               ...
               for(int var6 = 0; var6 < Class113.anInt1559; ++var6) {
                  var4[var6] = var5[-var6 + Class16.anInt396];
               }
            }
         }
   ...
   static final Class94 method207(int var0, boolean var1, int var2, long var3) {
      try {
         if(~var0 <= -3 && var0 <= 36) {
            if(var2 <= 71) {
            ...
            Class94 var13 = new Class94();
            var13.aByteArray2153 = var9;
            var13.anInt2156 = var8;
            return var13;
         } else {
