...
final class Class3_Sub13_Sub19 extends Class3_Sub13 {
   ...
   static Class94[] aClass94Array3226 = new Class94[100];
   static Class153 aClass153_3227;
   ...
   private static Class94 aClass94_3232 = Class3_Sub4.method108("pt", (byte)-120);
   private int anInt3233 = 8;
   private int anInt3234 = 1024;
   private int anInt3235;
   private int anInt3236 = 409;
   private static Class94 aClass94_3237 = Class3_Sub4.method108("en", (byte)-127);
   private static Class94 aClass94_3239 = Class3_Sub4.method108("fr", (byte)-124);
   private int[][] anIntArrayArray3240;
   static short aShort3241 = 1;
   private int anInt3242 = 4;
   private static Class94 aClass94_3243 = Class3_Sub4.method108("de", (byte)-126);
static Class94[] aClass94Array3238 = new Class94[]{aClass94_3237, aClass94_3243, aClass94_3239, aClass94_3232};
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(0 != var1) {
            if(~var1 == -2) {
               this.anInt3233 = var2.method803((byte)-82);
            } else if(-3 != ~var1) {
               if(var1 != 3) {
                  if(4 != var1) {
                     if(-6 != ~var1) {
                        if(-7 != ~var1) {
                           if(var1 == 7) {
                              this.anInt3229 = var2.method737(1);
                           }
                        } else {
                           this.anInt3224 = var2.method737(1);
                        }
                     } else {
                        this.anInt3231 = var2.method737(1);
                     }
                  } else {
                     this.anInt3234 = var2.method737(1);
                  }
               } else {
                  this.anInt3219 = var2.method737(1);
               }
            } else {
               this.anInt3236 = var2.method737(1);
            }
         } else {
            this.anInt3242 = var2.method803((byte)-60);
         }

         if(!var3) {
            aClass94_3239 = (Class94)null;
         }
   ...
   static final void method264(byte var0) {
      try {
         ...
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 184);
