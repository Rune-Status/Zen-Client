...
abstract class Class158 {
   ...
   static Class94 aClass94_2006 = Class3_Sub4.method108("null", (byte)-119);
   int[] anIntArray2007;
   ...
   int anInt2011;
   int anInt2012;
   static Class94 aClass94_2013 = Class3_Sub4.method108("Lade Liste der Welten", (byte)-123);
   ...
   static final void method2180(Class153 var0, Class153 var1, int var2) {
      try {
         if(var2 != 11504) {
            aClass94_2013 = (Class94)null;
         }
   ...
   static final void method2183(int var0, boolean var1, int var2, int var3, int var4, Class11[] var5) {
      try {
         int var6 = 0;
         if(var3 == 235) {
            for(; ~var6 > ~var5.length; ++var6) {
               Class11 var7 = var5[var6];
   ...
   abstract void method2184(int var1, int var2, int var3, int var4, Graphics var5, int var6);
