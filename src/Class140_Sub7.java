...
final class Class140_Sub7 extends Class140 {

   static Class94 aClass94_2928 = Class3_Sub4.method108("null", (byte)-121);
   ...
   static Class94[] aClass94Array2935 = new Class94[500];
   int anInt2936;
   static int anInt2937;
   static int anInt2938;
   static Class153 aClass153_2939;


   static final boolean method2029(byte var0, Class153 var1, int var2) {
      try {
         if(var0 > -116) {
            return false;
         } else {
   ...
   static final boolean method2031(byte var0, boolean var1, int var2, int var3, Class3_Sub2[][][] var4, int var5) {
      try {
         ...
         if(~var6 == ~Class158.aByteArrayArrayArray2008[Class26.anInt501][var2][var3]) {
            return false;
         } else if(-1 == ~(Class9.aByteArrayArrayArray113[Class26.anInt501][var2][var3] & 4)) {
            return false;
         } else {
            int var8 = 0;
            byte var7 = 0;
            ...
            Class158.aByteArrayArrayArray2008[Class26.anInt501][var2][var3] = var6;
            ...
            while(~var8 != ~var23) {
               ...
               boolean var14 = false;
               boolean var15 = false;
               if(0 == (Class9.aByteArrayArrayArray113[Class26.anInt501][var9][var12] & 4)) {
                  var14 = true;
               }
               ...
               int var16;
               label257:
               for(var16 = 1 + Class26.anInt501; 3 >= var16; ++var16) {
               ...
               if(var15) {
                  if(Class44.anIntArrayArrayArray723[Class26.anInt501 - -1][var9][var12] > Class41.anIntArray686[var5]) {
                     Class41.anIntArray686[var5] = Class44.anIntArrayArrayArray723[Class26.anInt501 + 1][var9][var12];
                  }
                  ...
                  var17 = var12 << 7;
                  if(~Class142.anIntArray1871[var5] < ~var17) {
                     Class142.anIntArray1871[var5] = var17;
                  } else if(Class140_Sub4_Sub1.anIntArray3959[var5] < var17) {
                     Class140_Sub4_Sub1.anIntArray3959[var5] = var17;
                  }
               }

               if(!var14) {
                  if(-2 >= ~var9 && Class158.aByteArrayArrayArray2008[Class26.anInt501][-1 + var9][var12] != var6) {
                     ...
                     var23 = 1 + var23 & 4095;
                     Class158.aByteArrayArrayArray2008[Class26.anInt501][var9 - 1][var12] = var6;
                  }

                  ++var12;
                  if(104 > var12) {
                     if(-1 >= ~(var9 + -1) && ~var6 != ~Class158.aByteArrayArrayArray2008[Class26.anInt501][-1 + var9][var12] && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][var9][var12] & 4) == -1 && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][-1 + var9][var12 + -1] & 4) == -1) {
                        ...
                        Class45.anIntArray729[var23] = Class3_Sub13_Sub29.method308(var12, 1245184);
                        Class158.aByteArrayArrayArray2008[Class26.anInt501][-1 + var9][var12] = var6;
                        var23 = 1 + var23 & 4095;
                     }

                     if(var6 != Class158.aByteArrayArrayArray2008[Class26.anInt501][var9][var12]) {
                        ...
                        var23 = 4095 & 1 + var23;
                        Class158.aByteArrayArrayArray2008[Class26.anInt501][var9][var12] = var6;
                     }

                     if(-105 < ~(1 + var9) && Class158.aByteArrayArrayArray2008[Class26.anInt501][var9 + 1][var12] != var6 && 0 == (Class9.aByteArrayArrayArray113[Class26.anInt501][var9][var12] & 4) && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][1 + var9][var12 - 1] & 4) == -1) {
                  ...
                  --var12;
                  if(104 > 1 + var9 && var6 != Class158.aByteArrayArrayArray2008[Class26.anInt501][var9 - -1][var12]) {
                  ...
                  --var12;
                  if(-1 >= ~var12) {
                     if(0 <= var9 + -1 && Class158.aByteArrayArrayArray2008[Class26.anInt501][-1 + var9][var12] != var6 && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][var9][var12] & 4) == -1 && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][var9 + -1][1 + var12] & 4) == -1) {
                     ...
                     if(-105 < ~(var9 - -1) && Class158.aByteArrayArrayArray2008[Class26.anInt501][var9 + 1][var12] != var6 && ~(4 & Class9.aByteArrayArrayArray113[Class26.anInt501][var9][var12]) == -1 && ~(Class9.aByteArrayArrayArray113[Class26.anInt501][1 + var9][1 + var12] & 4) == -1) {
            ...
            if(-1000000 != Class41.anIntArray686[var5]) {
               ...
               Class140_Sub4_Sub1.anIntArray3959[var5] += 50;
               Class142.anIntArray1871[var5] -= 50;
            }
   ...
   static final Class94 method2033(Class3_Sub30 var0, int var1, int var2) {
      try {
         try {
            int var3 = var0.method778(true);
            if(var2 < var3) {
               var3 = var2;
            }

            byte[] var4 = new byte[var3];
            var0.anInt2595 += Class3_Sub13_Sub9.aClass36_3112.method1017(0, var3, var4, var1 ^ -1247, var0.aByteArray2590, var0.anInt2595);
            Class94 var5 = Class3_Sub13_Sub3.method178(var4, -4114, var3, 0);
            return var1 != 1?(Class94)null:var5;
   ...
   final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
      try {
         Class140_Sub1 var13 = Class38.method1023(this.anInt2936, (byte)84).method1110(124, -1, 0, (Class142)null, this.anInt2930, 0);
         if(null != var13) {
            var13.method1868(var1, var2, var3, var4, var5, var6, var7, var8, var9, var11, var12);
