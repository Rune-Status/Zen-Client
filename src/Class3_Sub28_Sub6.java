...
final class Class3_Sub28_Sub6 extends Class3_Sub28 {

   static boolean aBoolean3594;
   static Class94 aClass94_3595 = Class3_Sub4.method108("(U0a )2 via: ", (byte)-127);
   int anInt3596;
   int anInt3597;
   int anInt3598;
   Class94 aClass94_3599;
   ...
   static final void d(int var0) {
      try {
         if(0 != ~Class90.anInt1252 && 0 != ~Class3_Sub7.anInt2293) {
            ...
            if(var0 == '\uffff') {
               ...
               for(int var5 = 0; -4 < ~var5; ++var5) {
                  var8 = (Class58.anIntArrayArrayArray911[Class90.anInt1252][var4 - -2][var5] + -Class58.anIntArrayArrayArray911[Class90.anInt1252][var4 - -3][var5] - -Class58.anIntArrayArrayArray911[Class90.anInt1252][var4 - -2][var5]) * 3;
                  var9 = Class58.anIntArrayArrayArray911[Class90.anInt1252][var4][var5];
                  var7 = 3 * Class58.anIntArrayArrayArray911[Class90.anInt1252][var4 + 1][var5];
                  var6 = 3 * Class58.anIntArrayArrayArray911[Class90.anInt1252][var4][var5];
                  var10 = -var6 + var7;
                  var11 = var8 + -(var7 * 2) + var6;
                  var12 = Class58.anIntArrayArrayArray911[Class90.anInt1252][2 + var4][var5] + -var9 - -var7 - var8;
                  var3[var5] = (float)var9 + (((float)var12 * var2 + (float)var11) * var2 + (float)var10) * var2;
               }

               Class7.anInt2162 = -1 * (int)var3[1];
               Class140_Sub4_Sub2.anInt3995 = (int)var3[0] + -(128 * Class131.anInt1716);
   ...
   static final Class109 a(int var0, Class153 var1, boolean var2) {
      try {
         return !Class140_Sub7.method2029((byte)-127, var1, var0)?null:(!var2?(Class109)null:Class166.method2259((byte)-40));
   ...
   static final Class2 c(int var0, int var1) {
      try {
         Class2 var2 = (Class2)Class3_Sub13_Sub34.aClass93_3412.method1526((long)var0, (byte)121);
         if(var2 != null) {
            return var2;
         } else {
            byte[] var3 = Class54.aClass153_878.method2133(34, (byte)-122, var0);
            if(var1 != 0) {
               aClass94_3595 = (Class94)null;
            }

            var2 = new Class2();
            if(var3 != null) {
               var2.method74((byte)-115, new Class3_Sub30(var3), var0);
            }

            Class3_Sub13_Sub34.aClass93_3412.method1515((byte)-86, var2, (long)var0);
            return var2;
         }
      } catch (RuntimeException var4) {
   ...
   static final void a(int var0, int var1, int var2, Class11 var3) {
      try {
         if(null == Class56.aClass11_886 && !Class38_Sub1.aBoolean2615) {
            if(var2 < 61) {
               a(19, 20, -32, (Class11)null);
            }

            if(null != var3 && Class49.method1122(0, var3) != null) {
               Class56.aClass11_886 = var3;
               Class4.aClass11_88 = Class49.method1122(0, var3);
               Class144.anInt1881 = var1;
               Class140_Sub4_Sub2.aBoolean3975 = false;
   ...
   static final void a(int var0, int var1, int var2, int var3, Class94 var4, long var5, int var7) {
      try {
         Class3_Sub30 var8 = new Class3_Sub30(128);
         var8.method752((byte)-101, 10);
         var8.method804(-20037, (int)(Math.random() * 99999.0D));
         var8.method804(var1 + -30640, 530);
         var8.method740(var5, -2037491440);
         var8.method738(-122, (int)(Math.random() * 9.9999999E7D));
         var8.method745(0, var4);
         var8.method738(-123, (int)(Math.random() * 9.9999999E7D));
         var8.method804(-20037, Class3_Sub26.anInt2554);
         var8.method752((byte)-125, var0);
         var8.method752((byte)-8, var3);
         if(var1 != 10603) {
            h((byte)-43);
         }

         var8.method738(-127, (int)(Math.random() * 9.9999999E7D));
         var8.method804(-20037, var7);
         var8.method804(var1 ^ -26416, var2);
         var8.method738(-127, (int)(9.9999999E7D * Math.random()));
         var8.method800(Class3_Sub13_Sub14.aBigInteger3162, Class3_Sub13_Sub37.aBigInteger3441, -296);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.anInt2595 = 0;
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-46, 36);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method752((byte)-41, var8.anInt2595);
         Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method753(var8.aByteArray2590, 0, var8.anInt2595, 115);
