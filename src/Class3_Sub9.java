...
final class Class3_Sub9 extends Class3 {
   ...
   Class111 aClass111_2320;
   int anInt2321;
   int anInt2322 = 0;
   static Class94 aClass94_2323 = Class3_Sub4.method108("<img=0>", (byte)-127);
   Class140_Sub4_Sub2 aClass140_Sub4_Sub2_2324;
   int anInt2325;
   int anInt2326;
   Class140_Sub4_Sub1 aClass140_Sub4_Sub1_2327;
   int anInt2328;
   boolean aBoolean2329;
   static int anInt2330 = 0;
   static Class94 aClass94_2331 = Class3_Sub4.method108("", (byte)-125);
   int anInt2332;
   int[] anIntArray2333;
   static int anInt2334;
   static Class94 aClass94_2335 = Class3_Sub4.method108("(Y", (byte)-119);
   ...
   static final Class3_Sub28_Sub5 method133(int var0, int var1) {
      try {
         ...
         Class3_Sub28_Sub5 var2 = (Class3_Sub28_Sub5)Class159.aClass93_2016.method1526((long)var0, (byte)121);
         if(var2 == null) {
            var2 = Class47.method1089(Class131.aClass153_1723, false, Class7.aClass153_2160, (byte)118, var0);
            if(null != var2) {
               Class159.aClass93_2016.method1515((byte)-75, var2, (long)var0);
            }
   ...
   final void method134(int var1) {
      try {
         ...
         if(null != this.aClass111_2320) {
            Class111 var3 = this.aClass111_2320.method1685(0);
            if(var3 == null) {
               this.anInt2332 = -1;
            ...
            int var6 = Class63.method1232(this.aClass140_Sub4_Sub2_2324, var1 ^ -2);
            if(var2 != var6) {
               Class90 var4 = this.aClass140_Sub4_Sub2_2324.aClass90_3976;
               this.anInt2332 = var6;
