...
final class Class3_Sub13_Sub10 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3119 = Class3_Sub4.method108("vert:", (byte)-120);
   private static Class94 aClass94_3120 = Class3_Sub4.method108("M", (byte)-128);
   static Frame aFrame3121;
   static int anInt3122;
   static Class94 aClass94_3123 = Class3_Sub4.method108("::noclip", (byte)-123);
   static Class94 aClass94_3124 = aClass94_3120;
   static GameStub aGameStub_3125;
   private int anInt3126 = 2048;
   private int anInt3127 = 3072;
   private int anInt3128 = 1024;
 static Class94 aClass94_3117 = aClass94_3120;
   ...
   static final int method210(int var0, int var1, int var2, int var3) {
      try {
         if(~var2 == ~var3) {
            ...
            int var4 = -var1 + 128;
            if(var0 != 18348) {
               method213(82, -103, 50, -59, (Class140)null, 126L, (Class140)null, (Class140)null);
            }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var1 != 0) {
            if(var1 == 1) {
               this.anInt3127 = var2.method737(1);
            } else if(-3 == ~var1) {
               this.aBoolean2375 = var2.method803((byte)-117) == 1;
            }
         } else {
            this.anInt3128 = var2.method737(1);
         }

         if(!var3) {
            this.method157(56, (Class3_Sub30)null, true);
         }
         ...
         if(0L != var0) {
            for(int var3 = var2; ~var3 > ~Class3_Sub28_Sub5.anInt3591; ++var3) {
               if(Class114.aLongArray1574[var3] == var0) {
                  ...
                  Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 213);
   ...
   static final void method213(int var0, int var1, int var2, int var3, Class140 var4, long var5, Class140 var7, Class140 var8) {
   ...
   static final void method214(Class140 var0, int var1, int var2, int var3, int var4, int var5) {
      boolean var6 = true;
      int var7 = var2;
      int var8 = var2 + var4;
      int var9 = var3 - 1;
      ...
      for(int var11 = var1; var11 <= var1 + 1; ++var11) {
         if(var11 != Class3_Sub17.anInt2456) {
            for(int var12 = var7; var12 <= var8; ++var12) {
               if(var12 >= 0 && var12 < Class89.anInt1234) {
   ...
   static final void method215(byte var0, Class109_Sub1 var1) {
      try {
         short var2 = 256;
         int var3 = 0;
         if(var0 >= -80) {
   ...
   static final void method216(Class3_Sub30 var0, int var1) {
      try {
         for(int var2 = 0; ~Class57.anInt906 < ~var2; ++var2) {
            int var3 = var0.method778(true);
            int var4 = var0.method737(1);
            if(~var4 == -65536) {
               var4 = -1;
            }

            if(null != Class117.aClass44_Sub1Array1609[var3]) {
               Class117.aClass44_Sub1Array1609[var3].anInt722 = var4;
            }
         }

         if(var1 != -14991) {
            aClass94_3123 = (Class94)null;
         }
