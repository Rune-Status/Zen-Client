...
final class Class137 {
   ...
   static Class94 aClass94_1782 = Class3_Sub4.method108("Prendre", (byte)-121);
   static Class94 aClass94_1783 = Class3_Sub4.method108(" de votre liste d(Wamis)3", (byte)-124);
   ...
   static final int method1817(byte var0) {
      try {
         ...
         return !Class73.aBoolean1084?(!Class140_Sub4_Sub2.method1986(var0 ^ 28)?1:(Class3_Sub28_Sub7.aBoolean3604?2:1)):0;
   ...
   static final void method1819(int var0, int var1, Class11 var2, byte var3, int var4, int var5, int var6, int var7) {
      try {
         if(var3 >= -89) {
            method1818(true);
         }
