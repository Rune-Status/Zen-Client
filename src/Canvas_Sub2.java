...
final class Canvas_Sub2 extends Canvas {
   ...
   static int anInt27;
   static Class94 aClass94_28 = Class3_Sub4.method108("; Expires=Thu)1 01)2Jan)21970 00:00:00 GMT; Max)2Age=0", (byte)-128);
   static boolean aBoolean29 = false;
   static int anInt30;
   static int anInt31 = 0;
   
   private Component aComponent33;
   private static Class94 aClass94_34 = Class3_Sub4.method108("flash2:", (byte)-128);
   static Class94 aClass94_32 = aClass94_34;
   static Class94 aClass94_35 = Class3_Sub4.method108("Annuler", (byte)-121);
   static Class94 aClass94_36 = aClass94_34;
   ...
   static final boolean method57(int var0, int var1) {
      try {
         if(!Class130.aBooleanArray1703[var0]) {
            if(Class3_Sub13_Sub29.aClass153_3361.method2117(-99, var0)) {
               int var2 = Class3_Sub13_Sub29.aClass153_3361.method2142(var0, (byte)94);
               if(0 == var2) {
                  Class130.aBooleanArray1703[var0] = true;
                  return true;
               } else {
                  if(null == Class140.aClass11ArrayArray1834[var0]) {
                     Class140.aClass11ArrayArray1834[var0] = new Class11[var2];
                  }

                  for(int var3 = 0; var3 < var2; ++var3) {
                     if(null == Class140.aClass11ArrayArray1834[var0][var3]) {
                        byte[] var4 = Class3_Sub13_Sub29.aClass153_3361.method2133(var0, (byte)-122, var3);
                        if(var4 != null) {
                           Class11 var5 = Class140.aClass11ArrayArray1834[var0][var3] = new Class11();
                           var5.anInt279 = var3 + (var0 << 16);
                           if(-1 == var4[0]) {
                              var5.method867(var1 ^ -105, new Class3_Sub30(var4));
                           } else {
                              var5.method858(-115, new Class3_Sub30(var4));
                           }
                        }
                     }
                  }
         ...
         throw Class44.method1067(var6, "tm.A(" + var0 + ',' + var1 + ')');
      }
   }
   ...
   static final void method58(int var0) {
      try {
         ...
         while(var1 < Class66.anInt997) {
            int var2 = Class21.anIntArray441[var1];
            Class140_Sub4_Sub1 var3 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var2];
            int var4 = Class28.aClass3_Sub30_Sub1_532.method803((byte)-43);
            if(-1 != ~(16 & var4)) {
               var4 += Class28.aClass3_Sub30_Sub1_532.method803((byte)-43) << 8;
            }
   ...
   static final void method60(int var0, int var1, int var2, Class91[] var3, int var4, byte var5, byte[] var6, int var7, int var8, int var9, boolean var10) {
      try {
         ...
         Class3_Sub30 var25 = new Class3_Sub30(var6);
            ...
            for(var14 = 0; var14 < 64; ++var14) {
               for(var15 = 0; -65 < ~var15; ++var15) {
                  if(~var7 == ~var13 && var9 <= var14 && 8 + var9 > var14 && var8 <= var15 && var15 < 8 + var8) {
                     Class167.method2267(0, 0, var10, var25, Class3_Sub13_Sub29.method310(var0, (byte)-117, 7 & var14, 7 & var15) + var4, Class3_Sub28.method519(var0, true, var15 & 7, var14 & 7) + var1, (byte)63, var0, var2);
                  } else {
         ...
         int var22;
         int var29;
         while(~var25.aByteArray2590.length < ~var25.anInt2595) {
            var14 = var25.method803((byte)-74);
            if(-130 != ~var14) {
               --var25.anInt2595;
               break;
            }
         ...
         boolean var27 = false;
         int var28;
         if(Class138.aBoolean1807 && !var10) {
            Class86 var26 = null;

            while(var25.aByteArray2590.length > var25.anInt2595) {
               var15 = var25.method803((byte)-33);
               if(var15 != 0) {
                  if(-2 != ~var15) {
                     throw new IllegalStateException();
                  }

                  var28 = var25.method803((byte)-71);
                  if(-1 > ~var28) {
                     for(var17 = 0; ~var17 > ~var28; ++var17) {
                        Class43 var30 = new Class43(var25);
                        if(~var30.anInt705 == -32) {
                           Class57 var31 = Class81.method1401(1001, var25.method737(1));
