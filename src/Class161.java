...
final class Class161 {
   ...
   static Class94 aClass94_2025 = Class3_Sub4.method108(")2", (byte)-122);
   static int[] anIntArray2026;
   static int anInt2027 = -1;
   static int anInt2028 = 0;
   static Class94 aClass94_2029 = Class3_Sub4.method108("l", (byte)-125);
   static Class3_Sub30 aClass3_Sub30_2030 = new Class3_Sub30(new byte[5000]);
   
   private static Class94 aClass94_2032 = Class3_Sub4.method108("Cancel", (byte)-120);
   static Class94 aClass94_2033 = Class3_Sub4.method108("Memory after cleanup=", (byte)-118);
   static Class33 aClass33_2034;
   static Class94 aClass94_2035 = null;
static Class94 aClass94_2031 = aClass94_2032;
   ...
   static final int method2201(Class44_Sub1 var0, int var1, int var2, Class44_Sub1 var3, boolean var4) {
      try {
         if(-2 == ~var1) {
            ...
            return 2 == var1?var0.method1078(102).aClass94_508.method1546((byte)-67, var3.method1078(-119).aClass94_508):(~var1 == -4?(var0.aClass94_2620.method1528((byte)-42, Class62.aClass94_946)?(var3.aClass94_2620.method1528((byte)-42, Class62.aClass94_946)?0:(var4?-1:1)):(var3.aClass94_2620.method1528((byte)-42, Class62.aClass94_946)?(var4?1:-1):var0.aClass94_2620.method1546((byte)-100, var3.aClass94_2620))):(var2 <= 67?36:(var1 == 4?(!var0.method1074(-114)?(!var3.method1074(-123)?0:-1):(var3.method1074(-108)?0:1)):(var1 == 5?(var0.method1075(64)?(!var3.method1075(64)?1:0):(var3.method1075(64)?-1:0)):(~var1 != -7?(7 == var1?(var0.method1070(8)?(var3.method1070(8)?0:1):(var3.method1070(8)?-1:0)):-var3.anInt2621 + var0.anInt2621):(var0.method1072(false)?(!var3.method1072(false)?1:0):(var3.method1072(false)?-1:0)))))));
         }
