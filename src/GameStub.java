...
public class GameStub implements Runnable {
    ...
    private static final Class122 method1438(boolean var0, String var1) {
        ...
        String[] var2 = new String[]{Constants.WORKING_DIRECTORY};
                                ...
                                if (~var2 == -4) {
                                    ...
                                    if (~var2 == -7) {
                                        ...
                                        if (10 == var2) {
                                            ...
                                            var7.setAccessible(true);
                                            if (!aString1202.startsWith("linux") && !aString1202.startsWith("sunos")) {
                                                if (aString1202.startsWith("mac")) {
    ...
    public final void method1445(int var1) {
        ...
        if (this.aClass122_1198 != null) {
            try {
                this.aClass122_1198.method1740(var1 ^ 1);
        ...
        if (this.aClass122_1204 != null) {
            try {
                this.aClass122_1204.method1740(1);
        ...
        if (this.aClass122Array1197 != null) {
            for (int var2 = 0; ~this.aClass122Array1197.length < ~var2; ++var2) {
                if (this.aClass122Array1197[var2] != null) {
                    try {
                        this.aClass122Array1197[var2].method1740(var1 ^ 1);
        ...
        if (this.aClass122_1207 != null) {
            try {
                this.aClass122_1207.method1740(var1 + 1);
    ...
    public static final File method1448(String var0, int var1, boolean var2, String var3) {
        ...
        if (var4 != null) {
            ...
            String[] var5 = new String[]{Constants.HOME_DIRECTORY};
            String[] var6 = new String[]{Constants.CACHE_IDENTIFIER};
    ...
    public GameStub(Applet var1, int var2, String var3, int var4) throws Exception {
        aString1196 = "1.1";
        ...
        aString1202 = aString1205.toLowerCase();
        ...
        this.aClass122Array1197 = new Class122[var4];
