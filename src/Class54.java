...
final class Class54 {
   ...
   static int anInt869;
   int[] anIntArray870;
   static Class94 aClass94_871 = Class3_Sub4.method108("hint_headicons", (byte)-121);
   static int anInt872;
   Class94[] aClass94Array873;
   Class3_Sub28_Sub15 aClass3_Sub28_Sub15_874;
   static Class94 aClass94_875 = Class3_Sub4.method108("Benutzen", (byte)-117);
   static int anInt876;
   int anInt877 = -1;
   static Class153 aClass153_878;
   ...
   static final void method1175(int var0, int var1) {
      try {
         ...
         Class82.anInt1150 = -1;
         if(var1 <= 55) {
            method1177(-67, 28L, (byte)76, (Class94)null, -45, (short)94, (Class94)null, -125);
         }
   ...
   static final boolean method1176(Class94 var0, byte var1) {
      try {
         if(var0 != null) {
            for(int var2 = 0; Class8.anInt104 > var2; ++var2) {
               if(var0.method1531(-121, Class70.aClass94Array1046[var2])) {
                  return true;
               }
            }

            if(var1 != -82) {
               aClass94_871 = (Class94)null;
            }

            if(var0.method1531(var1 + -46, Class102.aClass140_Sub4_Sub1_2141.aClass94_3967)) {
               return true;
            } else {
               return false;
            }
   ...
   static final void method1177(int var0, long var1, byte var3, Class94 var4, int var5, short var6, Class94 var7, int var8) {
      try {
         if(var3 > -23) {
            method1177(-45, 37L, (byte)-37, (Class94)null, -16, (short)110, (Class94)null, -75);
         }
