...
final class Class102 implements Interface2 {
   ...
   static Class94 aClass94_2132 = Class3_Sub4.method108("Titelbild ge-Offnet)3", (byte)-118);
   ...
   static Class140_Sub4_Sub1 aClass140_Sub4_Sub1_2141;
      ...
      try {
         ...
         for(var2 = 0; var2 < Class163.anInt2046; ++var2) {
            ...
            if(null != var3 && var3.method1966((byte)17) && !var3.aClass90_3976.aBoolean1263 != var1 && var3.aClass90_3976.method1472((byte)74)) {
               int var4 = var3.method1977((byte)114);
               int var5;
               if(1 != var4) {
                  if((~(1 & var4) != -1 || ~(127 & var3.anInt2819) == -1 && 0 == (127 & var3.anInt2829)) && ((var4 & 1) != 1 || -65 == ~(127 & var3.anInt2819) && 64 == (127 & var3.anInt2829))) {
                     ...
                     var7 = var3.method1977((byte)114) + var5;
                     if(~var5 > -1) {
                        var5 = 0;
                     }
                     ...
                     var8 = var6 + var3.method1977((byte)114);
                     if(-1 < ~var6) {
                        var6 = 0;
                     }
         ...
         for(var2 = 0; ~var2 > ~Class163.anInt2046; ++var2) {
            ...
            if(var3 != null && var3.method1966((byte)17) && !var3.aClass90_3976.aBoolean1263 == !var1 && var3.aClass90_3976.method1472((byte)74)) {
               ...
               var3.anInt2831 = Class121.method1736(Class26.anInt501, 1, var3.anInt2819, var3.anInt2829);
               Class20.method907(Class26.anInt501, var3.anInt2819, var3.anInt2829, var3.anInt2831, -64 + 64 * var6 + 60, var3, var3.anInt2785, var15, var3.aBoolean2810);
            }
         }
   ...
   private final Class3_Sub28_Sub20 method1613(int var1, int var2) {
      try {
         ...
         if(null != var3) {
            ...
            byte[] var4 = this.aClass153_2127.method2133(var1, (byte)-122, 0);
            if(null != var4) {
               Class3_Sub30 var5 = new Class3_Sub30(var4);
   ...
   final void method1619(int var1, int var2) {
      try {
         if(var2 != -1) {
            aClass140_Sub4_Sub1_2141 = (Class140_Sub4_Sub1)null;
         }
   ...
   Class102(Class153 var1, Class153 var2, Class153 var3, int var4, boolean var5) {
      try {
         ...
         Class3_Sub30 var6 = new Class3_Sub30(var2.method2133(0, (byte)-122, 0));
         int var7 = var6.method737(1);
         ...
         for(var8 = 0; ~var7 < ~var8; ++var8) {
            this.aBooleanArray2133[var8] = 1 == var6.method803((byte)-69);
         }

         for(var8 = 0; ~var7 < ~var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aBooleanArray2124[var8] = ~var6.method803((byte)-50) == -2;
            }
         }

         for(var8 = 0; ~var8 > ~var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aBooleanArray2128[var8] = 1 == var6.method803((byte)-60);
            }
         }

         for(var8 = 0; ~var8 > ~var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aBooleanArray2122[var8] = -2 == ~var6.method803((byte)-23);
            }
         }

         for(var8 = 0; var8 < var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aBooleanArray2135[var8] = -2 == ~var6.method803((byte)-30);
            }
         }

         for(var8 = 0; var7 > var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2126[var8] = var6.method760(false);
            }
         }

         for(var8 = 0; var7 > var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2129[var8] = var6.method760(false);
            }
         }

         for(var8 = 0; var8 < var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2144[var8] = var6.method760(false);
            }
         }

         for(var8 = 0; ~var8 > ~var7; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aByteArray2143[var8] = var6.method760(false);
            }
         }

         for(var8 = 0; var7 > var8; ++var8) {
            if(this.aBooleanArray2133[var8]) {
               this.aShortArray2137[var8] = (short)var6.method737(1);
            }
         }
