...
final class Class67 implements Runnable {
   ...
   static final void method1260(int var0, int var1, Class11[] var2) {
      try {
         for(int var3 = 0; var3 < var2.length; ++var3) {
            Class11 var4 = var2[var3];
            if(null != var4 && ~var4.anInt190 == ~var1 && (!var4.aBoolean233 || !GameClient.method51(var4))) {
               if(-1 == ~var4.anInt187) {
                  if(!var4.aBoolean233 && GameClient.method51(var4) && var4 != Class107.aClass11_1453) {
                     continue;
                  }
               ...
               if(var4.anInt187 == 6) {
                  ...
                  if(0 != ~var4.anInt305 || ~var4.anInt198 != 0) {
                     ...
                     if(var6 != -1) {
                        Class142 var7 = GameClient.method45(var6, (byte)-20);
                        if(null != var7) {
                           for(var4.anInt267 += Class106.anInt1446; ~var4.anInt267 < ~var7.anIntArray1869[var4.anInt283]; Class20.method909(115, var4)) {
   ...
   static final Class94 method1261(int var0, int var1, Class94[] var2, int var3) {
      try {
         int var4 = 0;
         ...
         for(int var7 = 0; var1 > var7; ++var7) {
            Class94 var8 = var2[var7 + var0];
            Class76.method1357(var8.aByteArray2153, 0, var10, var6, var8.anInt2156);
            var6 += var8.anInt2156;
         }

         Class94 var11 = new Class94();
         var11.anInt2156 = var4;
         if(var3 != 2774) {
            method1262(83, 28);
         }

         var11.aByteArray2153 = var10;
         return var11;
