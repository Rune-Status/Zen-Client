...
final class Class3_Sub13_Sub28 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3345 = Class3_Sub4.method108("glissement:", (byte)-127);
   ...
   static Class153 aClass153_3352;
   static Class94 aClass94_3353;
   private int anInt3354 = 3216;
   static Class94 aClass94_3355 = Class3_Sub4.method108("Angreifen", (byte)-121);
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(0 == var1) {
            this.anInt3350 = var2.method737(1);
         } else if(1 != var1) {
            if(~var1 == -3) {
               this.anInt3354 = var2.method737(1);
            }
         } else {
            this.anInt3347 = var2.method737(1);
         }
      ...
      try {
         ...
         if(this.aClass114_2382.aBoolean1580) {
            ...
            for(int var12 = 0; Class113.anInt1559 > var12; ++var12) {
               int var14 = (var10[Class16.anInt396 & -1 + var12] - var10[1 + var12 & Class16.anInt396]) * var8 >> 12;
   ...
   static final void method302(int var0) {
      try {
         ...
         for(Class3_Sub28_Sub19 var1 = (Class3_Sub28_Sub19)Class3_Sub13_Sub30.aClass61_3364.method1222(-37); var1 != null; var1 = (Class3_Sub28_Sub19)Class3_Sub13_Sub30.aClass61_3364.method1221(4)) {
            Class140_Sub6 var2 = var1.aClass140_Sub6_3778;
            if(~Class26.anInt501 == ~var2.anInt2907 && ~var2.anInt2899 <= ~Class44.anInt719) {
               if(Class44.anInt719 >= var2.anInt2925) {
                  if(-1 > ~var2.anInt2919) {
                     Class140_Sub4_Sub2 var3 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[-1 + var2.anInt2919];
                  ...
                  if(var2.anInt2919 < 0) {
                     ...
                     Class140_Sub4_Sub1 var6;
                     if(Class3_Sub1.anInt2211 == var4) {
                        var6 = Class102.aClass140_Sub4_Sub1_2141;
                     } else {
                        var6 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var4];
                     }
                  ...
                  Class20.method907(Class26.anInt501, (int)var2.aDouble2920, (int)var2.aDouble2900, (int)var2.aDouble2914, 60, var2, var2.anInt2924, -1L, false);
               }
            } else {
               var1.method86(-1024);
            }
