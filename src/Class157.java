...
final class Class157 {
   ...
   private static Class94 aClass94_1998 = Class3_Sub4.method108("Connecting to update server", (byte)-118);
   private int[][] anIntArrayArray1999;
   static Class3_Sub28_Sub17_Sub1 aClass3_Sub28_Sub17_Sub1_2000;
   private int anInt2001;
   static Class94 aClass94_2002 = Class3_Sub4.method108("Chargement des fichiers config )2 ", (byte)-117);
   static Class94 aClass94_2003 = Class3_Sub4.method108("_labels", (byte)-121);
static Class94 aClass94_1995 = aClass94_1998;
   ...
   static final Class3_Sub28_Sub16_Sub2[] method2176(int var0, int var1, int var2, Class153 var3) {
      try {
         if(Class75_Sub4.method1351(var3, var0, var2, -30901)) {
            if(var1 != 32767) {
               method2176(-111, 55, -18, (Class153)null);
            }
