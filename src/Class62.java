...
final class Class62 {
   ...
   int[] anIntArray945;
   static Class94 aClass94_946 = Class3_Sub4.method108(")2", (byte)-128);
   int anInt947;
   private static Class94 aClass94_948 = Class3_Sub4.method108("You can(Wt add yourself to your own friend list)3", (byte)-121);
   Class69 aClass69_949;
   static int anInt950;
   static Class94 aClass94_951 = Class3_Sub4.method108("Interfaces charg-Bes", (byte)-122);
   static int anInt952;
   int[] anIntArray953;
   int[] anIntArray954;
   int[] anIntArray955;
   int[] anIntArray956;
   static Class94 aClass94_957 = aClass94_948;
   int[] anIntArray958;
   ...
   static final void method1224(Class11 var0, int var1, int var2, int var3) {
      try {
         if(0 != var0.aByte162) {
            if(var0.aByte162 != 1) {
               if(2 == var0.aByte162) {
         ...
         if(Class69.aBoolean1040 && (GameClient.method44(var0).anInt2205 != 0 || ~var0.anInt187 == -1)) {
            if(~var0.anInt210 > -1) {
               var0.anInt210 = 0;
   ...
   static final void method1225(int var0) {
      try {
         ...
         synchronized(var1) {
            if(var0 != 18074) {
               aClass94_946 = (Class94)null;
            }

            Class3_Sub13_Sub5.anInt3069 = Class28.anInt549;
            ...
            Class163_Sub1.anInt2993 = Class16.anInt362;
   ...
   private final void method1226(int var1, byte[] var2) {
      try {
         Class3_Sub30 var3 = new Class3_Sub30(Class3_Sub28_Sub13.method623((byte)-114, var2));
         int var4 = var3.method803((byte)-34);
         if(var4 != 5 && ~var4 != -7) {
            throw new RuntimeException();
         } else {
            if(~var4 <= -7) {
               this.anInt961 = var3.method748(-502942936);
            } else {
               this.anInt961 = 0;
            }

            int var5 = var3.method803((byte)-127);
            int var6 = 0;
            this.anInt947 = var3.method737(var1 ^ 3);
            int var7 = -1;
            this.anIntArray953 = new int[this.anInt947];

            int var8;
            for(var8 = 0; this.anInt947 > var8; ++var8) {
               this.anIntArray953[var8] = var6 += var3.method737(1);
            ...
            if(~var5 != -1) {
               ...
               for(var8 = 0; ~var8 > ~this.anInt947; ++var8) {
                  this.anIntArray955[this.anIntArray953[var8]] = var3.method748(Class93.method1519(var1, -502942934));
               }
            ...
            for(var8 = 0; ~this.anInt947 < ~var8; ++var8) {
               this.anIntArray945[this.anIntArray953[var8]] = var3.method748(-502942936);
            }

            for(var8 = 0; this.anInt947 > var8; ++var8) {
               this.anIntArray958[this.anIntArray953[var8]] = var3.method748(Class93.method1519(var1, -502942934));
            }

            var8 = 0;
            if(var1 != 2) {
               aClass94_957 = (Class94)null;
            }

            while(this.anInt947 > var8) {
               this.anIntArray956[this.anIntArray953[var8]] = var3.method737(1);
               ++var8;
            }
            ...
            for(var8 = 0; ~var8 > ~this.anInt947; ++var8) {
               ...
               for(var12 = 0; var10 > var12; ++var12) {
                  int var13 = this.anIntArrayArray959[var9][var12] = var6 += var3.method737(1);
                  if(var13 > var11) {
                     var11 = var13;
                  }
               }
            ...
            if(-1 != ~var5) {
               ...
               for(var8 = 0; var8 < this.anInt947; ++var8) {
                  ...
                  for(var11 = 0; ~var11 > ~var10; ++var11) {
                     ...
                     this.anIntArrayArray943[var9][var12] = var3.method748(var1 + -502942938);
                  }
