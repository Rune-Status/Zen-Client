...
final class Class3_Sub13_Sub12 extends Class3_Sub13 {
   ...
   private static Class94 aClass94_3141 = Class3_Sub4.method108("Loaded config", (byte)-123);
   static Class94 aClass94_3142 = aClass94_3141;
   static CRC32 aCRC32_3143 = new CRC32();
   static int anInt3144;
   static Class94 aClass94_3145 = Class3_Sub4.method108(")1 ", (byte)-127);


   static final void method223(boolean var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         if(~var4 == ~var7) {
            Class89.method1460(var1, var3, (byte)-113, var6, var7, var2, var5);
         } else {
            if(!var0) {
               method226(87, 8);
            }
   ...
   static final void method224(byte var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         Class140.aClass109Array1831[0].method1667(var3, var4);
         Class140.aClass109Array1831[1].method1667(var3, -16 + var5 + var4);
   ...
   static final void method225(int var0, Class11 var1) {
      try {
         Class11 var2 = Class168.method2273(var1, 123);
         if(var0 != 14) {
            method227(true);
         }
   ...
   static final void method226(int var0, int var1) {
      try {
         if(0 != ~var0) {
            if(var1 <= 27) {
               method228((Class153)null, (Class153)null, true);
            }
            ...
            if(Canvas_Sub2.method57(var0, 104)) {
               ...
               for(int var3 = 0; var3 < var2.length; ++var3) {
                  ...
                  if(null != var4.anObjectArray159) {
                     Class3_Sub16 var5 = new Class3_Sub16();
                     var5.anObjectArray2448 = var4.anObjectArray159;
                     var5.aClass11_2449 = var4;
                     Class48.method1104((byte)-86, 2000000, var5);
                  }
               }
   ...
   static final int method228(Class153 var0, Class153 var1, boolean var2) {
      try {
         int var3 = 0;
