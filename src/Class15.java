...
final class Class15 implements Runnable {
   ...
   static int anInt342;
   static Class94 aClass94_343 = Class3_Sub4.method108("blanc:", (byte)-127);
   ...
   static int anInt348;
   static int anInt349;
   GameStub aGameStub_350;
   static Class64 aClass64_351;
   volatile Class155[] aClass155Array352 = new Class155[2];
   volatile boolean aBoolean353 = false;


   static final boolean method888(int var0, Class111 var1, boolean var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         if(var7.anInt64 == -1) {
            ...
            Class109_Sub1 var8 = var7.method77(var6, (byte)-111);
            if(var8 == null) {
               return false;
            } else {
   ...
   static final void method889(byte var0, Class3_Sub30 var1) {
      try {
         if(var0 != 105) {
            anIntArray347 = (int[])null;
         }
         ...
         int var12;
         int var14;
         while(var1.anInt2595 < var1.aByteArray2590.length) {
            int var7 = 0;
            var6 = 0;
            boolean var5 = false;
            if(~var1.method803((byte)-99) == -2) {
               var6 = var1.method803((byte)-56);
               var7 = var1.method803((byte)-51);
               var5 = true;
            }

            int var8 = var1.method803((byte)-125);
            int var9 = var1.method803((byte)-30);
               ...
               for(var12 = 0; var12 < 64; ++var12) {
                  ...
                  for(var14 = 0; 64 > var14; ++var14) {
                     if(!var5 || var12 >= 8 * var6 && 8 + 8 * var6 > var12 && var14 >= var7 * 8 && var14 < 8 + 8 * var7) {
                        var13[var11 - var14] = var1.method760(false);
                     }
                  }
               }
            } else if(!var5) {
      ...
      try {
         if(var2 == null) {
            ...
            if(~var2.length < -137 && !Class45.aBoolean732) {
               try {
                  Class144 var3 = (Class144)Class.forName("Class144_Sub1").newInstance();
      ...
      try {
         ...
         try {
            while(!this.aBoolean345) {
               ...
               Class81.method1400(this.aGameStub_350, (Object)null, -71);
            }
      ...
      try {
         ...
         for(int var2 = 0; ~Class95.anInt1338 < ~var2; ++var2) {
            ...
            for(int var6 = 0; var6 < var3; ++var6) {
               var5[var6] = Class3_Sub13_Sub38.anIntArray3446[Class3_Sub28_Sub15.method633(255, var4[var6])];
            }

            if(!Class138.aBoolean1807) {
               var1[var2] = new Class3_Sub28_Sub16_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], Class3_Sub30.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], var5);
            } else {
               var1[var2] = new Class3_Sub28_Sub16_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[var2], Class3_Sub30.anIntArray2591[var2], Class140_Sub7.anIntArray2931[var2], Class3_Sub13_Sub6.anIntArray3076[var2], var5);
            }
         }
   ...
   static final Class94 method894(long var0, byte var2) {
      try {
         ...
         if(var2 < 9) {
            method889((byte)7, (Class3_Sub30)null);
         }
         ...
         return Class16.method903(new Class94[]{Class3_Sub13_Sub31.aClass94Array3376[var3 + -1], Class3_Sub13_Sub12.aClass94_3145, Class72.method1298((byte)9, var4 / 10), Class72.method1298((byte)9, var4 % 10), Class161.aClass94_2025, Class140_Sub4_Sub2.aClass94Array3985[var5], Class161.aClass94_2025, Class72.method1298((byte)9, var6), Class24.aClass94_465, Class72.method1298((byte)9, var7 / 10), Class72.method1298((byte)9, var7 % 10), Class155.aClass94_1970, Class72.method1298((byte)9, var8 / 10), Class72.method1298((byte)9, var8 % 10), Class155.aClass94_1970, Class72.method1298((byte)9, var9 / 10), Class72.method1298((byte)9, var9 % 10), Class26.aClass94_500}, (byte)-96);
