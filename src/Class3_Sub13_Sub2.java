...
final class Class3_Sub13_Sub2 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3042 = Class3_Sub4.method108("<col=ff9040>", (byte)-123);
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(0 == var1) {
            this.anInt3043 = var2.method737(1);
         } else if(1 != var1) {
            if(2 == var1) {
               this.aBoolean2375 = var2.method803((byte)-76) == 1;
            }
         } else {
            this.anInt3046 = var2.method737(1);
         }

         if(!var3) {
            aClass94_3042 = (Class94)null;
         }
   ...
   static final int method173(byte var0, int var1, Class11 var2) {
      try {
         if(var0 < 4) {
            method176(-50);
         }

         return !GameClient.method44(var2).method92(var1, (byte)-109) && null == var2.anObjectArray314?-1:(null != var2.anIntArray249 && ~var1 > ~var2.anIntArray249.length?var2.anIntArray249[var1]:-1);
         ...
         while(~var7 > ~var9) {
            ...
            if(~var10 <= -1) {
               ...
               if(~var8 < ~var9) {
                  ...
                  var22 = -var7 + var6;
                  var21 = var7 + var6;
                  var20 = Class140.anIntArray1838[var9];
                  var24 = -var20 + var6;
                  var23 = var20 + var6;
            ...
            if(var8 <= var7) {
               ...
               var22 = var7 <= var11?var11:Class140.anIntArray1838[var7];
               var23 = var22 + var6;
               var24 = var6 + -var22;
