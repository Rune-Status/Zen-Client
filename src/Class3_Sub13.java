...
abstract class Class3_Sub13 extends Class3 {
   ...
   static Class94 aClass94_2380 = Class3_Sub4.method108("::shiftclick", (byte)-125);
   int anInt2381;
   Class114 aClass114_2382;
   static int anInt2383 = 0;
   static int anInt2384 = 0;
   static Class94 aClass94_2385 = Class3_Sub4.method108("::replacecanvas", (byte)-121);
   ...
   void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(!var3) {
   ...
   int method159(int var1) {
      try {
         if(var1 != 4) {
            method164((byte)-98, true, (Class94)null);
         }
   ...
   static final Class3_Sub28_Sub17_Sub1 method163(byte[] var0, int var1) {
      try {
         if(var0 == null) {
            ...
            Class3_Sub28_Sub17_Sub1 var2 = new Class3_Sub28_Sub17_Sub1(var0, Class164.anIntArray2048, Class3_Sub30.anIntArray2591, Class140_Sub7.anIntArray2931, Class3_Sub13_Sub6.anIntArray3076, Class163_Sub1.aByteArrayArray2987);
   ...
   static final void method164(byte var0, boolean var1, Class94 var2) {
      try {
         if(var0 <= -11) {
            byte var3 = 4;
            int var4 = var3 + 6;
   ...
   static final void method165(int var0) {
      try {
         ...
         if(var0 != -7878) {
            method164((byte)102, false, (Class94)null);
         }
