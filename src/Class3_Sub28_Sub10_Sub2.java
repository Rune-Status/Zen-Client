...
final class Class3_Sub28_Sub10_Sub2 extends Class3_Sub28_Sub10 {
   ...
   static Class94 aClass94_4066 = Class3_Sub4.method108("<br>", (byte)-124);
   int anInt4067;
   static boolean aBoolean4068 = true;
   Class3_Sub30 aClass3_Sub30_4069;
   static Class3_Sub2[][][] aClass3_Sub2ArrayArrayArray4070;
  
   private static Class94 aClass94_4072 = Class3_Sub4.method108(" from your friend list first)3", (byte)-118);
   static int anInt4073;
 static Class94 aClass94_4071 = aClass94_4072;

   final int method586(boolean var1) {
      try {
         return var1?92:(this.aClass3_Sub30_4069 == null?0:this.aClass3_Sub30_4069.anInt2595 * 100 / (-this.aByte4064 + this.aClass3_Sub30_4069.aByteArray2590.length));
      } catch (RuntimeException var3) {
         throw Class44.method1067(var3, "pm.A(" + var1 + ')');
      }
   }

   static final Class106[] method596(int var0, GameStub var1) {
      try {
   ...
   static final void method598(boolean var0, int var1, boolean var2, int var3, boolean var4, int var5, int var6) {
      try {
         ...
         if(3 == var1 && null == Class3_Sub13_Sub10.aFrame3121) {
            Class3_Sub13_Sub10.aFrame3121 = Class99.method1597(2, 0, 0, var6, var5, Class38.aGameStub_665);
         ...
         if(~var1 == -4 && Class3_Sub13_Sub10.aFrame3121 == null) {
            method598(true, Class3_Sub28.anInt2577, true, var3, var4, -1, -1);
         } else {
            Object var7;
            if(null == Class3_Sub13_Sub10.aFrame3121) {
               if(null != Class3_Sub13_Sub7.aFrame3092) {
                  var7 = Class3_Sub13_Sub7.aFrame3092;
               } else {
                  var7 = Class38.aGameStub_665.anApplet1219;
               }
            } else {
            ...
            Insets var8;
            if(Class3_Sub13_Sub7.aFrame3092 == var7) {
               var8 = Class3_Sub13_Sub7.aFrame3092.getInsets();
               Class3_Sub9.anInt2334 -= var8.right + var8.left;
               Class70.anInt1047 -= var8.bottom + var8.top;
            }

            if(var4) {
               aClass94_4071 = (Class94)null;
            }
            ...
            if(!var0) {
               if(Class138.aBoolean1807) {
                  Class138.method1854(Class23.anInt454, Class140_Sub7.anInt2934);
               }
               ...
               Class48.method1119(Class3_Sub28_Sub12.aCanvas3648, var4);
            ...
            if(0 == var1 && -1 > ~var3) {
               Class138.method1834(Class3_Sub28_Sub12.aCanvas3648);
            }

            if(var2 && var1 > 0) {
               Class3_Sub28_Sub12.aCanvas3648.setIgnoreRepaint(true);
               if(!Applet_Sub1.aBoolean11) {
                  Class32.method995();
                  ...
                  Class64 var13 = Class38.aGameStub_665.method1444(-43, Class126.aClient1671.getClass());
                  ...
                  if(1 == var13.anInt978) {
                     Applet_Sub1.aBoolean11 = true;
                  }
               }

               if(Applet_Sub1.aBoolean11) {
                  Class138.method1853(Class3_Sub28_Sub12.aCanvas3648, 2 * Class3_Sub28_Sub14.anInt3671);
               }
            }

            if(!Class138.aBoolean1807 && 0 < var1) {
               ...
               Class47.aBoolean742 = !Class140_Sub4_Sub2.method1986(89);
               if(var2) {
               ...
               if(null != Class3_Sub15.aClass89_2429 && (~Class143.anInt1875 == -31 || Class143.anInt1875 == 25)) {
   ...
   final byte[] method587(boolean var1) {
      try {
         if(!this.aBoolean3632 && ~this.aClass3_Sub30_4069.anInt2595 <= ~(-this.aByte4064 + this.aClass3_Sub30_4069.aByteArray2590.length)) {
            if(var1) {
               this.method586(false);
            }

            return this.aClass3_Sub30_4069.aByteArray2590;
         } else {
