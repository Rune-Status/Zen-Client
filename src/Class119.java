...
final class Class119 {
   ...
   static Class94 aClass94_1625 = Class3_Sub4.method108("Memory before cleanup=", (byte)-122);
   static Class33 aClass33_1626;
   static Class26[] aClass26Array1627;
   static Class153 aClass153_1628;
   static int anInt1629;
   static Class94 aClass94_1630 = Class3_Sub4.method108("Mem:", (byte)-127);
   ...
   static final void method1729(boolean var0) {
      try {
         ...
         if(null == Class3_Sub13_Sub10.aFrame3121) {
            if(Class3_Sub13_Sub7.aFrame3092 != null) {
               var1 = Class3_Sub13_Sub7.aFrame3092;
            } else {
               var1 = Class38.aGameStub_665.anApplet1219;
            }
         } else {
         ...
         Insets var2;
         if(var1 == Class3_Sub13_Sub7.aFrame3092) {
            var2 = Class3_Sub13_Sub7.aFrame3092.getInsets();
   ...
   static final void method1730(GameStub var0, byte var1) {
      try {
         if(var1 == 14) {
            Class122 var2 = null;
            ...
            try {
               ...
               if(~var3.anInt978 == -2) {
                  ...
                  Class3_Sub30 var4 = Class23.method939((byte)-116);
                  var2.method1738(116, var4.aByteArray2590, var4.anInt2595, 0);
               }
