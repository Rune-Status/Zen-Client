...
final class Class38_Sub1 extends Class38 {
   ...
   static Class94 aClass94_2610 = Class3_Sub4.method108(")1o", (byte)-126);
   ...
   static Class94 aClass94_2616 = Class3_Sub4.method108("blinken3:", (byte)-117);
   static int anInt2617 = 0;
   static int anInt2618;


   static final void method1030(Class11 var0, Class3_Sub28_Sub16 var1, int var2, int var3, int var4, byte var5, int var6) {
      try {
         if(null != var1) {
            if(var5 != 11) {
               method1032(true);
            ...
            int var7 = 2047 & Class3_Sub13_Sub8.anInt3102 + Class28.anInt531;
