...
final class Class56 {
   ...
   static Class11 aClass11_886 = null;
   static int[] anIntArray887 = new int[2048];
   static Class94 aClass94_888 = Class3_Sub4.method108("<col=ffff00>", (byte)-128);
   static int anInt889;
   static Class106[] aClass106Array890;
   
   static Class94 aClass94_892 = Class3_Sub4.method108(" )2> <col=ffffff>", (byte)-117);
   static int anInt893 = 0;
   private static Class94 aClass94_894 = Class3_Sub4.method108("Walk here", (byte)-119);
static Class94 aClass94_891 = aClass94_894;
   ...
   public static void method1187(int var0) {
      try {
         if(var0 != 30351) {
            method1189(-73, -127, -26, 43, 67, 125, 38, 80, (Class140)null, -92, true, 27L);
         }
   ...
   static final void method1188(int var0) {
      try {
         ...
         Class4.aByteArrayArrayArray81 = (byte[][][])null;
   ...
   static final boolean method1189(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, Class140 var8, int var9, boolean var10, long var11) {
      ...
      for(int var15 = var1; var15 < var1 + var3; ++var15) {
         for(var16 = var2; var16 < var2 + var4; ++var16) {
            if(var15 < 0 || var16 < 0 || var15 >= Class89.anInt1234 || var16 >= Class3_Sub13_Sub15.anInt3179) {
               return false;
            }
      ...
      if(var10) {
         Class142.aClass25Array1868[Class3_Sub13_Sub5.anInt3070++] = var20;
      }
