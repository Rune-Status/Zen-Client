...
final class Class163_Sub2_Sub1 extends Class163_Sub2 {
   ...
   private static Class94 aClass94_4022 = Class3_Sub4.method108("Your friend list is full)3 Max of 100 for free users)1 and 200 for members)3", (byte)-120);
   static Class94 aClass94_4023 = Class3_Sub4.method108(")3", (byte)-120);
   static Class94 aClass94_4024 = aClass94_4022;
   static int[] anIntArray4025 = new int[32];
   static int anInt4026 = 0;
   static Class109_Sub1[] aClass109_Sub1Array4027;
   ...
   static final void method2222(byte var0) {
      try {
         ...
         Class3_Sub16.aClass93_2442.method1523((byte)-108);
         ...
         for(int var5 = 0; var5 < var3; ++var5) {
            ...
            for(int var6 = 0; ~var6 > -14; ++var6) {
               for(int var7 = 0; ~var7 > -14; ++var7) {
                  int var8 = Class111.anIntArrayArrayArray1497[var5][var6][var7];
                  if(0 != ~var8) {
                     int var9 = var8 >> 24 & 3;
                     if(!var0 || var9 == 0) {
                        int var10 = (6 & var8) >> 1;
                        ...
                        for(int var14 = 0; Class3_Sub24_Sub3.anIntArray3494.length > var14; ++var14) {
                           if(~Class3_Sub24_Sub3.anIntArray3494[var14] == ~var13 && var4[var14] != null) {
                              Class3_Sub13_Sub30.method316(Class86.aClass91Array1182, var5, var4[var14], var9, var10, 8 * var6, var7 * 8, var0, (var11 & 7) * 8, 8 * (7 & var12), (byte)-54);
                              break;
                           }
                        }
                     }
   ...
   static final boolean method2224(byte var0, long var1, int var3, int var4) {
      try {
         ...
         if(var5 != 10 && -12 != ~var5 && var5 != 22) {
            Class3_Sub28_Sub9.method582(Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0], var6, 0, true, 0, 2, var4, 0, 1 + var5, 2, var3, Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0]);
         } else {
            Class111 var8 = Class162.method2207(4, var7);
            int var9;
            int var10;
            if(~var6 != -1 && ~var6 != -3) {
            ...
            Class3_Sub28_Sub9.method582(Class102.aClass140_Sub4_Sub1_2141.anIntArray2755[0], 0, var10, true, var11, 2, var4, var9, 0, 2, var3, Class102.aClass140_Sub4_Sub1_2141.anIntArray2767[0]);
         }
   ...
   static final void method2226(Class3_Sub30_Sub1 var0, int var1, int var2) {
      try {
         ...
         while(true) {
            Class3_Sub8 var3 = (Class3_Sub8)Class3_Sub26.aClass61_2557.method1222(-80);
            if(var3 == null) {
               return;
            }
            ...
            var0.method816(0, var1);
            var0.method752((byte)-86, 0);
            var5 = var0.anInt2595;
            var0.method738(-127, var3.anInt2305);

            for(int var6 = 0; ~var3.anInt2296 < ~var6; ++var6) {
               if(~var3.anIntArray2300[var6] != -1) {
                  var0.method752((byte)-101, var3.anIntArray2300[var6]);
               } else {
                  try {
                     ...
                     if(-1 != ~var7) {
                        if(~var7 == -2) {
                           ...
                           var0.method752((byte)-98, 0);
                        } else if(2 == var7) {
                           var8 = (Field)var3.aClass64Array2303[var6].anObject974;
                           var9 = var8.getModifiers();
                           var0.method752((byte)-26, 0);
                           var0.method738(-124, var9);
                        }
                     } else {
                        var8 = (Field)var3.aClass64Array2303[var6].anObject974;
                        var9 = var8.getInt((Object)null);
                        var0.method752((byte)-102, 0);
                        var0.method738(-122, var9);
                     }
                     ...
                     if(3 == var7) {
                        ...
                        if(var28 == null) {
                           var0.method752((byte)-51, 0);
                        } else if(!(var28 instanceof Number)) {
                           if(var28 instanceof Class94) {
                              var0.method752((byte)-52, 2);
                              var0.method745(0, (Class94)var28);
                           } else {
                              var0.method752((byte)-94, 4);
                           }
                        } else {
                           var0.method752((byte)-94, 1);
                           var0.method740(((Number)var28).longValue(), -2037491440);
                        }
                     } else if(var7 == 4) {
                        var26 = (Method)var3.aClass64Array2298[var6].anObject974;
                        var9 = var26.getModifiers();
                        var0.method752((byte)-27, 0);
                        var0.method738(-126, var9);
                     }
                  } catch (ClassNotFoundException var13) {
                     var0.method752((byte)-102, -10);
                  } catch (InvalidClassException var14) {
                     var0.method752((byte)-41, -11);
                  } catch (StreamCorruptedException var15) {
                     var0.method752((byte)-76, -12);
                  } catch (OptionalDataException var16) {
                     var0.method752((byte)-60, -13);
                  } catch (IllegalAccessException var17) {
                     var0.method752((byte)-76, -14);
                  } catch (IllegalArgumentException var18) {
                     var0.method752((byte)-98, -15);
                  } catch (InvocationTargetException var19) {
                     var0.method752((byte)-112, -16);
                  } catch (SecurityException var20) {
                     var0.method752((byte)-11, -17);
                  } catch (IOException var21) {
                     var0.method752((byte)-27, -18);
                  } catch (NullPointerException var22) {
                     var0.method752((byte)-37, -19);
                  } catch (Exception var23) {
                     var0.method752((byte)-75, -20);
                  } catch (Throwable var24) {
                     var0.method752((byte)-79, -21);
                  }
               }
            }

            var0.method793((byte)86, var5);
            var0.method769((byte)-127, var0.anInt2595 - var5);
            var3.method86(-1024);
         }
