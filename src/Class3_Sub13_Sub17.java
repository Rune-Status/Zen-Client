...
final class Class3_Sub13_Sub17 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3209 = Class3_Sub4.method108("showingVideoAd", (byte)-117);
   static Class153 aClass153_3210;
   static Class94 aClass94_3211 = Class3_Sub4.method108(" <col=ffffff>", (byte)-126);
   ...
   private final void method248(int var1, byte var2, int var3) {
      try {
         if(var2 > 80) {
            ...
            Class159.anInt2024 &= Class16.anInt396;
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(~var1 == -1) {
            this.aBoolean2375 = ~var2.method803((byte)-117) == -2;
         }

         if(!var3) {
            aClass153_3210 = (Class153)null;
         }
   ...
   static final void method250(int var0, Class153 var1) {
      try {
         if(var0 == 2048) {
   ...
   static final void method252(int var0) {
      try {
         Class3_Sub9 var1;
         for(var1 = (Class3_Sub9)Class3.aClass61_78.method1222(-36); null != var1; var1 = (Class3_Sub9)Class3.aClass61_78.method1221(4)) {
            if(var1.aBoolean2329) {
               var1.method134(1);
            }
         }

         for(var1 = (Class3_Sub9)Class89.aClass61_1242.method1222(-110); null != var1; var1 = (Class3_Sub9)Class89.aClass61_1242.method1221(4)) {
            if(var1.aBoolean2329) {
               var1.method134(1);
            }
         }
