...
final class Class3_Sub13_Sub16 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3190 = Class3_Sub4.method108("<img=1>", (byte)-117);
   private int anInt3191 = 2;
   static Class94 aClass94_3192 = Class3_Sub4.method108(" ", (byte)-124);
   private int anInt3193 = 2048;
   private int anInt3194 = 1;
   private byte[] aByteArray3195 = new byte[512];
   static Class94 aClass94_3196 = Class3_Sub4.method108("Fps:", (byte)-126);
   private int anInt3197 = 0;
   static int anInt3198 = 0;
   static int anInt3199;
   private short[] aShortArray3200 = new short[512];
   static Class44_Sub1[] aClass44_Sub1Array3201 = new Class44_Sub1[0];
   static long aLong3202;
   private int anInt3203 = 5;
   private int anInt3204 = 5;
   static int anInt3205;
   static Class94 aClass94_3206 = Class3_Sub4.method108("Moteur son pr-Bpar-B", (byte)-124);
   ...
   final void method158(int var1) {
      try {
         if(var1 != 16251) {
            aClass44_Sub1Array3201 = (Class44_Sub1[])null;
         }
   ...
   static final int method243(Class94 var0, byte var1) {
      try {
         if(var1 != 13) {
            method245(-29);
         }
         ...
         for(int var2 = 0; ~var2 > ~Class3_Sub13_Sub19.aClass94Array3238.length; ++var2) {
            if(Class3_Sub13_Sub19.aClass94Array3238[var2].method1531(var1 + 40, var0)) {
               return var2;
            }
         }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(!var3) {
            this.method157(-122, (Class3_Sub30)null, false);
         }

         if(-1 == ~var1) {
            this.anInt3203 = this.anInt3204 = var2.method803((byte)-57);
         } else if(-2 == ~var1) {
            this.anInt3197 = var2.method803((byte)-57);
         } else if(2 != var1) {
            if(-4 == ~var1) {
               this.anInt3191 = var2.method803((byte)-55);
            } else if(var1 == 4) {
               this.anInt3194 = var2.method803((byte)-124);
            } else if(var1 == 5) {
               this.anInt3203 = var2.method803((byte)-51);
            } else if(var1 == 6) {
               this.anInt3204 = var2.method803((byte)-64);
            }
         } else {
            this.anInt3193 = var2.method737(1);
         }
