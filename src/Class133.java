...
final class Class133 {
   ...
   static Class94 aClass94_1745 = Class3_Sub4.method108("settings", (byte)-127);
   int anInt1746;
   int anInt1747;
   static int anInt1748;
   static Class11 aClass11_1749;
   int anInt1750;
   static Class153 aClass153_1751;
   int anInt1752;
   ...
   Class133(Class3_Sub30 var1) {
      try {
         this.aByte1742 = var1.method760(false);
         this.anInt1752 = var1.method737(1);
         this.anInt1757 = var1.method748(-502942936);
         this.anInt1747 = var1.method748(-502942936);
         this.anInt1746 = var1.method748(-502942936);
         this.anInt1750 = var1.method748(-502942936);
      } catch (RuntimeException var3) {
