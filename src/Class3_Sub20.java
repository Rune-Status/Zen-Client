...
final class Class3_Sub20 extends Class3 {
   ...
   static Class94 aClass94_2482 = Class3_Sub4.method108(":clan:", (byte)-119);
   int anInt2483;
   static int anInt2484 = 0;
   static int anInt2485 = 0;
   private static Class94 aClass94_2486 = Class3_Sub4.method108("red:", (byte)-122);
   static int anInt2487;
   static int anInt2488 = 0;
   int anInt2489;
   static Class94 aClass94_2490 = aClass94_2486;
static Class94 aClass94_2481 = aClass94_2486;
   ...
   static final void method389(boolean var0) {
      try {
         ...
         for(int var1 = 0; 2048 > var1; ++var1) {
            Class140_Sub4_Sub1 var2 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var1];
            if(null != var2) {
         ...
         if(Class143.anInt1875 == 5) {
            Class108.method1656(Class140_Sub6.aClass153_2906, (byte)-60);
         }
   ...
   static final void method390(boolean var0, int var1, int var2, int var3, byte var4, int var5, int var6) {
      try {
         ...
         if(var0 && Class3_Sub28_Sub10.anInt3631 >= 100) {
            Class140_Sub4_Sub2.anInt3995 = 128 * Canvas_Sub2.anInt30 + 64;
            Class77.anInt1111 = 128 * Class146.anInt1904 + 64;
            Class7.anInt2162 = Class121.method1736(Class26.anInt501, 1, Class140_Sub4_Sub2.anInt3995, Class77.anInt1111) + -Class3_Sub13_Sub34.anInt3414;
         }
   ...
   static final void method392(Class153 var0, Class153 var1, int var2, Class153 var3) {
      try {
         Class142.aClass153_1860 = var1;
