...
abstract class Class118 {
   ...
   static Class94 aClass94_1617 = Class3_Sub4.method108(")1a2)1m", (byte)-128);
   static Class94 aClass94_1618 = Class3_Sub4.method108("Verbindung zum Update)2Server hergestellt)3", (byte)-122);
   ...
   static Class94 aClass94_1620 = Class3_Sub4.method108("Cach-B", (byte)-119);
   static Class94 aClass94_1621 = Class3_Sub4.method108("Chargement des polices )2 ", (byte)-122);
   static Class94 aClass94_1622 = Class3_Sub4.method108("Card:", (byte)-122);
   static int anInt1623;


   static final Class94 method1723(byte var0, boolean var1, int var2, int var3) {
      try {
         if(var2 >= 2 && 36 >= var2) {
            int var4 = 1;
            ...
            var11.aByteArray2153 = var7;
            var11.anInt2156 = var6;
            return var11;
         } else {
   ...
   static final void method1724(int var0, int var1, int var2, int var3, int var4, int var5, byte var6, int var7) {
      try {
         if(var5 >= 128 && ~var2 <= -129 && -13057 <= ~var5 && ~var2 >= -13057) {
            int var8 = Class121.method1736(Class26.anInt501, 1, var5, var2) + -var3;
            var2 -= Class77.anInt1111;
            var8 -= Class7.anInt2162;
            var5 -= Class140_Sub4_Sub2.anInt3995;
