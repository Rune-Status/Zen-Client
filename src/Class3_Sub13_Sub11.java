...
final class Class3_Sub13_Sub11 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3131 = Class3_Sub4.method108(" ", (byte)-123);
   static int anInt3132;
   static Class94 aClass94_3133 = Class3_Sub4.method108(")2", (byte)-125);
   private int anInt3134;
   private int anInt3135;
   static int anInt3136;
   static Class47 aClass47_3137 = new Class47(64);
   static Class94 aClass94_3138 = Class3_Sub4.method108("b12_full", (byte)-128);
   static int[] anIntArray3139 = new int[14];
   static Class94 aClass94_3140 = Class3_Sub4.method108("overlay2", (byte)-128);
   ...
   static final void method219(boolean var0, int var1) {
      try {
         ...
         Class102.aClass140_Sub4_Sub1_2141 = new Class140_Sub4_Sub1();
         Class102.aClass140_Sub4_Sub1_2141.anInt2829 = 3000;
         Class102.aClass140_Sub4_Sub1_2141.anInt2819 = var1;
         if(Class138.aBoolean1807) {
            if(-3 == ~Class133.anInt1753) {
               Class140_Sub4_Sub2.anInt3995 = Canvas_Sub2.anInt30 << 7;
            ...
            Class84.method1418(-110, Class140_Sub6.aClass153_2906);
   ...
   static final void method221(int var0, Class94 var1, Class94 var2, Class94 var3, int var4) {
      try {
         Class3_Sub28_Sub12.method611(var0, var4, var1, var3, (byte)50, var2);
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(!var3) {
            method221(-64, (Class94)null, (Class94)null, (Class94)null, 34);
         }

         if(-1 == ~var1) {
            this.method218((byte)75, var2.method794((byte)82));
         }
