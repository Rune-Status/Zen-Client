...
final class Class117 {
   ...
   private static Class94 aClass94_1610 = Class3_Sub4.method108("Loaded wordpack", (byte)-122);
   ...
   static Class94 aClass94_1612 = Class3_Sub4.method108("classement ", (byte)-120);
   static int[] anIntArray1613 = new int[500];
   static Class94 aClass94_1614 = Class3_Sub4.method108(":tradereq:", (byte)-128);
   static Class94 aClass94_1615 = aClass94_1610;
   static int anInt1616 = 0;


   static final void method1719(int var0, int var1) {
      try {
         if(Class143.anInt1875 != var0) {
            if(-1 == ~Class143.anInt1875) {
            ...
            if(40 != var0 && null != Class163_Sub2_Sub1.aClass89_4012) {
               Class163_Sub2_Sub1.aClass89_4012.method1468(14821);
            ...
            if(~var0 == -6) {
               Class108.method1656(Class140_Sub6.aClass153_2906, (byte)-111);
            } else {
               Class3_Sub13_Sub17.method247((byte)-121);
            }

            boolean var3 = var1 == Class143.anInt1875 || ~Class143.anInt1875 == -11 || -29 == ~Class143.anInt1875;
            if(var3 == !var2) {
               if(var2) {
            ...
            if(Class138.aBoolean1807 && (25 == var0 || var0 == 28 || -41 == ~var0)) {
               Class138.method1833();
            }

            Class143.anInt1875 = var0;
         }
   ...
   static final void method1720(boolean var0, int var1) {
      try {
         ...
         Class4.aByteArrayArrayArray81 = new byte[var2][104][104];
   ...
   static final Class3_Sub28_Sub16_Sub2 method1722(int var0) {
      try {
         ...
         Class3_Sub28_Sub16_Sub2 var6 = new Class3_Sub28_Sub16_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], var3);
