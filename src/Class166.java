...
final class Class166 {
   ...
   static Class94 aClass94_2074 = Class3_Sub4.method108("; version=1; path=)4; domain=", (byte)-117);
   static Class94 aClass94_2075 = Class3_Sub4.method108("rect_debug=", (byte)-122);
   byte[] aByteArray2076;
   int anInt2077;
   int anInt2078;
   static int anInt2079 = 0;
   static Class94 aClass94_2080 = Class3_Sub4.method108("(U2", (byte)-118);
   ...
   static final void method2258(int var0, int var1, Class94 var2) {
      try {
         Class94 var3 = var2.method1579(-17).method1545((byte)-50);
         boolean var4 = false;

         for(int var5 = var1; ~var5 > ~Class159.anInt2022; ++var5) {
            Class140_Sub4_Sub1 var6 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[Class56.anIntArray887[var5]];
         ...
         if(!var4) {
            Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, Class16.method903(new Class94[]{Class43.aClass94_691, var3}, (byte)-77), -1);
         }
