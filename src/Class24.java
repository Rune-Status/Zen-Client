...
final class Class24 {
   ...
   static Class94 aClass94_463 = Class3_Sub4.method108("Bitte entfernen Sie ", (byte)-122);
   private short[] aShortArray464;
   static Class94 aClass94_465 = Class3_Sub4.method108(" ", (byte)-117);
   int anInt466 = -1;
   static int anInt467 = 0;
   static Class94 aClass94_468 = Class3_Sub4.method108("(U", (byte)-125);
   static int anInt469 = 0;
   private short[] aShortArray470;
   private short[] aShortArray471;
   static int anInt472 = 0;
   private static Class94 aClass94_473 = Class3_Sub4.method108("Loading title screen )2 ", (byte)-127);
   private int[] anIntArray474;
   private int[] anIntArray475 = new int[]{-1, -1, -1, -1, -1};
   boolean aBoolean476 = false;
   private static Class94 aClass94_477 = Class3_Sub4.method108("Loading)3)3)3", (byte)-118);
 static Class94 aClass94_461 = aClass94_473;
   static Class94 aClass94_462 = aClass94_477;

   final Class140_Sub5 method941(boolean var1) {
      try {
         if(!var1) {
            return (Class140_Sub5)null;
         } else {
            int var3 = 0;
            Class140_Sub5[] var2 = new Class140_Sub5[5];

            for(int var4 = 0; -6 < ~var4; ++var4) {
               if(0 != ~this.anIntArray475[var4]) {
                  var2[var3++] = Class140_Sub5.method2015(Class10.aClass153_152, this.anIntArray475[var4], 0);
               }
            }

            Class140_Sub5 var7 = new Class140_Sub5(var2, var3);
            int var5;
   ...
   static final boolean method944(byte var0, int var1, int var2, byte[] var3) {
      try {
         ...
         boolean var5 = true;
         int var7 = -1;
         Class3_Sub30 var6 = new Class3_Sub30(var3);
         ...
         while(true) {
            ...
            while(true) {
               ...
               if(!var10) {
                  ...
                  int var14 = var6.method803((byte)-94) >> 2;
                  if(~var15 < -1 && var16 > 0 && 103 > var15 && 103 > var16) {
                     Class111 var17 = Class162.method2207(4, var7);
                     if(var14 != 22 || Class148.aBoolean1905 || 0 != var17.anInt1529 || ~var17.anInt1538 == -2 || var17.aBoolean1483) {
                        var10 = true;
   ...
   static final void method945(byte var0) {
      try {
         Class28.aClass3_Sub30_Sub1_532.method807((byte)-98);
         int var1 = Class28.aClass3_Sub30_Sub1_532.method812(var0, 8);
         int var2;
         if(~Class163.anInt2046 < ~var1) {
            for(var2 = var1; var2 < Class163.anInt2046; ++var2) {
               Class3_Sub7.anIntArray2292[Class139.anInt1829++] = Class15.anIntArray347[var2];
            }
         }
                  ...
                  if(-1 != ~var6) {
                     ...
                     if(1 != var6) {
                        if(var6 == 2) {
                           ...
                           if(-2 == ~Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 1)) {
   ...
   private final void method946(byte var1, Class3_Sub30 var2, int var3) {
      try {
         if(var1 >= -16) {
         ...
         if(~var3 != -2) {
            ...
            int var5;
            if(-3 == ~var3) {
               var4 = var2.method803((byte)-71);
               this.anIntArray474 = new int[var4];

               for(var5 = 0; var4 > var5; ++var5) {
                  this.anIntArray474[var5] = var2.method737(1);
               }
            } else if(-4 == ~var3) {
               this.aBoolean476 = true;
            } else if(-41 != ~var3) {
               if(-42 == ~var3) {
                  var4 = var2.method803((byte)-49);
                  this.aShortArray471 = new short[var4];
                  this.aShortArray470 = new short[var4];

                  for(var5 = 0; ~var4 < ~var5; ++var5) {
                     this.aShortArray471[var5] = (short)var2.method737(1);
                     this.aShortArray470[var5] = (short)var2.method737(1);
                  }
               } else if(~var3 <= -61 && var3 < 70) {
                  this.anIntArray475[-60 + var3] = var2.method737(1);
               }
            } else {
               var4 = var2.method803((byte)-128);
               this.aShortArray460 = new short[var4];
               this.aShortArray464 = new short[var4];

               for(var5 = 0; var5 < var4; ++var5) {
                  this.aShortArray464[var5] = (short)var2.method737(1);
                  this.aShortArray460[var5] = (short)var2.method737(1);
               }
            }
         } else {
            this.anInt466 = var2.method803((byte)-67);
         }
   ...
   final Class140_Sub5 method947(byte var1) {
      try {
         if(this.anIntArray474 == null) {
            return null;
         } else {
            Class140_Sub5[] var2 = new Class140_Sub5[this.anIntArray474.length];

            for(int var3 = 0; ~var3 > ~this.anIntArray474.length; ++var3) {
               var2[var3] = Class140_Sub5.method2015(Class10.aClass153_152, this.anIntArray474[var3], 0);
            }
            ...
            if(var2.length == 1) {
               ...
               var7 = new Class140_Sub5(var2, var2.length);
            }
   ...
   static final void method950(Class11 var0, int var1, int var2, int var3) {
      try {
         if(2 <= Class3_Sub13_Sub34.anInt3415 || ~Class164_Sub1.anInt3012 != -1 || Class140.aBoolean1837) {
            if(var1 > -55) {
               aClass94_473 = (Class94)null;
            }

            Class94 var4 = Class3_Sub28_Sub1.method531((byte)94);
            if(var0 == null) {
               ...
               var7.method702(var4, var3, var2, var0.anInt168, var0.anInt193, var0.anInt218, var0.anInt287, var0.anInt194, var0.anInt225, Class3_Sub13_Sub7.aRandom3088, Class38_Sub1.anInt2618, Class140_Sub4_Sub1.anIntArray3951);
               Class75.method1340(Class140_Sub4_Sub1.anIntArray3951[0], Class140_Sub4_Sub1.anIntArray3951[2], (byte)-40, Class140_Sub4_Sub1.anIntArray3951[1], Class140_Sub4_Sub1.anIntArray3951[3]);
            }
   ...
   final void method952(int var1, Class3_Sub30 var2) {
      try {
         if(var1 == -31957) {
            while(true) {
               int var3 = var2.method803((byte)-52);
               if(0 == var3) {
                  return;
               }
