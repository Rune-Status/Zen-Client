...
final class Class3_Sub15 extends Class3 {
   ...
   static Class89 aClass89_2429;
   byte[] aByteArray2430;
   Class3_Sub12_Sub1[] aClass3_Sub12_Sub1Array2431;
   static Class94 aClass94_2432 = Class3_Sub4.method108("::tween", (byte)-126);
   ...
   static final Class3_Sub28_Sub3 method371(int var0, Class94 var1) {
      try {
         if(var0 != 2) {
            method372(false);
         }

         for(Class3_Sub28_Sub3 var2 = (Class3_Sub28_Sub3)Class134.aClass61_1758.method1222(-19); var2 != null; var2 = (Class3_Sub28_Sub3)Class134.aClass61_1758.method1221(4)) {
   ...
   static final void method374(int var0, boolean var1, byte[] var2, int var3, int var4, Class91[] var5) {
      try {
         Class3_Sub30 var6 = new Class3_Sub30(var2);
         int var7 = -1;
         ...
         while(true) {
            ...
            while(true) {
               ...
               int var13 = var9 >> 12;
               int var12 = var9 >> 6 & 63;
               int var14 = var6.method803((byte)-48);
               int var15 = var14 >> 2;
               int var16 = var14 & 3;
               ...
               if(var17 > 0 && var18 > 0 && var17 < 103 && ~var18 > -104) {
                  ...
                  Class110.method1683(var13, !var1, var13, var1, var19, var7, var15, var17, (byte)50, var18, var16);
               }
            }
         }
   ...
   Class3_Sub15(byte[] var1) {
      try {
         ...
         Class3_Sub30 var2;
         for(var2 = new Class3_Sub30(var1); -1 != ~var2.aByteArray2590[var3 + var2.anInt2595]; ++var3) {
            ;
         }
         ...
         for(var5 = 0; ~var5 > ~var3; ++var5) {
            var4[var5] = var2.method760(false);
         }
         ...
         int var6;
         for(var6 = 0; 0 != var2.aByteArray2590[var2.anInt2595 + var6]; ++var6) {
            ;
         }
         ...
         for(var8 = 0; ~var8 > ~var6; ++var8) {
            var7[var8] = var2.method760(false);
         }
         ...
         for(var2.anInt2595 += var6; -1 != ~var2.aByteArray2590[var9 + var2.anInt2595]; ++var9) {
            ;
         }
         ...
         for(int var11 = 0; ~var11 > ~var9; ++var11) {
            var10[var11] = var2.method760(false);
         }
         ...
         if(~var9 >= -2) {
            ...
            for(var14 = 2; ~var9 < ~var14; ++var14) {
               int var15 = var2.method803((byte)-87);
               if(0 == var15) {
                  var13 = var12++;
               } else {
                  if(var15 <= var13) {
         ...
         for(var14 = 0; var14 < var38.length; ++var14) {
            ...
            int var16 = var2.method803((byte)-121);
            if(0 < var16) {
               var41.aByteArray2064 = new byte[2 * var16];
            }

            var16 = var2.method803((byte)-47);
            if(~var16 < -1) {
         ...
         var14 = var2.method803((byte)-81);
         byte[] var40 = ~var14 < -1?new byte[var14 * 2]:null;
         var14 = var2.method803((byte)-84);
         byte[] var39 = -1 > ~var14?new byte[var14 * 2]:null;

         int var17;
         for(var17 = 0; ~var2.aByteArray2590[var17 + var2.anInt2595] != -1; ++var17) {
            ;
         }
         ...
         for(var19 = 0; ~var17 < ~var19; ++var19) {
            var18[var19] = var2.method760(false);
         }
         ...
         for(var24 = 0; ~var24 > -129; ++var24) {
            if(-1 != ~this.anIntArray2423[var24]) {
               if(var20 == 0) {
                  var23 = var2.aByteArray2590[var5++] + -1;
         ...
         for(int var25 = 0; -129 < ~var25; ++var25) {
            if(-1 != ~this.anIntArray2423[var25]) {
               if(0 == var20) {
                  var24 = var2.aByteArray2590[var8++] - -16 << 2;
         ...
         for(var27 = 0; ~var27 > -129; ++var27) {
            if(-1 == ~var20) {
               ...
               if(this.anIntArray2423[var27] > 0) {
                  var26 = var2.method803((byte)-61) + 1;
               }
            }
         ...
         this.anInt2424 = var2.method803((byte)-26) + 1;
         ...
         for(var27 = 0; var27 < var12; ++var27) {
            ...
            if(var28.aByteArray2064 != null) {
               for(var29 = 1; var29 < var28.aByteArray2064.length; var29 += 2) {
                  var28.aByteArray2064[var29] = var2.method760(false);
               }
            }

            if(var28.aByteArray2076 != null) {
               for(var29 = 3; var29 < var28.aByteArray2076.length + -2; var29 += 2) {
                  var28.aByteArray2076[var29] = var2.method760(false);
               }
            }
         }
         ...
         if(null != var40) {
            for(var27 = 1; var40.length > var27; var27 += 2) {
               var40[var27] = var2.method760(false);
            }
         }

         if(null != var39) {
            for(var27 = 1; ~var39.length < ~var27; var27 += 2) {
               var39[var27] = var2.method760(false);
            }
         }
         ...
         for(var27 = 0; ~var12 < ~var27; ++var27) {
            ...
            if(null != var28.aByteArray2076) {
               ...
               for(var29 = 2; ~var29 > ~var28.aByteArray2076.length; var29 += 2) {
                  var19 -= -1 + -var2.method803((byte)-114);
         ...
         for(var27 = 0; var12 > var27; ++var27) {
            ...
            if(null != var28.aByteArray2064) {
               ...
               for(var29 = 2; ~var29 > ~var28.aByteArray2064.length; var29 += 2) {
                  var19 = var19 - -1 - -var2.method803((byte)-29);
         ...
         byte var48;
         if(null != var40) {
            var19 = var2.method803((byte)-32);
            var40[0] = (byte)var19;

            for(var27 = 2; var40.length > var27; var27 += 2) {
               var19 = 1 + (var19 - -var2.method803((byte)-29));
         ...
         if(null != var39) {
            var19 = var2.method803((byte)-118);
            var39[0] = (byte)var19;

            for(var27 = 2; var27 < var39.length; var27 += 2) {
               var19 = 1 + (var19 - -var2.method803((byte)-75));
         ...
         for(var27 = 0; var12 > var27; ++var27) {
            var38[var27].anInt2078 = var2.method803((byte)-60);
         }

         for(var27 = 0; var27 < var12; ++var27) {
            var28 = var38[var27];
            if(null != var28.aByteArray2064) {
               var28.anInt2067 = var2.method803((byte)-23);
            }

            if(null != var28.aByteArray2076) {
               var28.anInt2071 = var2.method803((byte)-104);
            }

            if(-1 > ~var28.anInt2078) {
               var28.anInt2063 = var2.method803((byte)-124);
            }
         }

         for(var27 = 0; ~var27 > ~var12; ++var27) {
            var38[var27].anInt2077 = var2.method803((byte)-102);
         }

         for(var27 = 0; ~var27 > ~var12; ++var27) {
            var28 = var38[var27];
            if(var28.anInt2077 > 0) {
               var28.anInt2066 = var2.method803((byte)-80);
            }
         }
         ...
         for(var27 = 0; var27 < var12; ++var27) {
            ...
            if(~var28.anInt2066 < -1) {
               var28.anInt2069 = var2.method803((byte)-84);
            }
         }
