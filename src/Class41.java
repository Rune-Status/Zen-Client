...
final class Class41 {
      ...
      try {
         if(!var6) {
            if(var2 > var4) {
               ...
               int var8 = var4;
               Class44_Sub1 var9 = Class3_Sub13_Sub16.aClass44_Sub1Array3201[var7];
               ...
               for(int var10 = var4; var10 < var2; ++var10) {
                  if(~Class94.method1535(var9, Class3_Sub13_Sub16.aClass44_Sub1Array3201[var10], 5730, var0, var1, var3, var5) >= -1) {
                     Class44_Sub1 var11 = Class3_Sub13_Sub16.aClass44_Sub1Array3201[var10];
   ...
   static final void method1048(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         if(-2 >= ~var1 && var4 >= 1 && 102 >= var1 && var4 <= 102) {
            int var8;
            if(!Class140_Sub4_Sub2.method1986(41) && 0 == (2 & Class9.aByteArrayArrayArray113[0][var1][var4])) {
               var8 = var2;
   ...
   static final Class94 method1052(int var0, long var1) {
      try {
         if(-1L > ~var1 && -6582952005840035282L < ~var1) {
            if(-1L == ~(var1 % 37L)) {
               ...
               var10.aByteArray2153 = var6;
               var10.anInt2156 = var6.length;
               return var10;
            }
         } else {
            return null;
   ...
   static final void method1053(byte var0, Class153 var1) {
      try {
               ...
               while(true) {
                  if(~var8 > ~var2) {
                     label146: {
                        ...
                        Class162.aByteArray2040[7] = (byte)this.anInt682;
