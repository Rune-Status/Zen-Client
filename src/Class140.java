...
abstract class Class140 {

   static Class109[] aClass109Array1831;
   static Class94 aClass94_1832 = Class3_Sub4.method108("::setparticles", (byte)-120);
   static int[] anIntArray1833 = new int[14];
   static Class11[][] aClass11ArrayArray1834;
   static int[] anIntArray1835 = new int[100];
   static Class11[] aClass11Array1836;
   ...
   public static void method1860(int var0) {
      try {
         ...
         aClass11ArrayArray1834 = (Class11[][])null;
         if(var0 != 0) {
            method1860(-87);
         }
   ...
   Class140 method1861(int var1, int var2, int var3) {
      try {
         return this;
      } catch (RuntimeException var5) {
   ...
   static final void method1862(boolean var0, int var1, int var2, int var3, int var4) {
      try {
         ...
         if(GameStub.aString1202.startsWith("mac") && -1 > ~var1) {
            var0 = true;
         }

         if(var2 != -8914) {
            method1864(false, (byte)90, (Class153)null, (Class3_Sub28_Sub17_Sub1)null, (Class153)null);
         }
   ...
   static final void method1864(boolean var0, byte var1, Class153 var2, Class3_Sub28_Sub17_Sub1 var3, Class153 var4) {
      try {
         ...
         RuntimeException_Sub1.aClass94Array2119 = new Class94[]{null, null, null, null, Class140_Sub3.aClass94_2744};
         Class3_Sub30.aClass94Array2596 = new Class94[]{null, null, Class3_Sub13_Sub33.aClass94_3397, null, null};
   ...
   void method1866(Class140 var1, int var2, int var3, int var4, boolean var5) {}

   abstract void method1867(int var1, int var2, int var3, int var4, int var5);

   abstract void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12);
