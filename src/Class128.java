...
final class Class128 {
   ...
   private static Class94 aClass94_1686 = Class3_Sub4.method108("shake:", (byte)-117);
   static Class94 aClass94_1687 = Class3_Sub4.method108("(Z", (byte)-124);
   static Class94 aClass94_1688 = aClass94_1686;
   static Class94 aClass94_1689 = aClass94_1686;


   static final void method1760(int var0, byte var1, int var2) {
      try {
         Class61 var3 = Class3_Sub13_Sub22.aClass61ArrayArrayArray3273[Class26.anInt501][var2][var0];
         if(var3 != null) {
            if(var1 == 65) {
               int var4 = -99999999;
