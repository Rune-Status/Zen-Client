...
final class Class33 {
   ...
   private final void method997(Class94 var1, int var2, int var3, int var4, boolean var5) {
      if(this.aBoolean595 || var4 == 0) {
         var5 = false;
      }

      for(int var6 = 0; var6 < var1.method1540(-95); ++var6) {
         int var7 = anIntArray599[var1.method1569(var6, (byte)65)];
         if(var5) {
   ...
   final void method1003(Class94 var1, int var2, int var3, int var4, boolean var5) {
   ...
   private final int method1005(Class94 var1) {
      int var2 = 0;

      for(int var3 = 0; var3 < var1.method1540(-97); ++var3) {
         if(var1.method1569(var3, (byte)-41) == 64 && var3 + 4 < var1.method1540(-93) && var1.method1569(var3 + 4, (byte)66) == 64) {
            var3 += 4;
         } else if(var1.method1569(var3, (byte)101) == 126 && var3 + 4 < var1.method1540(-60) && var1.method1569(var3 + 4, (byte)-51) == 126) {
            var3 += 4;
         } else {
            var2 += this.aByteArray594[anIntArray599[var1.method1569(var3, (byte)-64)] + 7];
         }
      }
