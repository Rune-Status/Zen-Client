...
final class Class140_Sub3 extends Class140 {

   private int anInt2720 = 0;
   private boolean aBoolean2721 = false;
   private Class142 aClass142_2722;
   static Class94 aClass94_2723 = Class3_Sub4.method108("<col=c0ff00>", (byte)-122);
   private int anInt2724;
   private int anInt2725 = 0;
   private int anInt2726;
   static Class153 aClass153_2727;
   private boolean aBoolean2728 = true;
   private int anInt2729;
   private int anInt2730;
   private static Class94 aClass94_2731 = Class3_Sub4.method108("wave:", (byte)-126);
   private int anInt2732;
   private int anInt2733;
   private int anInt2734;
   static Class94 aClass94_2735 = Class3_Sub4.method108(")4", (byte)-126);
   private int anInt2736;
   static int anInt2737 = 0;
   private Class109_Sub1 aClass109_Sub1_2738 = null;
   private static Class94 aClass94_2739 = Class3_Sub4.method108("Drop", (byte)-119);
   static Class94 aClass94_2740 = aClass94_2731;
   private int anInt2741 = -32768;
   private Class127_Sub1 aClass127_Sub1_2742;
   static volatile int anInt2743 = 0;
   static Class94 aClass94_2744 = aClass94_2739;
   ...
   static Class94 aClass94_2751 = aClass94_2731;
   private int anInt2752 = -1;


   static final Class140_Sub1 method1957(int var0, boolean var1, Class142 var2, int var3, int var4, int var5, int var6, int var7, Class140_Sub1 var8, int var9, int var10, int var11, int var12, byte var13) {
      try {
         long var14 = ((long)var4 << 48) + (long)(var7 + (var0 << 16) - -(var12 << 24)) + ((long)var6 << 32);
         Class140_Sub1 var16 = (Class140_Sub1)Class158_Sub1.aClass93_2982.method1526(var14, (byte)121);
         int var21;
         int var23;
         int var25;
         int var24;
         ...
         if(var16 == null) {
            ...
            byte var18 = 3;
            Class140_Sub5 var20 = new Class140_Sub5(1 + var18 * var17, -var17 + var17 * var18 * 2, 0);
            ...
            Class158_Sub1.aClass93_2982.method1515((byte)-125, var16, var14);
         }
         ...
         if(var13 != -49) {
            ...
            if(var2 != null) {
               ...
               var40 = Class3_Sub9.method133(var10 >> 16, 0);
               var10 &= '\uffff';
            }
            ...
            if(null == var40) {
               ...
               var16.method1881((var23 + -var35) / 2, 128, (var25 - var24) / 2);
            ...
            if(!Class138.aBoolean1807) {
               ...
               if(~Class121.method1736(Class26.anInt501, 1, var3 - -var35, var5 - -var24) != ~var11 || var11 != Class121.method1736(Class26.anInt501, 1, var3 + var23, var5 - -var25)) {
                  for(var28 = 0; ~var37.anInt3891 < ~var28; ++var28) {
                     var37.anIntArray3883[var28] += -var11 + Class121.method1736(Class26.anInt501, 1, var3 + var37.anIntArray3885[var28], var5 + var37.anIntArray3895[var28]);
                  }
               ...
               if(~Class121.method1736(Class26.anInt501, var13 ^ -50, var3 - -var35, var24 + var5) != ~var11 || ~Class121.method1736(Class26.anInt501, 1, var23 + var3, var5 - -var25) != ~var11) {
                  for(var28 = 0; var28 < var36.anInt3823; ++var28) {
                     var36.anIntArray3845[var28] += -var11 + Class121.method1736(Class26.anInt501, Class93.method1519(var13, -50), var36.anIntArray3822[var28] - -var3, var5 + var36.anIntArray3848[var28]);
                  }
   ...
   static final void method1959(int var0, int var1, int var2, boolean var3) {
      try {
         if(~var2 <= -8001 && var2 <= '\ubb80') {
            ...
            if(var0 != 256) {
               aClass94_2744 = (Class94)null;
            }

            Class94.aBoolean2150 = var3;
   ...
   final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
      try {
         Class140 var13 = this.method1963(3);
         if(null != var13) {
            var13.method1868(var1, var2, var3, var4, var5, var6, var7, var8, var9, var11, this.aClass127_Sub1_2742);
         }
      ...
      try {
         if(this.aClass142_2722 != null) {
            ...
            if(-101 > ~var4 && this.aClass142_2722.anInt1865 > 0) {
               int var5;
               for(var5 = this.aClass142_2722.anIntArray1851.length - this.aClass142_2722.anInt1865; ~this.anInt2726 > ~var5 && ~this.aClass142_2722.anIntArray1869[this.anInt2726] > ~var4; ++this.anInt2726) {
               ...
               if(this.anInt2733 >= this.aClass142_2722.anIntArray1851.length) {
                  ...
                  if(~this.anInt2733 > -1 || this.aClass142_2722.anIntArray1851.length <= this.anInt2733) {
                     this.anInt2733 = -1;
                  }
               }
            }
            ...
            while(~var4 < ~this.aClass142_2722.anIntArray1869[this.anInt2726]) {
               Class89.method1470(var1, this.aClass142_2722, 183921384, var2, false, this.anInt2726);
               var4 -= this.aClass142_2722.anIntArray1869[this.anInt2726];
               ++this.anInt2726;
               if(~this.aClass142_2722.anIntArray1851.length >= ~this.anInt2726) {
                  this.anInt2726 -= this.aClass142_2722.anInt1865;
                  if(0 > this.anInt2726 || ~this.aClass142_2722.anIntArray1851.length >= ~this.anInt2726) {
               ...
               if(~this.aClass142_2722.anIntArray1851.length >= ~this.anInt2733) {
                  this.anInt2733 -= this.aClass142_2722.anInt1865;
                  if(~this.anInt2733 > -1 || ~this.anInt2733 <= ~this.aClass142_2722.anIntArray1851.length) {
                     this.anInt2733 = -1;
                  }
               }
            }
   ...
   private final Class140 method1962(boolean var1, int var2) {
      try {
         boolean var3 = Class58.anIntArrayArrayArray914 != Class44.anIntArrayArrayArray723;
         Class111 var4 = Class162.method2207(var2 + 6, this.anInt2729);
         ...
         if(null == var4) {
            ...
            int var6;
            if(Class158.anInt2014 != 0 && this.aBoolean2721 && (null == this.aClass142_2722 || null != this.aClass142_2722 && ~this.aClass142_2722.anInt1864 != ~var4.anInt1531)) {
               var6 = var4.anInt1531;
               if(0 == ~var4.anInt1531) {
                  var6 = var5;
               }
               ...
               if(null != this.aClass142_2722) {
                  if(var4.aBoolean1492 && -1 != this.aClass142_2722.anInt1865) {
                     this.anInt2726 = (int)(Math.random() * (double)this.aClass142_2722.anIntArray1851.length);
                     this.anInt2749 -= (int)(Math.random() * (double)this.aClass142_2722.anIntArray1869[this.anInt2726]);
                  } else {
                     this.anInt2726 = 0;
            ...
            boolean var13 = !var3 && var4.aBoolean1503 && (var4.anInt1527 != this.anInt2750 || (~this.anInt2726 != ~this.anInt2752 || this.aClass142_2722 != null && (this.aClass142_2722.aBoolean1872 || Class3_Sub26.aBoolean2558) && ~this.anInt2726 != ~this.anInt2733) && ~Class80.anInt1137 <= -3);
            if(var1 && !var13) {
               return null;
            } else {
               ...
               if(Class138.aBoolean1807 && var13) {
                  Class141.method2047(this.aClass109_Sub1_2738, this.anInt2725, this.anInt2720, this.anInt2748);
               }
               ...
               if(null == var20) {
                  ...
                  if(Class138.aBoolean1807 && var13) {
                     ...
                     Class109_Sub1 var24 = var20.aClass109_Sub1_1770;
   ...
   final Class140 method1963(int var1) {
      try {
         if(var1 != 3) {
            aClass94_2731 = (Class94)null;
         }
   ...
   static final void method1964(boolean var0) {
      try {
         int var1 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 8);
         int var2;
         if(~Class159.anInt2022 < ~var1) {
            for(var2 = var1; ~var2 > ~Class159.anInt2022; ++var2) {
               Class3_Sub7.anIntArray2292[Class139.anInt1829++] = Class56.anIntArray887[var2];
            }
         }
         ...
         if(~var1 >= ~Class159.anInt2022) {
            ...
            for(; ~var2 > ~var1; ++var2) {
               ...
               Class140_Sub4_Sub1 var4 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var3];
               int var5 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 1);
               if(~var5 == -1) {
                  Class56.anIntArray887[Class159.anInt2022++] = var3;
                  var4.anInt2838 = Class44.anInt719;
               } else {
                  int var6 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 2);
                  if(var6 != 0) {
                     int var7;
                     int var8;
                     if(-2 != ~var6) {
                        if(-3 != ~var6) {
                           ...
                           if(Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 1) != 1) {
                              var7 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 3);
                              var4.method1968(0, (byte)113, var7);
                           } else {
                              var7 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 3);
                              var4.method1968(2, (byte)-92, var7);
                              var8 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 3);
                              var4.method1968(2, (byte)88, var8);
                           }

                           var7 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 1);
                           if(1 == var7) {
                              Class21.anIntArray441[Class66.anInt997++] = var3;
                           }
                        }
                     } else {
                        Class56.anIntArray887[Class159.anInt2022++] = var3;
                        ...
                        var8 = Class28.aClass3_Sub30_Sub1_532.method812((byte)-11, 1);
                        if(~var8 == -2) {
                           Class21.anIntArray441[Class66.anInt997++] = var3;
                        }
                     }
   ...
   Class140_Sub3(int var1, int var2, int var3, int var4, int var5, int var6, int var7, boolean var8, Class140 var9) {
      try {
         this.anInt2732 = var4;
         this.anInt2724 = var3;
         this.anInt2736 = var5;
         ...
         this.anInt2730 = var6;
         Class111 var10;
         if(Class138.aBoolean1807 && null != var9) {
            if(var9 instanceof Class140_Sub3) {
               ((Class140_Sub3)var9).method1960(-1);
            } else {
               var10 = Class162.method2207(4, this.anInt2729);
               if(var10.anIntArray1524 != null) {
                  var10 = var10.method1685(0);
               }

               if(null != var10) {
                  Class8.method840(var10, (byte)-76, 0, this.anInt2724, 0, this.anInt2734, this.anInt2736, this.anInt2730, this.anInt2732);
               }
            }
         }
         ...
         if(-1 != var7) {
            ...
            if(var8 && this.aClass142_2722.anInt1865 != -1) {
               ...
               if(~this.anInt2733 <= ~this.aClass142_2722.anIntArray1851.length) {
                  this.anInt2733 -= this.aClass142_2722.anInt1865;
                  if(this.anInt2733 < 0 || ~this.anInt2733 <= ~this.aClass142_2722.anIntArray1851.length) {
                     this.anInt2733 = -1;
                  }
               }

               this.anInt2746 = 1 - -((int)(Math.random() * (double)this.aClass142_2722.anIntArray1869[this.anInt2726]));
               this.anInt2749 = -this.anInt2746 + Class44.anInt719;
            }
         }

         if(Class138.aBoolean1807 && var9 != null) {
            this.method1962(true, -2);
         }
