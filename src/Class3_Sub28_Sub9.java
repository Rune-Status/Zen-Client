...
final class Class3_Sub28_Sub9 extends Class3_Sub28 {
   ...
   Class94 aClass94_3619;
   static int anInt3620 = 0;
   static Class94 aClass94_3621 = null;
      ...
      try {
         ...
         if(Class3_Sub13_Sub22.aBooleanArray3272[0]) {
            ...
            for(int var6 = 0; var6 < var1; ++var6) {
               var5[var6] = Class3_Sub13_Sub29.method308(Class3_Sub28_Sub15.method633(var4[var6] << 24, -16777216), Class3_Sub13_Sub38.anIntArray3446[Class3_Sub28_Sub15.method633(255, var2[var6])]);
            }

            var3 = new Class3_Sub28_Sub16_Sub2_Sub1(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], var5);
         } else {
            int[] var8 = new int[var1];

            for(int var9 = 0; var9 < var1; ++var9) {
               var8[var9] = Class3_Sub13_Sub38.anIntArray3446[Class3_Sub28_Sub15.method633(var2[var9], 255)];
            }

            var3 = new Class3_Sub28_Sub16_Sub2(Class3_Sub15.anInt2426, Class133.anInt1748, Class164.anIntArray2048[0], Class3_Sub30.anIntArray2591[0], Class140_Sub7.anIntArray2931[0], Class3_Sub13_Sub6.anIntArray3076[0], var8);
         }
   ...
   private final void method579(int var1, Class3_Sub30 var2, int var3) {
      try {
         if(~var1 != -2) {
            if(var1 == 2) {
               this.anInt3614 = var2.method748(-502942936);
            } else if(-6 == ~var1) {
               this.aClass94_3619 = var2.method776(true);
            }
         } else {
            this.anInt3617 = var2.method803((byte)-71);
         }
   ...
   static final void method581(Class153 var0, int var1, Class153 var2) {
      try {
   ...
   static final boolean method582(int var0, int var1, int var2, boolean var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      try {
         return Class102.aClass140_Sub4_Sub1_2141.method1977((byte)114) != var5?(Class102.aClass140_Sub4_Sub1_2141.method1977((byte)114) <= 2?Class158_Sub1.method2191(var6, var4, var11, -1001, var10, var9, var2, var1, var3, var8, var0, var7):Class52.method1166(var10, (byte)34, var7, var9, var1, Class102.aClass140_Sub4_Sub1_2141.method1977((byte)114), var6, var8, var4, var11, var2, var3, var0)):Class2.method76(var7, var8, var4, var0, var10, var3, var2, var1, var6, var9, 127, var11);
      } catch (RuntimeException var13) {
         throw Class44.method1067(var13, "hn.O(" + var0 + ',' + var1 + ',' + var2 + ',' + var3 + ',' + var4 + ',' + var5 + ',' + var6 + ',' + var7 + ',' + var8 + ',' + var9 + ',' + var10 + ',' + var11 + ')');
      }
   }

   final void method583(int var1, Class3_Sub30 var2) {
      try {
         if(var1 == 207) {
            while(true) {
               int var3 = var2.method803((byte)-96);
               if(var3 == 0) {
                  return;
               }
