...
final class Class3_Sub28_Sub20 extends Class3_Sub28 {

   private boolean aBoolean3781;
   private float aFloat3782;
   private int anInt3783;
   private int anInt3784;
   static Class94 aClass94_3785 = Class3_Sub4.method108("Benutzeroberfl-=che geladen)3", (byte)-125);
   static Class153 aClass153_3786;
   ...
   static Class94 aClass94_3792 = Class3_Sub4.method108("huffman", (byte)-120);
   ...
   static Class94 aClass94_3798 = Class3_Sub4.method108("RuneScape wird geladen )2 bitte warten)3)3)3", (byte)-121);
   private int anInt3799;
   private boolean aBoolean3800;


   final int[] method718(Interface2 var1, int var2, float var3, Class153 var4, boolean var5) {
      try {
         if(var2 != 0) {
            return (int[])null;
         } else {
               ...
               if(this.aBoolean3789) {
                  ...
                  for(int var31 = var18; ~var31 <= -1; --var31) {
                     ...
                     for(var11 = var17; -1 >= ~var11; --var11) {
                        ...
                        var20 = var28 / 9;
                        --var25;
                        var10[var25] = Class3_Sub13_Sub29.method308(var22, Class3_Sub13_Sub29.method308(var20 << 16, var21 << 8));
   ...
   final boolean method719(Class153 var1, Interface2 var2, int var3, boolean var4) {
      try {
         if(var3 != 579100487) {
            return false;
         } else if(this.aClass82_3790.method1408(true, var2, var1)) {
            GL var5 = Class138.aGL1804;
            int var6 = !var4?128:64;
            int var7 = Class27.method961(1536);
            if(~(1 & var7) == -1) {
               if(0 != ~this.anInt3795) {
                  Class138.method1850(this.anInt3795);
               } else {
                  int[] var8 = new int[1];
            ...
            if(~(2 & var7) == -1) {
               Class138.method1856(this.anInt3784);
            }

            if((4 & var7) == 0) {
               Class138.method1847(0);
            }
            ...
            if((var7 & 8) == 0) {
               if(-1 == ~this.anInt3799 && 0 == this.anInt3783) {
                  ...
                  float var12 = (float)(this.anInt3799 * Class138.anInt1791) / (float)var6;
                  float var13 = (float)(this.anInt3783 * Class138.anInt1791) / (float)var6;
                  Class138.method1843(var13, var12, 0.0F);
               }
            }
   ...
   final int[] method720(boolean var1, boolean var2, Interface2 var3, Class153 var4) {
      try {
         if(var1) {
   ...
   final boolean method722(int var1, Interface2 var2, Class153 var3) {
      try {
         ...
         if(~Class137.method1817((byte)70) == -3) {
            ...
            if(Class26.anInt501 != 3) {
               for(var4 = 0; -3 < ~var4; ++var4) {
                  ...
                  Class142.anIntArray1871[var4] = 1000000;
                  Class140_Sub4_Sub1.anIntArray3959[var4] = 0;
               }

               if(1 == Class133.anInt1753) {
                  if((4 & Class9.aByteArrayArrayArray113[Class26.anInt501][Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7][Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7]) != 0) {
                     Class140_Sub7.method2031((byte)-85, false, Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7, Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7, Class75_Sub2.aClass3_Sub2ArrayArrayArray2638, 0);
                  }

                  if(-311 < ~Class139.anInt1823) {
                     int var7 = Class102.aClass140_Sub4_Sub1_2141.anInt2829 >> 7;
                     ...
                     var4 = Class140_Sub4_Sub2.anInt3995 >> 7;
                     int var6 = Class102.aClass140_Sub4_Sub1_2141.anInt2819 >> 7;
                     int var8;
                     if(~var6 < ~var4) {
                        var8 = -var4 + var6;
                     } else {
                     ...
                     if(var8 > var9) {
                        ...
                        while(var6 != var4) {
                           ...
                           if(~(Class9.aByteArrayArrayArray113[Class26.anInt501][var4][var5] & 4) != -1) {
                           ...
                           if(var11 >= 65536) {
                              ...
                              var11 -= 65536;
                              if(~(4 & Class9.aByteArrayArrayArray113[Class26.anInt501][var4][var5]) != -1) {
                        ...
                        while(~var5 != ~var7) {
                           ...
                           if(~var11 <= -65537) {
                              ...
                              var11 -= 65536;
                              if((4 & Class9.aByteArrayArrayArray113[Class26.anInt501][var4][var5]) != 0) {
                  ...
                  var4 = Class121.method1736(Class26.anInt501, 1, Class140_Sub4_Sub2.anInt3995, Class77.anInt1111);
                  if(800 > var4 + -Class7.anInt2162 && (4 & Class9.aByteArrayArrayArray113[Class26.anInt501][Class140_Sub4_Sub2.anInt3995 >> 7][Class77.anInt1111 >> 7]) != 0) {
                     Class140_Sub7.method2031((byte)-107, false, Class140_Sub4_Sub2.anInt3995 >> 7, Class77.anInt1111 >> 7, Class75_Sub2.aClass3_Sub2ArrayArrayArray2638, 1);
                  }
               }
   ...
   Class3_Sub28_Sub20(Class3_Sub30 var1) {
      try {
         this.aClass82_3790 = new Class82(var1);
         this.aBoolean3789 = var1.method803((byte)-86) == 1;
         this.aBoolean3800 = 1 == var1.method803((byte)-80);
         this.aBoolean3787 = -2 == ~var1.method803((byte)-67);
         this.aBoolean3781 = ~var1.method803((byte)-114) == -2;
         int var2 = 3 & var1.method803((byte)-35);
         this.anInt3783 = var1.method760(false);
         this.anInt3799 = var1.method760(false);
         int var3 = var1.method803((byte)-86);
         var1.method803((byte)-87);
         if(var2 == 1) {
            this.anInt3784 = 2;
         } else if(-3 == ~var2) {
            this.anInt3784 = 3;
