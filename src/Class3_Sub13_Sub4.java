...
final class Class3_Sub13_Sub4 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3055 = Class3_Sub4.method108("k", (byte)-118);
   int anInt3056 = 4;
   ...
   static final void method189(byte var0) {
      try {
         ...
         int var1;
         for(var1 = -1; Class159.anInt2022 > var1; ++var1) {
            int var3;
            if(~var1 != 0) {
               var3 = Class56.anIntArray887[var1];
            } else {
               var3 = 2047;
            }
         ...
         for(var1 = 0; ~Class163.anInt2046 < ~var1; ++var1) {
            var2 = Class15.anIntArray347[var1];
            Class140_Sub4_Sub2 var6 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var2];
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         ...
         if(var1 == 0) {
            this.aBoolean3065 = var2.method803((byte)-101) == 1;
         } else if(~var1 == -2) {
            this.anInt3058 = var2.method803((byte)-96);
         } else if(var1 == 2) {
            ...
            this.anInt3060 = this.anInt3056 = var2.method803((byte)-38);
         } else if(var1 == 4) {
            this.anInt3067 = var2.method803((byte)-94);
         } else if(~var1 == -6) {
            this.anInt3060 = var2.method803((byte)-124);
         } else if(var1 == 6) {
            this.anInt3056 = var2.method803((byte)-66);
         }
   ...
   static final void method193(byte var0, Component var1) {
      try {
         ...
         Method var2 = GameStub.aMethod1222;
         if(null != var2) {
            try {
