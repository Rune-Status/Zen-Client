...
final class Class94 implements Interface3 {

   static int anInt2145;
   static boolean aBoolean2146 = false;
   static int anInt2147 = 0;
   static int anInt2148 = 0;
   static Class94 aClass94_2149 = Class3_Sub4.method108("Bitte warten Sie )2 es wird versucht)1 die Verbindung wiederherzustellen)3", (byte)-118);
   static boolean aBoolean2150;
   private boolean aBoolean2152 = true;
   byte[] aByteArray2153;
   static boolean aBoolean2154;
   static Class94 aClass94_2155 = Class3_Sub4.method108(":allyreq:", (byte)-127);
   int anInt2156;
   static int[] anIntArray2157 = new int[50];
   private static Class94 aClass94_2158 = Class3_Sub4.method108("Allocated memory", (byte)-120);
   static Class94 aClass94_2151 = aClass94_2158;
   ...
   final boolean method1528(byte var1, Class94 var2) {
      try {
         if(var2 == null) {
            return false;
         } else if(this == var2) {
   ...
   final boolean method1531(int var1, Class94 var2) {
      try {
         if(var2 == null) {
            return false;
         } else if(this.anInt2156 != var2.anInt2156) {
   ...
   final Class94 method1533(Class94 var1, boolean var2) {
      try {
   ...
   final Class94 method1534(int var1) {
      try {
         if(var1 != -98) {
            this.method1562((byte)-53, (Class94)null);
         }
   ...
   final Class94 method1536(int var1) {
      try {
         byte var3 = 2;
         Class94 var2 = new Class94();
         var2.anInt2156 = this.anInt2156;
   ...
   final Class94 method1542(int var1, Class94 var2, int var3, int var4) {
      try {
         if(!this.aBoolean2152) {
            throw new IllegalArgumentException();
   ...
   final Class94 method1544(boolean var1) {
      try {
         Class94 var2 = new Class94();
         var2.anInt2156 = this.anInt2156;
   ...
   final Class94 method1545(byte var1) {
      try {
         Class94 var2 = new Class94();
         var2.anInt2156 = this.anInt2156;
         var2.aByteArray2153 = new byte[this.anInt2156];
   ...
   final int method1546(byte var1, Class94 var2) {
      try {
         if(var1 >= -44) {
            aBoolean2150 = true;
         }
   ...
   final Class94 method1548(boolean var1, int var2) {
      try {
         if(~var2 < -1 && ~var2 >= -256) {
   ...
   final boolean method1550(byte var1, Class94 var2) {
      try {
   ...
   final int method1551(Class94 var1, int var2) {
      try {
   ...
   final Class94 method1556(int var1, byte var2) {
      try {
         if(var2 != -74) {
            this.toString();
         }
   ...
   final Class94 method1557(int var1, int var2, int var3) {
      try {
   ...
   final boolean method1558(Class94 var1, int var2) {
      try {
   ...
   public final boolean equals(Object var1) {
      try {
         if(!(var1 instanceof Class94)) {
            throw new IllegalArgumentException();
         } else {
            return this.method1528((byte)-42, (Class94)var1);
         }
      } catch (RuntimeException var3) {
   ...
   final int method1559(Class94 var1, int var2) {
      try {
         if(var2 != -1) {
   ...
   final Class94 method1560(Class94 var1, boolean var2, Class94 var3) {
      try {
         ...
         while(true) {
            ...
            if(0 > var7) {
               var6 = 0;
               Class94 var10 = Class47.method1090((byte)-104, var4);
   ...
   final boolean method1562(byte var1, Class94 var2) {
      try {
   ...
   final Class94 method1563(int var1) {
      try {
         if(var1 <= 86) {
            this.method1564(117);
         }
   ...
   final Class94 method1564(int var1) {
      try {
         if(var1 != 1) {
   ...
   final Class94 method1565(int var1, int var2, int var3) {
      try {
         byte var4 = (byte)var3;
   ...
   final int method1566(Class94 var1, int var2, int var3) {
      try {
   ...
   final Class94[] method1567(int var1, byte var2) {
      try {
         int var3 = 0;
         ...
         Class94[] var11 = new Class94[1 + var3];
         if(var3 == 0) {
            var11[0] = this;
            return var11;
         } else {
   ...
   final Class94 method1571(byte var1) {
      try {
         long var2 = this.method1538(var1 + 90);
         Class var4 = Class94.class;
         synchronized(var4) {
            Class3_Sub29 var5;
   ...
   final Class94 method1572(int var1, byte var2) {
      try {
         if(var2 <= 110) {
            aBoolean2150 = true;
         }
   ...
   final Class94 method1573(byte var1, Applet var2) {
      try {
         if(var1 < 124) {
   ...
   final Class94 method1576(byte var1) {
      try {
         if(!this.aBoolean2152) {
            throw new IllegalArgumentException();
         } else {
   ...
   final Class94 method1579(int var1) {
      try {
         Class94 var2 = Class41.method1052(-29664, this.method1578(-112));
         return var1 >= -4?(Class94)null:(null == var2?Class134.aClass94_1760:var2);
      } catch (RuntimeException var3) {
