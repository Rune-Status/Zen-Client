...
abstract class Class75 {
   ...
   static final void method1339(Class94 var0, int var1) {
      try {
         if(var1 == 0) {
            for(Class3_Sub28_Sub3 var2 = (Class3_Sub28_Sub3)Class134.aClass61_1758.method1222(var1 ^ -39); var2 != null; var2 = (Class3_Sub28_Sub3)Class134.aClass61_1758.method1221(var1 ^ 4)) {
               if(var2.aClass94_3561.method1528((byte)-42, var0)) {
                  Class3_Sub30.aClass3_Sub28_Sub3_2600 = var2;
                  return;
               }
            }
   ...
   static final void method1340(int var0, int var1, byte var2, int var3, int var4) {
      try {
         ...
         for(int var5 = 0; ~Class3_Sub28_Sub3.anInt3557 < ~var5; ++var5) {
            if(~(Class3_Sub28_Sub18.anIntArray3768[var5] + Class155.anIntArray1969[var5]) < ~var0 && ~(var1 + var0) < ~Class155.anIntArray1969[var5] && ~var3 > ~(Class140_Sub4.anIntArray2794[var5] + Class140_Sub4_Sub1.anIntArray3954[var5]) && Class140_Sub4_Sub1.anIntArray3954[var5] < var3 - -var4) {
