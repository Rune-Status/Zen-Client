...
final class Class28 {
	...
	private static Class94 aClass94_553 = Class3_Sub4.method108("slide:", (byte)-128);
	static int anInt529;
	...
	static int anInt546;
	static Class94 aClass94_547 = aClass94_553;
	static int anInt548 = 0;
	static volatile int anInt549 = 0;
	static Class94 aClass94_550 = Class3_Sub4.method108("Jeter", (byte)-117);
	static Class94 aClass94_551 = aClass94_553;
	static Class94 aClass94_552 = Class3_Sub4.method108("Sprites geladen)3", (byte)-117);
		...
		try {
			...
			if(var2 != -30) {
				...
				if(0 != ~this.anInt542 && var3 != -1) {
					var9 = GameClient.method45(this.anInt542, (byte)-20).method2059(var1, var4, var3, (byte)-52, var5);
				} else {
	...
	static final void method967(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
		try {
			if(Canvas_Sub2.method57(var5, 104)) {
				if(var2 == 2) {
					GameClient.method50(Class140.aClass11ArrayArray1834[var5], -1, var6, var1, var4, var7, var0, var3);
				}
			}
