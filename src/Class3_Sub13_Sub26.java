...
final class Class3_Sub13_Sub26 extends Class3_Sub13 {
	...
	private static Class94 aClass94_3334 = Class3_Sub4.method108("wave2:", (byte)-122);
	static Class94[] aClass94Array3317 = new Class94[anInt3332];
	static int[] anIntArray3318 = new int[anInt3332];
	static int[] anIntArray3319 = new int[anInt3332];
	static int anInt3320 = 0;
	static int[] anIntArray3321 = new int[]{76, 8, 137, 4, 0, 1, 38, 2, 19};
	private int anInt3322 = 4096;
	static int anInt3323 = 50;
	static Class94 aClass94_3324 = Class3_Sub4.method108(" loggt sich ein)3", (byte)-120);
	static Class94 aClass94_3325 = aClass94_3334;
	static Class94 aClass94_3326 = Class3_Sub4.method108("leuchten1:", (byte)-123);
	...
	static Class94 aClass94_3330 = Class3_Sub4.method108(":assistreq:", (byte)-122);
	static int[] anIntArray3331 = new int[anInt3332];
	static Class94 aClass94_3333 = aClass94_3334;
		...
		try {
			...
			if(this.aClass114_2382.aBoolean1580) {
				...
				for(int var8 = 0; Class113.anInt1559 > var8; ++var8) {
					...
					int var10 = this.anInt3322 * (-var6[var8 - 1 & Class16.anInt396] + var6[Class16.anInt396 & var8 - -1]);
					int var11 = var10 >> 12;
					int var12 = var9 >> 12;
	...
	final void method157(int var1, Class3_Sub30 var2, boolean var3) {
		try {
			...
			if(var1 == 0) {
				this.anInt3322 = var2.method737(1);
			}
