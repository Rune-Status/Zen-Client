...
final class Class75_Sub1 extends Class75 {
   ...
   static Class109_Sub1 aClass109_Sub1_2631 = null;
   ...
   final void method1341(int var1, int var2, int var3) {
      try {
         if(var1 != 2) {
            method1342((int[])null, (int[])null, (Class140_Sub4_Sub1)null, (byte)-68, (int[])null);
         }
            ...
            for(int var9 = 0; ~var7 != -1 && ~var9 > ~var2.aClass145Array2809.length; var7 >>>= 1) {
               if(~(1 & var7) != -1) {
                  if(~var6 == 0) {
                     ...
                     Class142 var10 = GameClient.method45(var6, (byte)-20);
                     ...
                     if(var12 != null) {
                        if(~var6 == ~var12.anInt1890) {
                           if(var11 != 0) {
                              if(1 == var11) {
                                 ...
                                 var12.anInt1897 = 0;
                                 Class89.method1470(var2.anInt2829, var10, 183921384, var2.anInt2819, var2 == Class102.aClass140_Sub4_Sub1_2141, 0);
                              } else if(-3 == ~var11) {
                                 var12.anInt1894 = 0;
                              }
                           } else {
                        ...
                        } else if(var10.anInt1857 >= GameClient.method45(var12.anInt1890, (byte)-20).anInt1857) {
                           var12 = var2.aClass145Array2809[var9] = null;
                        }
                     }
