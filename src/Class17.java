...
final class Class17 {
   ...
   static int anInt410;
   static int anInt411;
   static Class94 aClass94_412 = Class3_Sub4.method108("Vous ne pouvez pas ajouter votre nom -9 votre liste d(Wamis)3", (byte)-119);
   static Class64 aClass64_413;
   static Class94 aClass94_414 = Class3_Sub4.method108("Verbindung abgebrochen)3", (byte)-126);
   static Class94 aClass94_415 = Class3_Sub4.method108("comp-Btence ", (byte)-118);
      ...
      try {
         if(var1.anInt2779 != 0) {
            ...
            if(var1.anInt2772 != -1 && '\u8000' > var1.anInt2772) {
               Class140_Sub4_Sub2 var3 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var1.anInt2772];
               if(var3 != null) {
            ...
            if(var1.anInt2772 >= '\u8000') {
               ...
               if(~var9 == ~Class3_Sub1.anInt2211) {
                  var9 = 2047;
               }

               Class140_Sub4_Sub1 var10 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var9];
               if(null != var10) {
