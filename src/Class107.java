...
final class Class107 {
   ...
   static Class11 aClass11_1453;
   static Class94[] aClass94Array1454;
   static Class94 aClass94_1455 = Class3_Sub4.method108(" loggt sich aus)3", (byte)-121);


   static final void method1645(Class153 var0, Class153 var1, byte var2) {
      try {
         Class148.aClass153_1916 = var1;
         int var4 = (int)(21.0D * Math.random()) - 10;
         Class54.aClass153_878 = var0;
         int var5 = (int)(21.0D * Math.random()) - 10;
         Class54.aClass153_878.method2142(34, (byte)103);
   ...
   static final void method1648(Class153 var0, int var1) {
      try {
   ...
   static final int method1651(int var0, int var1, int var2) {
      try {
         ...
         if(var0 != 19067) {
            aClass94Array1454 = (Class94[])null;
         }
