...
final class Class132 {
   ...
   static Class153 aClass153_1735;
   static int anInt1736;
   static int anInt1737 = 1;
   static Class94 aClass94_1738 = Class3_Sub4.method108("<col=ffff00>", (byte)-121);
   static Class94[] aClass94Array1739 = new Class94[1000];
   ...
   static final void method1799(byte var0, Class153 var1) {
      try {
   ...
   public static void method1800(byte var0) {
      try {
         ...
         aClass153_1735 = null;
         if(var0 <= 52) {
            aClass94Array1739 = (Class94[])null;
         }
   ...
   static final void method1801(byte var0) {
      try {
         if(var0 >= -94) {
            method1799((byte)-90, (Class153)null);
         }
         ...
         for(var2 = 0; Class3_Sub13_Sub34.anInt3415 > var2; ++var2) {
            var3 = Class168.aClass3_Sub28_Sub17_2096.method682(Class3_Sub30.method802(var2, true));
            if(var3 > var1) {
               var1 = var3;
            }
         }
         ...
         if(-2 == ~Class3_Sub28_Sub13.anInt3660) {
            if(~Class90.anInt1297 == ~Class3_Sub13_Sub39.anInt3460 && ~Class168.anInt2099 == ~Class38_Sub1.anInt2612) {
               Class3_Sub28_Sub1.anInt3537 = Class3_Sub13_Sub34.anInt3415 * 15 - -(!Class153.aBoolean1951?22:26);
               Class3_Sub28_Sub13.anInt3660 = 0;
               Class3_Sub13_Sub33.anInt3395 = var4;
               Class109.anInt1462 = var3;
            ...
            Class3_Sub28_Sub3.anInt3552 = var1;
            Class3_Sub13_Sub33.anInt3395 = var4;
            Class3_Sub28_Sub1.anInt3537 = (Class153.aBoolean1951?26:22) + Class3_Sub13_Sub34.anInt3415 * 15;
            Class38_Sub1.aBoolean2615 = true;
         } else {
