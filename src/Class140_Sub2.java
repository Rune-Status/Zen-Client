...
final class Class140_Sub2 extends Class140 {

   static Class94 aClass94_2700 = Class3_Sub4.method108("p11_full", (byte)-120);
   static int anInt2701 = 0;
   static Class94 aClass94_2702 = Class3_Sub4.method108("floorshadows", (byte)-121);
   int anInt2703;
   private Class127_Sub1 aClass127_Sub1_2704;
   static boolean aBoolean2705 = true;
   private int anInt2706 = 0;
   static Class94 aClass94_2707 = Class3_Sub4.method108("<br>(X100(U(Y", (byte)-118);
   ...
   int anInt2710;
   private Class142 aClass142_2711;
   int anInt2712;
   ...
   private final Class140_Sub1 method1949(boolean var1) {
      try {
         Class28 var2 = Class16.method898((byte)42, this.anInt2708);
         if(var1) {
            aClass94_2707 = (Class94)null;
         }
   ...
   static final void method1950(Class140_Sub4 var0, boolean var1) {
      try {
         ...
         int var3 = 128 * var0.anInt2784 - -(64 * var0.method1977((byte)114));
         if(var1) {
            int var4 = 128 * var0.anInt2835 - -(var0.method1977((byte)114) * 64);
            if(0 == var0.anInt2840) {
               var0.anInt2806 = 1024;
            }
   ...
   static final void method1952(int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         if(Class138.aBoolean1807) {
            ...
            var9 = var8 * (-OutputStream_Sub1.aShort46 + Class111.aShort1535) / 100 + OutputStream_Sub1.aShort46;
            var4 = var9 * var4 >> 8;
         }
         ...
         Class140_Sub4_Sub2.anInt3995 = var0 + -var10;
   ...
   static final Class44_Sub1 method1953(byte var0) {
      try {
         if(var0 <= 97) {
         ...
         return Class48.method1107(5422);
   ...
   final void method1868(int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, long var9, int var11, Class127_Sub1 var12) {
      try {
         Class140_Sub1 var13 = this.method1949(false);
         if(var13 != null) {
            var13.method1868(var1, var2, var3, var4, var5, var6, var7, var8, var9, var11, this.aClass127_Sub1_2704);
   ...
   Class140_Sub2(int var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      try {
         ...
         this.anInt2708 = var1;
         this.anInt2712 = var5;
         int var8 = Class16.method898((byte)42, this.anInt2708).anInt542;
         if(-1 == var8) {
            this.aBoolean2718 = true;
         } else {
