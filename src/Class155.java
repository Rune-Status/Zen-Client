...
class Class155 {
   ...
   static Class94 aClass94_1970 = Class3_Sub4.method108(":", (byte)-119);
   static int anInt1971;
   private long aLong1972 = Class5.method830((byte)-55);
   private Class3_Sub24 aClass3_Sub24_1973;
   static Class94 aClass94_1974 = Class3_Sub4.method108("Verbindung mit Update)2Server)3)3)3", (byte)-123);
   int[] anIntArray1975;
   ...
   static final Class10 method2156(int var0, Class3_Sub30 var1) {
      try {
         Class10 var2 = new Class10();
         var2.anInt149 = var1.method737(var0 + -1023);
         if(var0 != 1024) {
            method2162((Class140)null, 34, 103, -93);
         }
   ...
   static final void method2162(Class140 var0, int var1, int var2, int var3) {
      Class3_Sub2 var4;
      if(var2 < Class89.anInt1234) {
         var4 = Class75_Sub2.aClass3_Sub2ArrayArrayArray2638[var1][var2 + 1][var3];
         if(var4 != null && var4.aClass12_2230 != null && var4.aClass12_2230.aClass140_320.method1865()) {
            var0.method1866(var4.aClass12_2230.aClass140_320, 128, 0, 0, true);
         }
      }

      if(var3 < Class89.anInt1234) {
      ...
      if(var2 < Class89.anInt1234 && var3 < Class3_Sub13_Sub15.anInt3179) {
      ...
      if(var2 < Class89.anInt1234 && var3 > 0) {
         var4 = Class75_Sub2.aClass3_Sub2ArrayArrayArray2638[var1][var2 + 1][var3 - 1];
         if(var4 != null && var4.aClass12_2230 != null && var4.aClass12_2230.aClass140_320.method1865()) {
            var0.method1866(var4.aClass12_2230.aClass140_320, 128, 0, -128, true);
         }
