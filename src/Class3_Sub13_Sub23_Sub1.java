...
final class Class3_Sub13_Sub23_Sub1 extends Class3_Sub13_Sub23 {
   ...
   private static Class94 aClass94_4030 = Class3_Sub4.method108("Allocating memory", (byte)-118);
   ...
   static Class94 aClass94_4036 = Class3_Sub4.method108("Connect-B au serveur de mise -9 jour", (byte)-120);
   static int anInt4037;
   static short aShort4038 = 32767;
   static int anInt4039 = 0;
   static Class94 aClass94_4040 = aClass94_4030;
   ...
   static final Class158 method285(int var0, int var1, boolean var2, Component var3) {
      try {
         if(!var2) {
            ...
            try {
               Class var4 = Class.forName("Class158_Sub2");
   ...
   static final Class3_Sub28_Sub16[] method286(int var0, int var1, int var2, Class153 var3) {
      try {
         if(var0 != -1) {
