...
abstract class Class3_Sub28_Sub17 extends Class3_Sub28 {

   int[] anIntArray3709;
   private int anInt3710;
   private static Class94 aClass94_3711 = Class3_Sub4.method108("gt", (byte)-121);
   private static Class94 aClass94_3712 = Class3_Sub4.method108("lt", (byte)-120);
   private static Class94 aClass94_3713 = Class3_Sub4.method108("shad=", (byte)-127);
   private static Class94 aClass94_3714 = Class3_Sub4.method108("shy", (byte)-117);
   private static Class94 aClass94_3715 = Class3_Sub4.method108("trans=", (byte)-123);
   private static Class94 aClass94_3716 = Class3_Sub4.method108("u=", (byte)-119);
   private static Class94 aClass94_3717 = Class3_Sub4.method108("str=", (byte)-128);
   private static Class94 aClass94_3718 = Class3_Sub4.method108("euro", (byte)-125);
   private int[] anIntArray3719;
   private static Class94 aClass94_3720 = Class3_Sub4.method108(")4col", (byte)-122);
   int[] anIntArray3721;
   private int anInt3722;
   private int[] anIntArray3723;
   private static Class94 aClass94_3724 = Class3_Sub4.method108(")4shad", (byte)-123);
   private static Class94 aClass94_3725 = Class3_Sub4.method108("col=", (byte)-122);
   private static Class94 aClass94_3726 = Class3_Sub4.method108("<gt>", (byte)-128);
   int anInt3727 = 0;
   private static Class94 aClass94_3728 = Class3_Sub4.method108("u", (byte)-118);
   private static Class94 aClass94_3729 = Class3_Sub4.method108("times", (byte)-118);
   private int[] anIntArray3730;
   private static Class94 aClass94_3731 = Class3_Sub4.method108(")4trans", (byte)-126);
   private static Class94 aClass94_3732 = Class3_Sub4.method108("nbsp", (byte)-128);
   private byte[] aByteArray3733;
   private static Class94 aClass94_3734 = Class3_Sub4.method108("<lt>", (byte)-124);
   private static Class94 aClass94_3735 = Class3_Sub4.method108(")4u", (byte)-123);
   private int[] anIntArray3736;
   private static Class94 aClass94_3737 = Class3_Sub4.method108("br", (byte)-120);
   private static Class94 aClass94_3738 = Class3_Sub4.method108("shad", (byte)-124);
   private static Class94 aClass94_3739 = Class3_Sub4.method108("img=", (byte)-123);
   private Class109[] aClass109Array3740;
   private static Class94 aClass94_3741 = Class3_Sub4.method108("copy", (byte)-117);
   private static Class94 aClass94_3742 = Class3_Sub4.method108(")4str", (byte)-125);
   private static Class94 aClass94_3743 = Class3_Sub4.method108("reg", (byte)-117);
   private static Class94 aClass94_3744 = Class3_Sub4.method108("str", (byte)-125);
   private static Class94 aClass94_3745 = Class47.method1090((byte)-123, 100);
   ...
   private static Class94[] aClass94Array3753 = new Class94[100];
   private static int anInt3754 = -1;
   private static int anInt3755 = 0;
   private static int anInt3756 = 0;


   final int method676(Class94 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10) {
      return this.method693(var1, var2, var3, var4, var5, var6, var7, 256, var8, var9, var10);
   }

   private final void method677(Class94 var1, int var2, int var3) {
      var3 -= this.anInt3727;
      int var4 = -1;
      int var5 = 0;
      int var6 = var1.method1540(-34);

      for(int var7 = 0; var7 < var6; ++var7) {
         int var8 = var1.method1569(var7, (byte)72);
         if(var8 == 60) {
            var4 = var7;
         } else {
            int var10;
            if(var8 == 62 && var4 != -1) {
               Class94 var9 = var1.method1557(var7, 0, var4 + 1);
               var4 = -1;
                  ...
                  if(!var9.method1528((byte)-42, aClass94_3743)) {
                     if(var9.method1558(aClass94_3739, 0)) {
                        try {
                           ...
                           Class109 var15 = this.aClass109Array3740[var10];
   ...
   final int method680(Class94 var1, int var2) {
   ...
   final void method681(Class94 var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
   ...
   final int method682(Class94 var1) {
      if(var1 == null) {
         return 0;
      } else {
         int var2 = -1;
         int var3 = 0;
         int var4 = 0;
         int var5 = var1.method1540(-105);

         for(int var6 = 0; var6 < var5; ++var6) {
            int var7 = var1.method1569(var6, (byte)-45);
            if(var7 == 60) {
               var2 = var6;
            } else {
               if(var7 == 62 && var2 != -1) {
                  Class94 var8 = var1.method1557(var6, 0, var2 + 1);
                  var2 = -1;
   ...
   final int method683(Class94 var1, int var2, int var3, int var4, int var5, Random var6, int var7) {
      if(var1 == null) {
         return 0;
      } else {
         var6.setSeed((long)var7);
         this.method701(var4, var5, 192 + (var6.nextInt() & 31));
         int var8 = var1.method1540(-40);
   ...
   final int method684(Class94 var1, int var2) {
      return this.method691(var1, new int[]{var2}, aClass94Array3753);
   }

   private final void method685(Class94 var1) {
      try {
   ...
   static final Class94 method686(Class94 var0) {
      int var1 = var0.method1540(-94);
      int var2 = 0;

      int var4;
      for(int var3 = 0; var3 < var1; ++var3) {
         var4 = var0.method1569(var3, (byte)50);
         if(var4 == 60 || var4 == 62) {
            var2 += 3;
         }
      }

      Class94 var6 = Class47.method1090((byte)-92, var1 + var2);

      for(var4 = 0; var4 < var1; ++var4) {
         int var5 = var0.method1569(var4, (byte)-101);
         if(var5 == 60) {
   ...
   final void method688(Class94 var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   private final void method690(Class94 var1, int var2) {
      int var3 = 0;
      boolean var4 = false;
      int var5 = var1.method1540(-78);

      for(int var6 = 0; var6 < var5; ++var6) {
         int var7 = var1.method1569(var6, (byte)75);
         if(var7 == 60) {
            var4 = true;
         } else if(var7 == 62) {
            var4 = false;
   ...
   final int method691(Class94 var1, int[] var2, Class94[] var3) {
      if(var1 == null) {
         return 0;
      } else {
         ...
         int var10 = 0;
         int var11 = 0;
         int var12 = var1.method1540(-93);

         for(int var13 = 0; var13 < var12; ++var13) {
            int var14 = var1.method1569(var13, (byte)-30);
            if(var14 == 60) {
               var9 = var13;
            } else {
               if(var14 == 62 && var9 != -1) {
                  Class94 var15 = var1.method1557(var13, 0, var9 + 1);
                  var9 = -1;
                  ...
                  if(var15.method1528((byte)-42, aClass94_3737)) {
                     if(var3[var11] != null) {
                        ...
                        var3[var11].method1542(1, aClass94_3745, var5, aClass94_3745.method1540(-72));
                     } else {
                        var3[var11] = aClass94_3745.method1563(101).method1557(aClass94_3745.method1540(-91), 0, var5);
                     }

                     ++var11;
                     var5 = aClass94_3745.method1540(-26);
                     var4 = 0;
                     var6 = -1;
                     var10 = 0;
               ...
               if(var9 == -1) {
                  ...
                  if(var14 == 32) {
                     var6 = aClass94_3745.method1540(-71);
                     var7 = var4;
                     var8 = 1;
                  }
                  ...
                  if(var14 == 45) {
                     var6 = aClass94_3745.method1540(-104);
                     var7 = var4;
                     var8 = 0;
                  }
               }
         ...
         if(aClass94_3745.method1540(-78) > var5) {
            if(var3[var11] != null) {
               var3[var11].method1553(0, false);
               var3[var11] = var3[var11].method1542(1, aClass94_3745, var5, aClass94_3745.method1540(-64));
            } else {
               var3[var11] = aClass94_3745.method1563(94).method1557(aClass94_3745.method1540(-89), 0, var5);
            }
   ...
   final void method692(Class94 var1, int var2, int var3, int var4, int var5, int var6, int var7) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   final int method693(Class94 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11) {
      if(var1 == null) {
         return 0;
      } else {
   ...
   final void method695(Class94 var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.method698(var4, var5);
         int var7 = var1.method1540(-61);
   ...
   final void method696(Class94 var1, int var2, int var3, int var4, int var5, int var6) {
      if(var1 != null) {
         this.method698(var4, var5);
         int var7 = var1.method1540(-128);
         int[] var8 = new int[var7];
   ...
   final void method697(Class109[] var1, int[] var2) {
   ...
   final void method699(Class94 var1, int var2, int var3, int var4, int var5) {
      if(var1 != null) {
         this.method698(var4, var5);
   ...
   final int method702(Class94 var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, Random var10, int var11, int[] var12) {
      if(var1 == null) {
         return 0;
      } else {
         var10.setSeed((long)var11);
         this.method701(var6, var7, 192 + (var10.nextInt() & 31));
         int var13 = var1.method1540(-114);
   ...
   private final void method703(Class94 var1, int var2, int var3, int[] var4, int[] var5) {
      var3 -= this.anInt3727;
      int var6 = -1;
      int var7 = 0;
      int var8 = 0;
      int var9 = var1.method1540(-29);

      for(int var10 = 0; var10 < var9; ++var10) {
         int var11 = var1.method1569(var10, (byte)95);
         if(var11 == 60) {
            var6 = var10;
         } else {
            int var13;
            ...
            int var15;
            if(var11 == 62 && var6 != -1) {
               Class94 var12 = var1.method1557(var10, 0, var6 + 1);
               var6 = -1;
                  ...
                  if(!var12.method1528((byte)-42, aClass94_3743)) {
                     if(var12.method1558(aClass94_3739, 0)) {
                        try {
                           ...
                           Class109 var20 = this.aClass109Array3740[var15];
