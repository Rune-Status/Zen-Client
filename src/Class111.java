...
final class Class111 {
   ...
   int anInt1522;
   static Class94 aClass94_1523 = Class3_Sub4.method108("Chargement en cours)3 Veuillez patienter)3", (byte)-123);
   int[] anIntArray1524;
         ...
         if(this.anIntArray1487 != null) {
            for(int var7 = 0; ~this.anIntArray1487.length < ~var7; ++var7) {
               if(~var2 == ~this.anIntArray1487[var7]) {
                  return Class69.aClass153_1043.method2129((byte)72, 0, this.anIntArray1519[var7] & '\uffff');
               }
            }
            ...
            for(int var5 = 0; this.anIntArray1519.length > var5; ++var5) {
               var4 &= Class69.aClass153_1043.method2129((byte)71, 0, '\uffff' & this.anIntArray1519[var5]);
            }
   ...
   final Class111 method1685(int var1) {
      try {
         if(var1 != 0) {
            this.method1697(-92, 83, (Class109_Sub1)null, -13, (Class142)null, 18, (int[][])((int[][])null), true, 114, 123, (int[][])((int[][])null), 118, 85, -116);
         }

         int var2 = -1;
         if(this.anInt1526 != -1) {
            var2 = Class90.method1484(64835055, this.anInt1526);
         ...
         if(~var2 <= -1 && ~var2 > ~(this.anIntArray1524.length - 1) && ~this.anIntArray1524[var2] != 0) {
            return Class162.method2207(4, this.anIntArray1524[var2]);
         } else {
            int var3 = this.anIntArray1524[-1 + this.anIntArray1524.length];
            return ~var3 == 0?null:Class162.method2207(4, var3);
         }
   ...
   private final Class140_Sub5 method1686(int var1, int var2, int var3) {
      try {
         Class140_Sub5 var4 = null;
         ...
         if(null == this.anIntArray1487) {
            ...
            for(var7 = 0; ~var7 > ~var6; ++var7) {
               ...
               var4 = (Class140_Sub5)Class99.aClass93_1401.method1526((long)var8, (byte)121);
               if(var4 == null) {
                  var4 = Class140_Sub5.method2015(Class69.aClass153_1043, var8 & '\uffff', 0);
                  if(var4 == null) {
                     return null;
                  }
                  ...
                  Class99.aClass93_1401.method1515((byte)-91, var4, (long)var8);
               }
            ...
            if(~var6 < -2) {
               var4 = new Class140_Sub5(Class164.aClass140_Sub5Array2058, var6);
            }
         } else {
            var6 = -1;
            ...
            var4 = (Class140_Sub5)Class99.aClass93_1401.method1526((long)var7, (byte)121);
            if(null == var4) {
               var4 = Class140_Sub5.method2015(Class69.aClass153_1043, var7 & '\uffff', 0);
               if(null == var4) {
                  return null;
               }
               ...
               Class99.aClass93_1401.method1515((byte)-122, var4, (long)var7);
            }
         }
         ...
         Class140_Sub5 var13 = new Class140_Sub5(var4, var3 == ~var1 && !var11 && !var12, this.aShortArray1477 == null, null == this.aShortArray1476, true);
         if(~var2 == -5 && var1 > 3) {
   ...
   final void method1689(int var1) {
      try {
         if(this.anInt1529 == -1) {
            this.anInt1529 = 0;
            if(null != this.anIntArray1519 && (null == this.anIntArray1487 || -11 == ~this.anIntArray1487[0])) {
               this.anInt1529 = 1;
            }
         ...
         if(var1 != -2116) {
            this.method1692(67, (Class3_Sub30)null);
         }
   ...
   final boolean method1690(int var1) {
      try {
         if(this.anIntArray1524 != null) {
            if(var1 != 28933) {
               this.method1696(34, 54, (int[][])((int[][])null), 55, 80, (int[][])((int[][])null), true, (Class109_Sub1)null, (byte)127, true, -38);
            }

            for(int var2 = 0; ~var2 > ~this.anIntArray1524.length; ++var2) {
               if(0 != ~this.anIntArray1524[var2]) {
                  Class111 var3 = Class162.method2207(var1 + -28929, this.anIntArray1524[var2]);
   ...
   final void method1692(int var1, Class3_Sub30 var2) {
      try {
         while(true) {
            int var3 = var2.method803((byte)-89);
            if(-1 == ~var3) {
               if(var1 != 6219) {
                  this.method1696(105, -55, (int[][])((int[][])null), -39, 71, (int[][])((int[][])null), true, (Class109_Sub1)null, (byte)-117, false, -25);
               }
   ...
   private final void method1693(Class3_Sub30 var1, int var2, int var3) {
      try {
         if(var3 != -80) {
            this.anInt1522 = -122;
         }
         ...
         int var5;
         if(1 == var2) {
            var4 = var1.method803((byte)-77);
            if(~var4 < -1) {
               if(this.anIntArray1519 != null && !Class47.aBoolean742) {
                  var1.anInt2595 += var4 * 3;
               } else {
                  this.anIntArray1487 = new int[var4];
                  this.anIntArray1519 = new int[var4];

                  for(var5 = 0; var4 > var5; ++var5) {
                     this.anIntArray1519[var5] = var1.method737(Class93.method1519(var3, -79));
                     this.anIntArray1487[var5] = var1.method803((byte)-75);
                  }
               }
            }
         } else if(-3 == ~var2) {
            this.aClass94_1504 = var1.method776(true);
         } else if(-6 != ~var2) {
            if(~var2 == -15) {
               this.anInt1480 = var1.method803((byte)-124);
            } else if(-16 != ~var2) {
               if(~var2 != -18) {
                  if(18 != var2) {
                     if(var2 != 19) {
                        if(~var2 != -22) {
                           if(~var2 != -23) {
                              if(-24 != ~var2) {
                                 if(~var2 == -25) {
                                    this.anInt1531 = var1.method737(var3 ^ -79);
                                    if(~this.anInt1531 == -65536) {
                                       this.anInt1531 = -1;
                                    }
                                 } else if(-28 != ~var2) {
                                    if(28 == var2) {
                                       this.anInt1528 = var1.method803((byte)-112);
                                    } else if(-30 != ~var2) {
                                       if(39 == var2) {
                                          this.anInt1489 = var1.method760(false) * 5;
                                       } else if(~var2 <= -31 && -36 < ~var2) {
                                          this.aClass94Array1499[var2 - 30] = var1.method776(true);
                                          if(this.aClass94Array1499[-30 + var2].method1531(-112, Class3_Sub13_Sub3.aClass94_3051)) {
                                             this.aClass94Array1499[-30 + var2] = null;
                                          }
                                       } else if(var2 == 40) {
                                          var4 = var1.method803((byte)-27);
                                          this.aShortArray1477 = new short[var4];
                                          this.aShortArray1506 = new short[var4];

                                          for(var5 = 0; var5 < var4; ++var5) {
                                             this.aShortArray1477[var5] = (short)var1.method737(1);
                                             this.aShortArray1506[var5] = (short)var1.method737(1);
                                          }
                                       } else if(var2 != 41) {
                                          if(var2 == 42) {
                                             var4 = var1.method803((byte)-118);
                                             this.aByteArray1513 = new byte[var4];

                                             for(var5 = 0; ~var5 > ~var4; ++var5) {
                                                this.aByteArray1513[var5] = var1.method760(false);
                                             }
                                          } else if(var2 != 60) {
                                             if(~var2 == -63) {
                                                ...
                                                if(~var2 == -66) {
                                                   this.anInt1479 = var1.method737(1);
                                                } else if(-67 == ~var2) {
                                                   this.anInt1488 = var1.method737(1);
                                                } else if(-68 == ~var2) {
                                                   this.anInt1481 = var1.method737(var3 + 81);
                                                } else if(var2 != 69) {
                                                   if(70 == var2) {
                                                      ...
                                                      if(var2 != 74) {
                                                         if(75 == var2) {
                                                            this.anInt1540 = var1.method803((byte)-66);
                                                            ...
                                                            if(78 != var2) {
                                                               if(~var2 != -80) {
                                                                  if(81 != var2) {
                                                                           ...
                                                                           if(-90 != ~var2) {
                                                                              if(90 != var2) {
                                                                                 if(var2 == 91) {
                                                                                    ...
                                                                                    this.aByte1505 = 3;
                                                                                    this.aShort1500 = (short)var1.method737(1);
                                                                                 } else if(var2 != 94) {
                                                                                    if(~var2 == -96) {
                                                                                       this.aByte1505 = 5;
                                                                                    } else if(~var2 != -97) {
                                                                                       if(~var2 == -98) {
                                                                                          ...
                                                                                          if(-101 == ~var2) {
                                                                                             this.anInt1520 = var1.method803((byte)-27);
                                                                                             this.anInt1522 = var1.method737(var3 ^ -79);
                                                                                          } else if(~var2 != -102) {
                                                                                             if(var2 != 102) {
                                                                                                if(249 == var2) {
                                                                                                   var4 = var1.method803((byte)-88);
                                                                                                   ...
                                                                                                   for(var5 = 0; var4 > var5; ++var5) {
                                                                                                      boolean var10 = -2 == ~var1.method803((byte)-84);
                                                                                                      int var7 = var1.method794((byte)122);
                                                                                                      Object var8;
                                                                                                      if(!var10) {
                                                                                                         var8 = new Class3_Sub18(var1.method748(-502942936));
                                                                                                      } else {
                                                                                                         var8 = new Class3_Sub29(var1.method776(true));
                                                                                                      }
                                                                                                ...
                                                                                                this.anInt1516 = var1.method737(1);
                                                                                             }
                                                                                          } else {
                                                                                             this.anInt1478 = var1.method803((byte)-114);
                                                                                          }
                                                                                       } else {
                                                                                          this.anInt1493 = var1.method803((byte)-115);
                                                                                          this.anInt1517 = var1.method737(1);
                                                                                       }
                                                                                    } else {
                                                                     ...
                                                                     this.aByte1505 = 2;
                                                                     this.aShort1500 = (short)(256 * var1.method803((byte)-52));
                                                                  }
                                                               } else {
                                                                  this.anInt1518 = var1.method737(1);
                                                                  this.anInt1515 = var1.method737(1);
                                                                  this.anInt1484 = var1.method803((byte)-100);
                                                                  var4 = var1.method803((byte)-95);
                                                                  this.anIntArray1539 = new int[var4];

                                                                  for(var5 = 0; ~var4 < ~var5; ++var5) {
                                                                     this.anIntArray1539[var5] = var1.method737(1);
                                                                  }
                                                               }
                                                            } else {
                                                               this.anInt1512 = var1.method737(var3 + 81);
                                                               this.anInt1484 = var1.method803((byte)-90);
                                                            }
                                                         } else {
                                                            var4 = -1;
                                                            this.anInt1526 = var1.method737(1);
                                                            if('\uffff' == this.anInt1526) {
                                                               this.anInt1526 = -1;
                                                            }

                                                            this.anInt1532 = var1.method737(1);
                                                            if('\uffff' == this.anInt1532) {
                                                               this.anInt1532 = -1;
                                                            }

                                                            if(92 == var2) {
                                                               var4 = var1.method737(1);
                                                               if(var4 == '\uffff') {
                                                                  var4 = -1;
                                                               }
                                                            }

                                                            var5 = var1.method803((byte)-66);
                                                            this.anIntArray1524 = new int[var5 - -2];

                                                            for(int var6 = 0; var5 >= var6; ++var6) {
                                                               this.anIntArray1524[var6] = var1.method737(1);
                                                   ...
                                                   this.anInt1533 = var1.method803((byte)-55);
                                                }
                                             } else {
                                                this.aBoolean1525 = false;
                                             }
                                          } else {
                                             this.anInt1482 = var1.method737(var3 ^ -79);
                                          }
                                       } else {
                                          var4 = var1.method803((byte)-79);
                                          this.aShortArray1495 = new short[var4];
                                          this.aShortArray1476 = new short[var4];

                                          for(var5 = 0; ~var5 > ~var4; ++var5) {
                                             this.aShortArray1476[var5] = (short)var1.method737(1);
                                             this.aShortArray1495[var5] = (short)var1.method737(Class93.method1519(var3, -79));
                                          }
                                       }
                                    } else {
                                       this.anInt1494 = var1.method760(false);
                                    }
                                 } else {
                                    this.anInt1538 = 1;
                                 }
                        ...
                        this.anInt1529 = var1.method803((byte)-79);
                     }
                  } else {
               ...
               this.anInt1485 = var1.method803((byte)-42);
            }
         } else {
            var4 = var1.method803((byte)-62);
            if(~var4 < -1) {
               if(null != this.anIntArray1519 && !Class47.aBoolean742) {
                  var1.anInt2595 += var4 * 2;
               } else {
                  this.anIntArray1519 = new int[var4];
                  this.anIntArray1487 = null;

                  for(var5 = 0; var4 > var5; ++var5) {
                     this.anIntArray1519[var5] = var1.method737(1);
                  }
               }
            }
         }
         ...
         throw Class44.method1067(var9, "pb.K(" + (var1 != null?"{...}":"null") + ',' + var2 + ',' + var3 + ')');
      }
   }
      ...
      try {
         if(null == this.anIntArray1519) {
            ...
            for(int var3 = 0; ~this.anIntArray1519.length < ~var3; ++var3) {
               var2 &= Class69.aClass153_1043.method2129((byte)64, 0, '\uffff' & this.anIntArray1519[var3]);
            }
   ...
   private final Class140_Sub1_Sub1 method1695(int var1, boolean var2, boolean var3, int var4) {
      try {
         ...
         if(this.anIntArray1487 != null) {
            ...
            var5 = (Class140_Sub1_Sub1)Class99.aClass93_1401.method1526((long)var9, (byte)121);
            if(null == var5) {
               Class140_Sub5 var10 = Class140_Sub5.method2015(Class69.aClass153_1043, '\uffff' & var9, 0);
               if(null == var10) {
                  return null;
               }

               var5 = new Class140_Sub1_Sub1(var10, var6, var7, var2);
               Class99.aClass93_1401.method1515((byte)-101, var5, (long)var9);
            }
         } else {
            if(var4 != 10) {
               return null;
            ...
            var5 = (Class140_Sub1_Sub1)Class99.aClass93_1401.method1526(var16, (byte)121);
            if(null == var5) {
               Class140_Sub5 var17 = null;

               for(var12 = 0; ~var8 < ~var12; ++var12) {
                  var17 = Class140_Sub5.method2015(Class69.aClass153_1043, this.anIntArray1519[var12] & '\uffff', 0);
                  if(null == var17) {
                     return null;
                  }
               ...
               if(1 < var8) {
                  var17 = new Class140_Sub5(Class164.aClass140_Sub5Array2058, var8);
               }

               var5 = new Class140_Sub1_Sub1(var17, var6, var7, var2);
               Class99.aClass93_1401.method1515((byte)-75, var5, var16);
            }
         }
         ...
         if(this.anInt1479 != 128 || -129 != ~this.anInt1488 || ~this.anInt1481 != -129) {
            var19.method1881(this.anInt1479, this.anInt1488, this.anInt1481);
         }
   ...
   final Class136 method1696(int var1, int var2, int[][] var3, int var4, int var5, int[][] var6, boolean var7, Class109_Sub1 var8, byte var9, boolean var10, int var11) {
      try {
         if(var9 >= -5) {
            ...
            if(!Class138.aBoolean1807) {
               ...
               Object var22 = (Class140)Class3_Sub28_Sub7_Sub1.aClass93_4051.method1526(var12, (byte)121);
               if(null == var22) {
                  Class140_Sub5 var21 = this.method1686(var1, var4, -1);
                  if(var21 == null) {
                  ...
                  Class3_Sub28_Sub7_Sub1.aClass93_4051.method1515((byte)-89, var22, var12);
               }

               if(var20) {
                  var22 = ((Class140_Sub5)var22).method2004();
               }

               if(0 != this.aByte1505) {
                  if(!(var22 instanceof Class140_Sub1_Sub2)) {
                     if(var22 instanceof Class140_Sub5) {
                        var22 = ((Class140_Sub5)var22).method1999(this.aByte1505, this.aShort1500, var3, var6, var2, var5, var11, true, false);
                     }
                  } else {
               ...
               Class100.aClass136_1413.aClass140_1777 = (Class140)var22;
               return Class100.aClass136_1413;
            } else {
               if(null != this.anIntArray1487) {
               ...
               Class136 var16 = (Class136)Class3_Sub28_Sub7_Sub1.aClass93_4051.method1526(var12, (byte)121);
               ...
               if(null == var16) {
                  ...
                  Class3_Sub28_Sub7_Sub1.aClass93_4051.method1515((byte)-93, var16, var12);
               } else {
   ...
   final Class136 method1697(int var1, int var2, Class109_Sub1 var3, int var4, Class142 var5, int var6, int[][] var7, boolean var8, int var9, int var10, int[][] var11, int var12, int var13, int var14) {
      try {
         if(var10 != 8308) {
         ...
         if(Class138.aBoolean1807) {
            ...
            Class140_Sub1_Sub1 var23 = (Class140_Sub1_Sub1)Class154.aClass93_1965.method1526(var15, (byte)121);
            if(var23 == null) {
               ...
               Class154.aClass93_1965.method1515((byte)-75, var23, var15);
            }
            ...
            Class140_Sub1_Sub2 var17 = (Class140_Sub1_Sub2)Class154.aClass93_1965.method1526(var15, (byte)121);
            if(var17 == null) {
               Class140_Sub5 var18 = this.method1686(var6, var13, -1);
               if(var18 == null) {
                  return null;
               }

               var17 = new Class140_Sub1_Sub2(var18, 64 + this.anInt1494, this.anInt1489 * 5 + 768, -50, -10, -50);
               Class154.aClass93_1965.method1515((byte)-94, var17, var15);
            }
   ...
   final Class94 method1698(Class94 var1, int var2, int var3) {
      try {
         if(var2 != -23085) {
   ...
   public Class111() {
      this.aClass94_1504 = Class3_Sub13_Sub13.aClass94_3150;
      ...
      this.aShort1500 = -1;
      this.anInt1481 = 128;
      this.aClass94Array1499 = new Class94[5];
      this.anInt1479 = 128;
