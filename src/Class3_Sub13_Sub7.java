...
final class Class3_Sub13_Sub7 extends Class3_Sub13 {
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(~var1 == -1) {
            this.anInt3085 = var2.method803((byte)-118);
         } else if(-2 != ~var1) {
            if(-3 == ~var1) {
               this.anInt3086 = var2.method803((byte)-81);
            }
         } else {
            this.anInt3093 = var2.method737(1);
         }
