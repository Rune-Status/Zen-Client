...
final class Class163_Sub3 extends Class163 {
   ...
   static Class94 aClass94_3000 = Class3_Sub4.method108("; Max)2Age=", (byte)-119);
   static int anInt3001;
   static Class94 aClass94_3002 = Class3_Sub4.method108("M", (byte)-121);
   static Class94[] aClass94Array3003 = new Class94[100];
   static boolean aBoolean3004 = true;
   static byte[][] aByteArrayArray3005;
   static Class94 aClass94_3006 = Class3_Sub4.method108("<col=ff3000>", (byte)-125);
      ...
      try {
         ...
         if(var0 <= -69) {
            ...
            for(var1 = 0; Class139.anInt1829 > var1; ++var1) {
               ...
               if(Class44.anInt719 != Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var2].anInt2838) {
      ...
      try {
         if(-1L != ~var0) {
            if((100 > Class8.anInt104 || Class3_Sub13_Sub29.aBoolean3358) && ~Class8.anInt104 > -201) {
               Class94 var3 = Class41.method1052(-29664, var0).method1545((byte)-50);
               if(var2 != -91) {
                  method2227((byte)22);
               }
               ...
               for(var4 = 0; Class8.anInt104 > var4; ++var4) {
                  if(~Class50.aLongArray826[var4] == ~var0) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, Class16.method903(new Class94[]{var3, Class3_Sub28_Sub11.aClass94_3645}, (byte)-93), -1);
                     return;
                  }
               }
               ...
               for(var4 = 0; ~Class3_Sub28_Sub5.anInt3591 < ~var4; ++var4) {
                  if(~var0 == ~Class114.aLongArray1574[var4]) {
                     Class3_Sub30_Sub1.method805(Class3_Sub28_Sub14.aClass94_3672, 0, Class16.method903(new Class94[]{Class38.aClass94_662, var3, Applet_Sub1.aClass94_4}, (byte)-66), -1);
                     return;
                  }
               }
