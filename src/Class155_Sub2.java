...
final class Class155_Sub2 extends Class155 {
   ...
   final void method2164(Component var1) {
      ...
      this.anAudioFormat2974 = new AudioFormat((float)Class21.anInt443, 16, !Class94.aBoolean2150?1:2, true, false);
      this.aByteArray2975 = new byte[256 << (Class94.aBoolean2150?2:1)];
   }

   final void method2150(int var1) throws LineUnavailableException {
      try {
         javax.sound.sampled.DataLine.Info var2 = new javax.sound.sampled.DataLine.Info(SourceDataLine.class, this.anAudioFormat2974, var1 << (!Class94.aBoolean2150?1:2));
   ...
   final void method2151() throws LineUnavailableException {
      ...
      if(this.aBoolean2973) {
         this.aSourceDataLine2972.close();
         this.aSourceDataLine2972 = null;
         javax.sound.sampled.DataLine.Info var1 = new javax.sound.sampled.DataLine.Info(SourceDataLine.class, this.anAudioFormat2974, this.anInt2971 << (!Class94.aBoolean2150?1:2));
   ...
   final int method2157() {
      return this.anInt2971 - (this.aSourceDataLine2972.available() >> (!Class94.aBoolean2150?1:2));
   }
