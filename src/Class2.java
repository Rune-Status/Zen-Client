...
final class Class2 {
	...
	private static Class94 aClass94_68 = Class3_Sub4.method108("glow1:", (byte)-118);

	static int anInt59 = 0;
	static Class94 aClass94_60 = aClass94_68;
	int anInt61;
	static Class94 aClass94_62 = aClass94_68;
	...
	final void method74(byte var1, Class3_Sub30 var2, int var3) {
		try {
			while(true) {
				int var4 = var2.method803((byte)-34);
				if(-1 == ~var4) {
					if(var1 > -108) {
						this.method74((byte)85, (Class3_Sub30)null, 63);
					}
	...
	static final void method75(Class11[] var0, boolean var1, int var2) {
		try {
			if(var1) {
				for(int var3 = 0; ~var3 > ~var0.length; ++var3) {
					Class11 var4 = var0[var3];
					if(null != var4) {
						if(var4.anInt187 == 0) {
						...
						if(~var2 == -1 && null != var4.anObjectArray206) {
							var7 = new Class3_Sub16();
							var7.anObjectArray2448 = var4.anObjectArray206;
						...
						if(-2 == ~var2 && var4.anObjectArray176 != null) {
							if(-1 >= ~var4.anInt191) {
								Class11 var8 = Class7.method832((byte)121, var4.anInt279);
							...
							var7 = new Class3_Sub16();
							var7.anObjectArray2448 = var4.anObjectArray176;
							var7.aClass11_2449 = var4;
							Class43.method1065(1073376993, var7);
						}
					}
	...
	static final boolean method76(int var0, int var1, int var2, int var3, int var4, boolean var5, int var6, int var7, int var8, int var9, int var10, int var11) {
		try {
			...
			while(var15 != var27) {
				...
				if(-1 != ~var1) {
					if((5 > var1 || -11 == ~var1) && Class86.aClass91Array1182[Class26.anInt501].method1488(var4, var12, false, var13, var8, -1 + var1, 2, var7)) {
						var16 = true;
						break;
					}

					if(var1 < 10 && Class86.aClass91Array1182[Class26.anInt501].method1492(var4, var1 + -1, var8, var13, 2, var7, var12, 88)) {
						var16 = true;
						break;
					}
				}

				if(0 != var0 && ~var6 != -1 && Class86.aClass91Array1182[Class26.anInt501].method1498(true, var8, var13, var12, 2, var0, var2, var4, var6)) {
					var16 = true;
					break;
				}
	...
	final Class109_Sub1 method77(int var1, byte var2) {
		try {
			Class109_Sub1 var3 = (Class109_Sub1)Class3_Sub13_Sub31.aClass93_3369.method1526((long)(var1 << 16 | this.anInt64), (byte)121);
			if(var3 != null) {
				return var3;
			} else {
				Class148.aClass153_1916.method2144(0, this.anInt64);
				int var4 = 125 % ((var2 - -21) / 50);
				var3 = Class94.method1539(0, true, this.anInt64, Class148.aClass153_1916);
				if(var3 != null) {
					...
					Class3_Sub13_Sub31.aClass93_3369.method1515((byte)-125, var3, (long)(var1 << 16 | this.anInt64));
				}
	...
	static final void method78(int var0, boolean var1, int var2) {
		try {
			++Class153.anInt1944;
			Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 132);
			Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method775(var2, 1437452424);
			if(!var1) {
				Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method796(-1, var0);
			}
	...
	private final void method79(int var1, Class3_Sub30 var2, int var3, int var4) {
		try {
			if(var1 == 1) {
				this.anInt64 = var2.method737(1);
			} else if(var1 != 2) {
				if(~var1 != -4) {
					if(var1 == 4) {
						this.anInt64 = -1;
				...
				this.anInt61 = var2.method794((byte)96);
			}
	...
	static final void method81(byte var0, Class11 var1) {
		try {
			if(var0 != -128) {
				method75((Class11[])null, true, 21);
			}
			...
			if(324 != var2) {
				if(-326 != ~var2) {
					if(var2 == 327) {
						...
						if(null == Class102.aClass140_Sub4_Sub1_2141.aClass94_3967) {
							var1.anInt201 = 0;
						} else {
							var1.anInt182 = 150;
							var1.anInt308 = 2047 & (int)(256.0D * Math.sin((double)Class44.anInt719 / 40.0D));
							var1.anInt202 = 5;
							var1.anInt201 = 2047 + ((int)Class102.aClass140_Sub4_Sub1_2141.aClass94_3967.method1578(var0 + 18) << 11);
							var1.anInt260 = Class102.aClass140_Sub4_Sub1_2141.anInt2793;
							var1.anInt267 = 0;
							var1.anInt305 = Class102.aClass140_Sub4_Sub1_2141.anInt2764;
							var1.anInt283 = Class102.aClass140_Sub4_Sub1_2141.anInt2813;
						}
					}
				} else {
					if(-1 == Class3_Sub13_Sub21.anInt3260) {
						Class84.anInt1165 = var1.anInt296;
						Class3_Sub13_Sub21.anInt3260 = var1.anInt224;
					}

					if(!Class77.aClass52_1112.aBoolean864) {
						var1.anInt224 = Class3_Sub13_Sub21.anInt3260;
					} else {
						var1.anInt224 = Class84.anInt1165;
					}
