...
final class Class3_Sub13_Sub20 extends Class3_Sub13 {
   ...
   private static Class94 aClass94_3247 = Class3_Sub4.method108("flash1:", (byte)-119);
   static int anInt3248;
   static Class94 aClass94_3249 = aClass94_3247;
   private int anInt3250 = 4096;
   static Class94 aClass94_3251 = Class3_Sub4.method108("M-Bmoire attribu-Be", (byte)-121);
   private int anInt3252 = 4096;
static Class94 aClass94_3246 = aClass94_3247;
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(-1 != ~var1) {
            if(var1 != 1) {
               if(2 == var1) {
                  this.anInt3250 = var2.method737(1);
               }
            } else {
               this.anInt3245 = var2.method737(1);
            }
         } else {
            this.anInt3252 = var2.method737(1);
         }
