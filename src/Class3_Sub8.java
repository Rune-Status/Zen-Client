...
final class Class3_Sub8 extends Class3 {
   ...
   int anInt2296;
   static Class94 aClass94_2297 = Class3_Sub4.method108("Wordpack geladen)3", (byte)-118);
   ...
   static Class94 aClass94_2304 = Class3_Sub4.method108("details", (byte)-119);
   int anInt2305;
   static Class94 aClass94_2306 = Class3_Sub4.method108("<)4col> x", (byte)-123);


   static final void method124(int var0, int var1, int var2) {
      try {
         if(var0 <= 23) {
            aClass94_2306 = (Class94)null;
         }

         if(Canvas_Sub2.method57(var2, 104)) {
            Class2.method75(Class140.aClass11ArrayArray1834[var2], true, var1);
         }
   ...
   static final void method125(int var0, byte var1, int var2, int var3, Class11 var4) {
      try {
         ...
         if(2 != Class161.anInt2028 && 5 != Class161.anInt2028 && Class49.aClass3_Sub28_Sub16_812 != null) {
            int var19 = Class3_Sub13_Sub8.anInt3102 + Class28.anInt531 & 2047;
            int var6 = 0 + Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32 + 48;
            int var7 = 0 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32) + 464;
            if(!Class138.aBoolean1807) {
            ...
            if(null != Class3_Sub13_Sub35.aClass131_3421) {
               for(int var8 = 0; var8 < Class3_Sub13_Sub35.aClass131_3421.anInt1720; ++var8) {
                  if(Class3_Sub13_Sub35.aClass131_3421.method1789(var8, var1 ^ 553)) {
                     var9 = 2 + 4 * (Class3_Sub13_Sub35.aClass131_3421.aShortArray1727[var8] + -Class131.anInt1716) + -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32);
                     ...
                     var10 = 2 + 4 * (-Class82.anInt1152 + Class3_Sub13_Sub35.aClass131_3421.aShortArray1718[var8]) - Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32;
            ...
            for(var9 = 0; Class149.anInt1924 > var9; ++var9) {
               var10 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32) + 2 + 4 * Class84.anIntArray1163[var9] + 0;
               var11 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32) + 2 + (Class3_Sub28_Sub7_Sub1.anIntArray4050[var9] * 4 - 0);
               Class111 var20 = Class162.method2207(4, Class3_Sub28_Sub15.anIntArray3693[var9]);
            ...
            for(var9 = 0; 104 > var9; ++var9) {
               for(var10 = 0; -105 < ~var10; ++var10) {
                  Class61 var25 = Class3_Sub13_Sub22.aClass61ArrayArrayArray3273[Class26.anInt501][var9][var10];
                  if(null != var25) {
                     var12 = 2 + var9 * 4 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32);
                     var13 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32) + 2 + 4 * var10;
            ...
            for(var9 = 0; ~Class163.anInt2046 < ~var9; ++var9) {
               Class140_Sub4_Sub2 var21 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[Class15.anIntArray347[var9]];
               if(var21 != null && var21.method1966((byte)17)) {
                  Class90 var22 = var21.aClass90_3976;
                  if(null != var22 && null != var22.anIntArray1292) {
                     var22 = var22.method1471((byte)-3);
                  }

                  if(var22 != null && var22.aBoolean1285 && var22.aBoolean1270) {
                     var12 = var21.anInt2819 / 32 - Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32;
                     var13 = var21.anInt2829 / 32 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32);
            ...
            for(var9 = 0; var9 < Class159.anInt2022; ++var9) {
               Class140_Sub4_Sub1 var23 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[Class56.anIntArray887[var9]];
               if(null != var23 && var23.method1966((byte)17)) {
                  var12 = var23.anInt2829 / 32 - Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32;
                  var11 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32) + var23.anInt2819 / 32;
                  long var29 = var23.aClass94_3967.method1578(-128);
                  boolean var28 = false;
                  ...
                  for(var17 = 0; Class3_Sub28.anInt2572 > var17; ++var17) {
                  ...
                  boolean var32 = false;
                  if(-1 != ~Class102.aClass140_Sub4_Sub1_2141.anInt3956 && 0 != var23.anInt3956 && var23.anInt3956 == Class102.aClass140_Sub4_Sub1_2141.anInt3956) {
                     var32 = true;
                  }
            ...
            for(var10 = 0; ~var10 > ~var24.length; ++var10) {
               ...
               if(null != var26 && -1 != ~var26.anInt1360 && Class44.anInt719 % 20 < 10) {
                  if(~var26.anInt1360 == -2 && var26.anInt1359 >= 0 && var26.anInt1359 < Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292.length) {
                     Class140_Sub4_Sub2 var27 = Class3_Sub13_Sub24.aClass140_Sub4_Sub2Array3292[var26.anInt1359];
                     if(null != var27) {
                        var13 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32) + var27.anInt2819 / 32;
                        var14 = var27.anInt2829 / 32 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32);
                        Class53.method1171(var26.anInt1351, var2, var3, var13, var14, var4, false);
                     }
                  }

                  if(-3 == ~var26.anInt1360) {
                     var12 = (-Class131.anInt1716 + var26.anInt1356) * 4 + 2 - Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32;
                     var13 = -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32) + 2 + (-Class82.anInt1152 + var26.anInt1347) * 4;
                  ...
                  if(var26.anInt1360 == 10 && -1 >= ~var26.anInt1359 && Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269.length > var26.anInt1359) {
                     Class140_Sub4_Sub1 var30 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var26.anInt1359];
                     if(null != var30) {
                        var14 = var30.anInt2829 / 32 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32);
                        var13 = var30.anInt2819 / 32 + -(Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32);
                        Class53.method1171(var26.anInt1351, var2, var3, var13, var14, var4, false);
                     }
                  }
               }
            ...
            if(Class65.anInt987 != 0) {
               var9 = 4 * Class65.anInt987 + (2 - Class102.aClass140_Sub4_Sub1_2141.anInt2819 / 32);
               var10 = 2 + 4 * Class45.anInt733 - Class102.aClass140_Sub4_Sub1_2141.anInt2829 / 32;
   ...
   static final void method127(short[] var0, int var1, Class94[] var2, int var3, int var4) {
      try {
         if(~var1 < ~var4) {
            int var6 = var4;
            int var5 = (var4 - -var1) / 2;
            Class94 var7 = var2[var5];
            var2[var5] = var2[var1];
            var2[var1] = var7;
         ...
         if(var3 != -909) {
            method125(-13, (byte)113, -27, -120, (Class11)null);
         }
   ...
   static final void method128(int var0) {
      try {
         ...
         if(var0 != 2) {
            method127((short[])null, -27, (Class94[])null, -4, -64);
         }
   ...
   static final Class44_Sub1 method130(int var0, int var1) {
      try {
         if(Class30.aBoolean579 && ~var1 <= ~Class3_Sub13_Sub4.anInt3054 && ~var1 >= ~Class100.anInt1416) {
   ...
   static final void method132(byte var0) {
      try {
         for(int var1 = 0; var1 < Class113.anInt1552; ++var1) {
            --Class94.anIntArray2157[var1];
            if(~Class94.anIntArray2157[var1] > 9) {
               --Class113.anInt1552;
               ...
               for(int var2 = var1; var2 < Class113.anInt1552; ++var2) {
                  ...
                  Class94.anIntArray2157[var2] = Class94.anIntArray2157[1 + var2];
               ...
               if(null == var11) {
                  ...
                  Class94.anIntArray2157[var1] += var11.method1813();
                  Class102.aClass135Array2131[var1] = var11;
               }

               if(0 > Class94.anIntArray2157[var1]) {
                  int var3;
                  if(~Class3_Sub13_Sub6.anIntArray3083[var1] != -1) {
                     ...
                     int var8 = -Class102.aClass140_Sub4_Sub1_2141.anInt2829 + 64 + 128 * var7;
                     if(var8 < 0) {
                        var8 = -var8;
                     }

                     int var6 = -Class102.aClass140_Sub4_Sub1_2141.anInt2819 + 64 + var5 * 128;
                     if(0 > var6) {
                        var6 = -var6;
                     }
                     ...
                     if(~var4 > ~var9) {
                        Class94.anIntArray2157[var1] = -100;
                        continue;
                     }
         ...
         if(Class83.aBoolean1158 && !Class79.method1391(-1)) {
            ...
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method816(0, 137);
            Class3_Sub13_Sub1.aClass3_Sub30_Sub1_3035.method738(-127, Class129.anInt1691);
