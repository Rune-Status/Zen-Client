...
final class Class168 {
   ...
   static Class94 aClass94_2089 = Class3_Sub4.method108("compass", (byte)-121);
   int anInt2090 = 128;
   static Class11 aClass11_2091 = null;
   ...
   static Class153 aClass153_2097;
   int anInt2098 = -1;
   ...
   static final void method2270(Class140_Sub4 var0, byte var1) {
      try {
         if(Class44.anInt719 == var0.anInt2790 || ~var0.anInt2771 == 0 || var0.anInt2828 != 0 || ~(1 + var0.anInt2760) < ~GameClient.method45(var0.anInt2771, (byte)-20).anIntArray1869[var0.anInt2832]) {
            int var2 = var0.anInt2790 + -var0.anInt2800;
            int var3 = Class44.anInt719 + -var0.anInt2800;
            int var4 = var0.anInt2784 * 128 + 64 * var0.method1977((byte)114);
            int var5 = var0.anInt2835 * 128 - -(var0.method1977((byte)114) * 64);
            int var6 = 128 * var0.anInt2823 + var0.method1977((byte)114) * 64;
            int var7 = 128 * var0.anInt2798 + var0.method1977((byte)114) * 64;
   ...
   static final Class11 method2273(Class11 var0, int var1) {
      try {
         if(var1 < 57) {
            method2273((Class11)null, -22);
         }
         ...
         if(var0.anInt190 == -1) {
            ...
            for(Class3_Sub31 var2 = (Class3_Sub31)var4.method1393((byte)125); null != var2; var2 = (Class3_Sub31)var4.method1392(0)) {
               if(~var3 == ~var2.anInt2602) {
                  return Class7.method832((byte)127, (int)var2.aLong71);
               }
            }

            return null;
         } else {
            return Class7.method832((byte)118, var0.anInt190);
         }
      } catch (RuntimeException var5) {
   ...
   final void method2274(int var1, Class3_Sub30 var2, int var3) {
      try {
         while(true) {
            int var4 = var2.method803((byte)-111);
            if(var4 == 0) {
               if(var1 != 24559) {
                  method2276(-85);
               }
   ...
   static final void method2275(int var0, byte var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         while(~var7 > ~var9) {
            ...
            if(-1 >= ~var12 && ~var11 <= -2) {
               --var11;
               Class140.anIntArray1838[var11] = var7;
               var12 -= var11 << 1;
            }
            ...
            if(0 <= var10) {
               ...
               if(~Class159.anInt2020 >= ~var16 && ~Class57.anInt902 <= ~var24) {
                  if(~var9 <= ~var8) {
                     ...
                     var17 = Class140.anIntArray1838[var9];
                     var18 = Class40.method1040(Class3_Sub28_Sub18.anInt3765, var7 + var6, (byte)0, Class101.anInt1425);
            ...
            if(~Class159.anInt2020 >= ~var16 && ~Class57.anInt902 <= ~var24) {
               ...
               if(var17 >= Class101.anInt1425 && ~Class3_Sub28_Sub18.anInt3765 <= ~var18) {
                  ...
                  if(var7 < var8) {
                     var19 = var11 >= var7?var11:Class140.anIntArray1838[var7];
         ...
         while(!var1) {
            ...
            for(int var2 = 0; ~var2 > ~(-1 + Class3_Sub13_Sub34.anInt3415); ++var2) {
               if(Class3_Sub13_Sub7.aShortArray3095[var2] < 1000 && -1001 > ~Class3_Sub13_Sub7.aShortArray3095[1 + var2]) {
                  Class94 var3 = Class163_Sub2_Sub1.aClass94Array4016[var2];
                  var1 = false;
                  ...
                  Class94 var4 = Class140_Sub7.aClass94Array2935[var2];
   ...
   private final void method2279(int var1, int var2, Class3_Sub30 var3, int var4) {
      try {
         if(var1 == 0) {
            if(-2 != ~var2) {
               if(var2 != 2) {
                                 ...
                                 if(-11 != ~var2) {
                                    if(var2 != 11) {
                                       if(12 != var2) {
                                          if(13 != var2) {
                                             if(~var2 == -15) {
                                                this.anInt2101 = var3.method803((byte)-68);
                                             }
                                          } else {
                                             this.anInt2094 = var3.method794((byte)110);
                                          }
                                       } else {
                                          this.aBoolean2092 = true;
                                       }
                                    } else {
                                       this.anInt2100 = var3.method803((byte)-89);
                                    }
                                 } else {
                                    this.aBoolean2093 = false;
                                 }
                              } else {
                                 this.anInt2090 = var3.method737(var1 ^ 1);
                              }
                           } else {
                              Class3_Sub13_Sub6.anInt3081 = var4;
                           }
                        } else {
                           this.anInt2098 = Class11.method869(116, var3.method794((byte)82));
                        }
                     } else {
                        this.aBoolean2102 = false;
                     }
                  } else {
                     this.anInt2095 = var3.method737(1);
                     if(this.anInt2095 == '\uffff') {
                        this.anInt2095 = -1;
                     }
                  }
               } else {
                  this.anInt2095 = var3.method803((byte)-128);
               }
            } else {
               this.anInt2103 = Class11.method869(116, var3.method794((byte)83));
            }
