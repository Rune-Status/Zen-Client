...
final class Class99 {
   ...
   static Class11 aClass11_1402;
   static int anInt1403 = -1;


   static final void method1596(Class94 var0, byte var1, boolean var2) {
      try {
         if(var1 < 124) {
         ...
         if(!var2) {
            ...
            if(Class138.aBoolean1807 && Class3_Sub28_Sub6.aBoolean3594) {
               try {
                  Class42.method1056(Class38.aGameStub_665.anApplet1219, "openjs", new Object[]{var0.method1547(Class3_Sub29.anApplet_Sub1_2588.getCodeBase(), true).toString()}, (byte)117);
                  return;
   ...
   static final Frame method1597(int var0, int var1, int var2, int var3, int var4, GameStub var5) {
      try {
