...
final class Class3_Sub13_Sub25 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3302 = Class3_Sub4.method108("Connexion perdue)3", (byte)-122);
   private int anInt3303 = 1024;
   static Class153 aClass153_3304;
   static int anInt3305 = 0;
   private static Class94 aClass94_3306 = Class3_Sub4.method108(" is already on your ignore list)3", (byte)-126);
   static Class94 aClass94_3307 = Class3_Sub4.method108("<col=00ff80>", (byte)-125);
   private int anInt3308 = 2048;
   private int anInt3309 = 0;
   private int anInt3310 = 409;
   static Class94 aClass94_3311 = aClass94_3306;
   ...
   final void method158(int var1) {
      try {
         if(var1 != 16251) {
            this.method157(-7, (Class3_Sub30)null, true);
         }
                  ...
                  if(~var17 > ~var14) {
                     ...
                     if(~this.anInt3309 != -1) {
                        for(var20 = 0; var20 < var13; ++var20) {
                           ...
                           var18[Class3_Sub28_Sub15.method633(Class16.anInt396, var3 - -var20)] = var18[Class3_Sub28_Sub15.method633(Class16.anInt396, var4 + var3 + -var20 - 1)] = ~var19 >= ~var21?var19:var21;
                        }
                     } else {
                        for(var20 = 0; ~var13 < ~var20; ++var20) {
                           var21 = var20 * var8 / var13;
                           var18[Class3_Sub28_Sub15.method633(Class16.anInt396, var20 + var3)] = var18[Class3_Sub28_Sub15.method633(-1 + var4 + var3 + -var20, Class16.anInt396)] = var21 * var19 >> 12;
                        }
                     }
                     ...
                     if(~var19 <= ~var14) {
                        for(var20 = 0; var13 > var20; ++var20) {
                           var18[Class3_Sub28_Sub15.method633(Class16.anInt396, var3 + var20)] = var18[Class3_Sub28_Sub15.method633(-1 + -var20 + var3 - -var4, Class16.anInt396)] = var8 * var20 / var13;
                        }
                        ...
                        if(this.anInt3309 == 0) {
                           for(var21 = 0; var13 > var21; ++var21) {
                              ...
                              var18[Class3_Sub28_Sub15.method633(Class16.anInt396, var3 - -var21)] = var18[Class3_Sub28_Sub15.method633(Class16.anInt396, -1 + var3 - (-var4 + var21))] = var22 * var20 >> 12;
                           }
                        } else {
                           for(var21 = 0; ~var13 < ~var21; ++var21) {
                              var22 = var21 * var8 / var13;
                              var18[Class3_Sub28_Sub15.method633(var3 - -var21, Class16.anInt396)] = var18[Class3_Sub28_Sub15.method633(-1 + -var21 + var4 + var3, Class16.anInt396)] = ~var20 >= ~var22?var20:var22;
                           }
                        }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         ...
         if(~var1 != -1) {
            if(var1 == 1) {
               this.anInt3300 = var2.method737(1);
            } else if(2 != var1) {
               if(var1 != 3) {
                  if(-5 == ~var1) {
                     this.anInt3301 = var2.method737(1);
                  } else if(var1 != 5) {
                     if(-7 != ~var1) {
                        if(-8 != ~var1) {
                           if(~var1 == -9) {
                              this.anInt3316 = var2.method737(1);
                           }
                        } else {
                           this.anInt3299 = var2.method737(1);
                        }
                     } else {
                        this.anInt3309 = var2.method803((byte)-114);
                     }
                  } else {
                     this.anInt3303 = var2.method737(1);
                  }
               } else {
                  this.anInt3310 = var2.method737(1);
               }
            } else {
               this.anInt3308 = var2.method737(1);
            }
         } else {
            this.anInt3312 = var2.method803((byte)-104);
         }
   ...
   static final boolean method292(int var0, int var1, int var2, int var3, Class140 var4, int var5, long var6, int var8, int var9, int var10, int var11) {
