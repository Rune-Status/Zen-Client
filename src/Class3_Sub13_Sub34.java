...
final class Class3_Sub13_Sub34 extends Class3_Sub13 {
   ...
   static Class94 aClass94_3408 = Class3_Sub4.method108("Untersuchen", (byte)-127);
   static Class94 aClass94_3409 = Class3_Sub4.method108("Musik)2Engine vorbereitet)3", (byte)-121);
   ...
   static final void method328(int var0, Class3_Sub30 var1) {
      try {
         if(var0 != -21774) {
         ...
         while(var1.anInt2595 < var1.aByteArray2590.length) {
            ...
            boolean var3 = false;
            int var5 = 0;
            if(var1.method803((byte)-23) == 1) {
               var3 = true;
               var4 = var1.method803((byte)-76);
               var5 = var1.method803((byte)-88);
            }

            int var6 = var1.method803((byte)-70);
            int var7 = var1.method803((byte)-89);
                  ...
                  for(int var13 = 0; ~var13 > -65; ++var13) {
                     if(!var3 || ~(var4 * 8) >= ~var12 && 8 + 8 * var4 > var12 && var13 >= var5 * 8 && 8 + var5 * 8 > var13) {
                        ...
                        if(var2 != 0) {
                           ...
                           byte var14 = var1.method760(false);
                           if(null == Class3_Sub16.aByteArrayArrayArray2452[var10][var11]) {
                              Class3_Sub16.aByteArrayArrayArray2452[var10][var11] = new byte[4096];
                           }

                           Class3_Sub16.aByteArrayArrayArray2452[var10][var11][var12 + (-var13 + 63 << 6)] = var14;
                        }
                     }
                  }
               }
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(var3) {
            if(var1 == 0) {
               this.anInt3404 = var2.method737(1);
            } else if(1 != var1) {
               if(~var1 == -3) {
                  this.anInt3406 = var2.method737(1);
               } else if(var1 != 3) {
                  if(4 == var1) {
                     int var4 = var2.method794((byte)107);
                  ...
                  this.anInt3410 = var2.method737(1);
               }
            } else {
               this.anInt3405 = var2.method737(1);
            }
   ...
   static final void method330(int var0, int var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if(var6 == 0) {
            ...
            Class140.method1869((byte)6, var0, var11, var10, var9, var8);
         }
   ...
   static final boolean method334(Class153 var0, int var1) {
      try {
         return var0.method2144(var1, Class140_Sub4_Sub2.anInt4001);
      } catch (RuntimeException var3) {
