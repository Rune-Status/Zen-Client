...
final class Class8 {
   ...
   private Class3_Sub30 aClass3_Sub30_99;
   ...
   static Class153 aClass153_105;
   static Class94 aClass94_106 = Class3_Sub4.method108("showVideoAd", (byte)-125);
   ...
   public static void method836(int var0) {
      try {
         aClass153_105 = null;
         if(var0 > -10) {
            method843(-80, (Class3_Sub30)null);
         }
      ...
      try {
         if(null == this.aClass3_Sub30_99) {
            ...
            if(this.aClass3_Sub28_Sub10_Sub2_100 == null) {
               ...
               this.aClass3_Sub28_Sub10_Sub2_100 = this.aClass66_102.method1255(123, 255, (byte)0, 255, true);
            }

            if(this.aClass3_Sub28_Sub10_Sub2_100.aBoolean3632) {
               return false;
            } else {
               this.aClass3_Sub30_99 = new Class3_Sub30(this.aClass3_Sub28_Sub10_Sub2_100.method587(false));
               this.aClass151_Sub1Array107 = new Class151_Sub1[(this.aClass3_Sub30_99.aByteArray2590.length + -5) / 8];
               return true;
            }
         } else {
            return true;
   ...
   private final Class151_Sub1 method839(int var1, int var2, Class41 var3, Class41 var4) {
      try {
         if(var1 != -1824885439) {
            method842(true, false, false, -22, true);
         }
   ...
   static final void method840(Class111 var0, byte var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8) {
      try {
         int var9 = 3 & var3;
         if(var1 >= -1) {
            aClass94_106 = (Class94)null;
         }
         ...
         Class136 var22 = var0.method1696(var3, var16, var18, var5, var19, var21, false, (Class109_Sub1)null, (byte)-69, true, var17);
   ...
   static final void method841(boolean var0) {
      try {
         Class140.aClass11Array1836 = null;
         Class3_Sub13_Sub1.method171(-101, Class3_Sub28_Sub12.anInt3655, 0, Class23.anInt454, 0, -1, Class140_Sub7.anInt2934, 0, 0);
         if(Class140.aClass11Array1836 != null) {
            Class47.method1095(0, Class73.anInt1082, Class3_Sub28_Sub7.anInt3602, Class140.aClass11Array1836, Class23.anInt454, -1412584499, 0, Class140_Sub7.anInt2934, (byte)73, Class4.aClass11_88.anInt292);
            Class140.aClass11Array1836 = null;
         }
   ...
   static final Class153 method842(boolean var0, boolean var1, boolean var2, int var3, boolean var4) {
      try {
         if(!var4) {
            ...
            Class3_Sub30.aClass151_Sub1Array2601[var3] = Class151.aClass8_1936.method839(-1824885439, var3, Class86.aClass41_1186, var5);
            if(var1) {
               Class3_Sub30.aClass151_Sub1Array2601[var3].method2101(true);
            }

            return new Class153(Class3_Sub30.aClass151_Sub1Array2601[var3], var0, var2);
         }
      } catch (RuntimeException var6) {
   ...
   static final Class75_Sub1 method843(int var0, Class3_Sub30 var1) {
      try {
         return var0 != -5232?(Class75_Sub1)null:new Class75_Sub1(var1.method787((byte)46), var1.method787((byte)109), var1.method787((byte)68), var1.method787((byte)127), var1.method794((byte)91), var1.method803((byte)-124));
      } catch (RuntimeException var3) {
   ...
   private final Class151_Sub1 method847(Class41 var1, int var2, int var3, boolean var4, Class41 var5) {
      try {
         if(null != this.aClass3_Sub30_99) {
            this.aClass3_Sub30_99.anInt2595 = 5 + var3 * 8;
            if(var2 >= -1) {
               return (Class151_Sub1)null;
            } else if(this.aClass3_Sub30_99.aByteArray2590.length > this.aClass3_Sub30_99.anInt2595) {
               if(null == this.aClass151_Sub1Array107[var3]) {
                  int var6 = this.aClass3_Sub30_99.method748(-502942936);
                  int var7 = this.aClass3_Sub30_99.method748(-502942936);
   ...
   Class8(Class66 var1, Class73 var2) {
      try {
         ...
         if(!this.aClass66_102.method1251((byte)111)) {
            this.aClass3_Sub28_Sub10_Sub2_100 = this.aClass66_102.method1255(110, 255, (byte)0, 255, true);
         }
