...
final class Class3_Sub13_Sub38 extends Class3_Sub13 {
   ...
   private static Class94 aClass94_3449 = Class3_Sub4.method108("Loading sprites )2 ", (byte)-119);
   private int anInt3450 = 4096;
   private int anInt3451 = 16;
   static Class94 aClass94_3452 = Class3_Sub4.method108("mapflag", (byte)-125);
...
static Class94 aClass94_3445 = aClass94_3449;
   ...
   final void method157(int var1, Class3_Sub30 var2, boolean var3) {
      try {
         if(-1 == ~var1) {
            this.anInt3454 = var2.method803((byte)-34);
         } else if(~var1 == -2) {
            this.anInt3447 = var2.method737(1);
         } else if(~var1 != -3) {
            if(3 == var1) {
               this.anInt3444 = var2.method737(1);
            } else if(var1 == 4) {
               this.anInt3450 = var2.method737(1);
            }
         } else {
            this.anInt3451 = var2.method803((byte)-116);
         }
            ...
            for(int var8 = 0; this.anInt3447 > var8; ++var8) {
               ...
               if(~var15 != -1 || ~var14 != -1) {
                  ...
                  for(int var24 = var10; var12 > var24; ++var24) {
                     ...
                     int var26 = Class16.anInt396 & var24;
                     if(!var16) {
