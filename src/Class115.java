...
final class Class115 {
   ...
   private static Class94 aClass94_1582 = Class3_Sub4.method108("Ok", (byte)-127);
   static Class94 aClass94_1583 = aClass94_1582;
      ...
      try {
         ...
         while(true) {
            ...
            if(0 > var1.anInt2273) {
               ...
               if(~var3 != ~Class3_Sub1.anInt2211) {
                  var2 = Class3_Sub13_Sub22.aClass140_Sub4_Sub1Array3269[var3];
               } else {
                  var2 = Class102.aClass140_Sub4_Sub1_2141;
               }
            } else {
               var3 = var1.anInt2273 - 1;
            ...
            if(var2 != null) {
               Class111 var20 = Class162.method2207(4, var1.anInt2270);
               if(~Class26.anInt501 > -4) {
                  ;
               }
               ...
               int[][] var10 = Class44.anIntArrayArrayArray723[Class26.anInt501];
               ...
               if(-1 == ~var13) {
                  Class70 var14 = Class154.method2147(Class26.anInt501, var1.anInt2271, var1.anInt2282);
                  if(var14 != null) {
                     var12 = var14.aClass140_1049;
                  }
               } else if(~var13 != -2) {
                  if(2 == var13) {
                     Class25 var23 = Class75.method1336(Class26.anInt501, var1.anInt2271, var1.anInt2282);
                     if(null != var23) {
                        var12 = var23.aClass140_479;
                     }
                  } else if(var13 == 3) {
                     Class12 var24 = Class3_Sub30.method784(Class26.anInt501, var1.anInt2271, var1.anInt2282);
                     if(null != var24) {
                        var12 = var24.aClass140_320;
                     }
                  }
               } else {
                  Class19 var21 = Class44.method1068(Class26.anInt501, var1.anInt2271, var1.anInt2282);
                  if(null != var21) {
               ...
               if(null != var12) {
                  Class13.method881(Class26.anInt501, var1.anInt2282, -96, 0, var1.anInt2271, var1.anInt2283 - -1, -1, var13, 0, var1.anInt2266 - -1);
