...
final class Class32 {
   ...
   static Class94 aClass94_591 = Class3_Sub4.method108("Lade Benutzeroberfl-=che )2 ", (byte)-117);
   static Class94 aClass94_592 = Class3_Sub4.method108("<img=0>", (byte)-119);
   static Class94 aClass94_593 = Class3_Sub4.method108("Utiliser", (byte)-124);


   static final Class94 method992(Class3_Sub30 var0, int var1) {
      try {
         if(var1 != 29488) {
            anInt590 = 22;
         }
   ...
   static final void method995() {
      ...
      if(Class3_Sub28_Sub10_Sub2.aClass3_Sub2ArrayArrayArray4070 != null) {
         for(var0 = 0; var0 < Class3_Sub28_Sub10_Sub2.aClass3_Sub2ArrayArrayArray4070.length; ++var0) {
            for(var1 = 0; var1 < Class89.anInt1234; ++var1) {
      ...
      GameClient.aClass3_Sub11ArrayArray2199 = (Class3_Sub11[][])null;
      ...
      if(Class142.aClass25Array1868 != null) {
         ...
         synchronized(var1) {
            ...
            if(Class3_Sub13.anInt2384 < 0) {
               for(var2 = 0; ~var2 > -113; ++var2) {
                  Class111.aBooleanArray1490[var2] = false;
               }
               ...
               while(Class3_Sub13.anInt2384 != Class133.anInt1744) {
                  ...
                  if(0 <= var2) {
                     Class111.aBooleanArray1490[var2] = true;
                  } else {
                     Class111.aBooleanArray1490[~var2] = false;
                  }
               }
